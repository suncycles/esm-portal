...
exports.loadMVSX = exports.MVSXFormatProvider = exports.MVSJFormatProvider = exports.LoadMvsData = exports.LoadMvsDataParams = exports.ParseMVSX = exports.ParseMVSJ = exports.Mvs = void 0;
...
exports.LoadMvsData = mol_state_1.StateAction.build({
    ...
    await (0, load_1.loadMVS)(plugin, mvsData, { replaceExisting: params.replaceExisting, keepCamera: params.keepCamera, sourceUrl: sourceUrl });
}));
