...
exports.builderDemo = exports.Representation = exports.Component = exports.Structure = exports.Parse = exports.Download = exports.Root = exports.createMVSBuilder = void 0;
const object_1 = require("../../../../mol-util/object");
const mvs_data_1 = require("../../mvs-data");
const mvs_defaults_1 = require("./mvs-defaults");
...
class _Base {
    ...
    addChild(kind, params) {
        var _a;
        var _b;
        const allowedParamNames = Object.keys(mvs_tree_1.MVSTreeSchema.nodes[kind].params);
        const node = {
            kind,
            params: (0, object_1.pickObjectKeys)(params, allowedParamNames),
        };
...
class Root extends _Base {
    ...
    getState(metadata) {
        return {
            ...
            metadata: {
                ...metadata,
                version: `${mvs_data_1.MVSData.SupportedVersion}`,
                timestamp: utcNowISO(),
            },
        };
    }
...
class Structure extends _Base {
    ...
    component(params = {}) {
        var _a;
        const fullParams = { ...params, selector: (_a = params.selector) !== null && _a !== void 0 ? _a : mvs_defaults_1.MVSDefaults.component.selector };
