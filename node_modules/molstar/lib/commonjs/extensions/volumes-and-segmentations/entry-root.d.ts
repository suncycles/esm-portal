...
declare const VolsegEntry_base: {
    ...
    type: PluginStateObject.TypeInfo;
    is(obj?: import("../../mol-state").StateObject<any, import("../../mol-state").StateObject.Type<any>> | undefined): obj is import("../../mol-state").StateObject<VolsegEntryData, PluginStateObject.TypeInfo>;
};
