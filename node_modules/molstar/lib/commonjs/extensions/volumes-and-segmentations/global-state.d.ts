...
declare const VolsegGlobalState_base: {
    ...
    type: PluginStateObject.TypeInfo;
    is(obj?: import("../../mol-state").StateObject<any, import("../../mol-state").StateObject.Type<any>> | undefined): obj is import("../../mol-state").StateObject<VolsegGlobalStateData, PluginStateObject.TypeInfo>;
};
