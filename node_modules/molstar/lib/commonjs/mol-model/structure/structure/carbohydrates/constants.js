...
exports.SaccharideCompIdMap = exports.setSaccharideCompIdMapType = exports.MonosaccharidesColorTable = exports.SaccharidesSnfgMap = exports.UnknownSaccharideComponent = exports.getSaccharideShape = exports.getSaccharideName = exports.SaccharideType = exports.SaccharideColors = exports.SaccharideShape = void 0;
const color_1 = require("../../../../mol-util/color");
const saccharides_1 = require("../../model/types/saccharides");
...
})(SaccharideShape || (exports.SaccharideShape = SaccharideShape = {}));
...
})(SaccharideType || (exports.SaccharideType = SaccharideType = {}));
...
exports.getSaccharideShape = getSaccharideShape;
exports.UnknownSaccharideComponent = {
    abbr: 'Unk',
    name: 'Unknown',
...
const Monosaccharides = [
    { abbr: 'Glc', name: 'Glucose', color: exports.SaccharideColors.Blue, type: SaccharideType.Hexose },
    { abbr: 'Man', name: 'Mannose', color: exports.SaccharideColors.Green, type: SaccharideType.Hexose },
    { abbr: 'Gal', name: 'Galactose', color: exports.SaccharideColors.Yellow, type: SaccharideType.Hexose },
    { abbr: 'Gul', name: 'Gulose', color: exports.SaccharideColors.Orange, type: SaccharideType.Hexose },
    { abbr: 'Alt', name: 'Altrose', color: exports.SaccharideColors.Pink, type: SaccharideType.Hexose },
    { abbr: 'All', name: 'Allose', color: exports.SaccharideColors.Purple, type: SaccharideType.Hexose },
    { abbr: 'Tal', name: 'Talose', color: exports.SaccharideColors.LightBlue, type: SaccharideType.Hexose },
    { abbr: 'Ido', name: 'Idose', color: exports.SaccharideColors.Brown, type: SaccharideType.Hexose },
    { abbr: 'GlcNAc', name: 'N-Acetyl Glucosamine', color: exports.SaccharideColors.Blue, type: SaccharideType.HexNAc },
    { abbr: 'ManNAc', name: 'N-Acetyl Mannosamine', color: exports.SaccharideColors.Green, type: SaccharideType.HexNAc },
    { abbr: 'GalNAc', name: 'N-Acetyl Galactosamine', color: exports.SaccharideColors.Yellow, type: SaccharideType.HexNAc },
    { abbr: 'GulNAc', name: 'N-Acetyl Gulosamine', color: exports.SaccharideColors.Orange, type: SaccharideType.HexNAc },
    { abbr: 'AltNAc', name: 'N-Acetyl Altrosamine', color: exports.SaccharideColors.Pink, type: SaccharideType.HexNAc },
    { abbr: 'AllNAc', name: 'N-Acetyl Allosamine', color: exports.SaccharideColors.Purple, type: SaccharideType.HexNAc },
    { abbr: 'TalNAc', name: 'N-Acetyl Talosamine', color: exports.SaccharideColors.LightBlue, type: SaccharideType.HexNAc },
    { abbr: 'IdoNAc', name: 'N-Acetyl Idosamine', color: exports.SaccharideColors.Brown, type: SaccharideType.HexNAc },
    { abbr: 'GlcN', name: 'Glucosamine', color: exports.SaccharideColors.Blue, type: SaccharideType.Hexosamine },
    { abbr: 'ManN', name: 'Mannosamine', color: exports.SaccharideColors.Green, type: SaccharideType.Hexosamine },
    { abbr: 'GalN', name: 'Galactosamine', color: exports.SaccharideColors.Yellow, type: SaccharideType.Hexosamine },
    { abbr: 'GulN', name: 'Gulosamine', color: exports.SaccharideColors.Orange, type: SaccharideType.Hexosamine },
    { abbr: 'AltN', name: 'Altrosamine', color: exports.SaccharideColors.Pink, type: SaccharideType.Hexosamine },
    { abbr: 'AllN', name: 'Allosamine', color: exports.SaccharideColors.Purple, type: SaccharideType.Hexosamine },
    { abbr: 'TalN', name: 'Talosamine', color: exports.SaccharideColors.LightBlue, type: SaccharideType.Hexosamine },
    { abbr: 'IdoN', name: 'Idosamine', color: exports.SaccharideColors.Brown, type: SaccharideType.Hexosamine },
    { abbr: 'GlcA', name: 'Glucuronic Acid', color: exports.SaccharideColors.Blue, type: SaccharideType.Hexuronate },
    { abbr: 'ManA', name: 'Mannuronic Acid', color: exports.SaccharideColors.Green, type: SaccharideType.Hexuronate },
    { abbr: 'GalA', name: 'Galacturonic Acid', color: exports.SaccharideColors.Yellow, type: SaccharideType.Hexuronate },
    { abbr: 'GulA', name: 'Guluronic Acid', color: exports.SaccharideColors.Orange, type: SaccharideType.Hexuronate },
    { abbr: 'AltA', name: 'Altruronic Acid', color: exports.SaccharideColors.Pink, type: SaccharideType.Hexuronate },
    { abbr: 'AllA', name: 'Alluronic Acid', color: exports.SaccharideColors.Purple, type: SaccharideType.Hexuronate },
    { abbr: 'TalA', name: 'Taluronic Acid', color: exports.SaccharideColors.LightBlue, type: SaccharideType.Hexuronate },
    { abbr: 'IdoA', name: 'Iduronic Acid', color: exports.SaccharideColors.Brown, type: SaccharideType.Hexuronate },
    { abbr: 'Qui', name: 'Quinovose', color: exports.SaccharideColors.Blue, type: SaccharideType.Deoxyhexose },
    { abbr: 'Rha', name: 'Rhamnose', color: exports.SaccharideColors.Green, type: SaccharideType.Deoxyhexose },
    { abbr: '6dGul', name: '6-Deoxy Gulose', color: exports.SaccharideColors.Orange, type: SaccharideType.Deoxyhexose },
    { abbr: '6dAlt', name: '6-Deoxy Altrose', color: exports.SaccharideColors.Pink, type: SaccharideType.Deoxyhexose },
    { abbr: '6dTal', name: '6-Deoxy Talose', color: exports.SaccharideColors.LightBlue, type: SaccharideType.Deoxyhexose },
    { abbr: 'Fuc', name: 'Fucose', color: exports.SaccharideColors.Red, type: SaccharideType.Deoxyhexose },
    { abbr: 'QuiNAc', name: 'N-Acetyl Quinovosamine', color: exports.SaccharideColors.Blue, type: SaccharideType.DeoxyhexNAc },
    { abbr: 'RhaNAc', name: 'N-Acetyl Rhamnosamine', color: exports.SaccharideColors.Green, type: SaccharideType.DeoxyhexNAc },
    { abbr: '6dAltNAc', name: 'N-Acetyl 6-Deoxy Altrosamine', color: exports.SaccharideColors.Pink, type: SaccharideType.DeoxyhexNAc },
    { abbr: '6dTalNAc', name: 'N-Acetyl 6-Deoxy Talosamine', color: exports.SaccharideColors.LightBlue, type: SaccharideType.DeoxyhexNAc },
    { abbr: 'FucNAc', name: 'N-Acetyl Fucosamine', color: exports.SaccharideColors.Red, type: SaccharideType.DeoxyhexNAc },
    { abbr: 'Oli', name: 'Olivose', color: exports.SaccharideColors.Blue, type: SaccharideType.DiDeoxyhexose },
    { abbr: 'Tyv', name: 'Tyvelose', color: exports.SaccharideColors.Green, type: SaccharideType.DiDeoxyhexose },
    { abbr: 'Abe', name: 'Abequose', color: exports.SaccharideColors.Orange, type: SaccharideType.DiDeoxyhexose },
    { abbr: 'Par', name: 'Paratose', color: exports.SaccharideColors.Pink, type: SaccharideType.DiDeoxyhexose },
    { abbr: 'Dig', name: 'Digitoxose', color: exports.SaccharideColors.Purple, type: SaccharideType.DiDeoxyhexose },
    { abbr: 'Col', name: 'Colitose', color: exports.SaccharideColors.LightBlue, type: SaccharideType.DiDeoxyhexose },
    { abbr: 'Ara', name: 'Arabinose', color: exports.SaccharideColors.Green, type: SaccharideType.Pentose },
    { abbr: 'Lyx', name: 'Lyxose', color: exports.SaccharideColors.Yellow, type: SaccharideType.Pentose },
    { abbr: 'Xyl', name: 'Xylose', color: exports.SaccharideColors.Orange, type: SaccharideType.Pentose },
    { abbr: 'Rib', name: 'Ribose', color: exports.SaccharideColors.Pink, type: SaccharideType.Pentose },
    { abbr: 'Kdn', name: 'Keto-Deoxy Nonulonic Acid', color: exports.SaccharideColors.Green, type: SaccharideType.Deoxynonulosonate },
    { abbr: 'Neu5Ac', name: 'N-Acetyl Neuraminic Acid', color: exports.SaccharideColors.Purple, type: SaccharideType.Deoxynonulosonate },
    { abbr: 'Neu5Gc', name: 'N-Glycolyl Neuraminic Acid', color: exports.SaccharideColors.LightBlue, type: SaccharideType.Deoxynonulosonate },
    { abbr: 'Neu', name: 'Neuraminic Acid', color: exports.SaccharideColors.Brown, type: SaccharideType.Deoxynonulosonate },
    { abbr: 'Sia', name: 'Sialic acid', color: exports.SaccharideColors.Red, type: SaccharideType.Deoxynonulosonate },
    { abbr: 'Pse', name: 'Pseudaminic Acid', color: exports.SaccharideColors.Green, type: SaccharideType.DiDeoxynonulosonate },
    { abbr: 'Leg', name: 'Legionaminic Acid', color: exports.SaccharideColors.Yellow, type: SaccharideType.DiDeoxynonulosonate },
    { abbr: 'Aci', name: 'Acinetaminic Acid', color: exports.SaccharideColors.Pink, type: SaccharideType.DiDeoxynonulosonate },
    { abbr: '4eLeg', name: '4-Epilegionaminic Acid', color: exports.SaccharideColors.LightBlue, type: SaccharideType.DiDeoxynonulosonate },
    { abbr: 'Bac', name: 'Bacillosamine', color: exports.SaccharideColors.Blue, type: SaccharideType.Unknown },
    { abbr: 'LDmanHep', name: 'L-Glycero-D-Manno Heptose', color: exports.SaccharideColors.Green, type: SaccharideType.Unknown },
    { abbr: 'Kdo', name: 'Keto-Deoxy Octulonic Acid', color: exports.SaccharideColors.Yellow, type: SaccharideType.Unknown },
    { abbr: 'Dha', name: '3-Deoxy Lyxo-Heptulosaric Acid', color: exports.SaccharideColors.Orange, type: SaccharideType.Unknown },
    { abbr: 'DDmanHep', name: 'D-Glycero-D-Manno-Heptose', color: exports.SaccharideColors.Pink, type: SaccharideType.Unknown },
    { abbr: 'MurNAc', name: 'N-Acetyl Muramic Acid', color: exports.SaccharideColors.Purple, type: SaccharideType.Unknown },
    { abbr: 'MurNGc', name: 'N-Glycolyl Muramic Acid', color: exports.SaccharideColors.LightBlue, type: SaccharideType.Unknown },
    { abbr: 'Mur', name: 'Muramic Acid', color: exports.SaccharideColors.Brown, type: SaccharideType.Unknown },
    { abbr: 'Api', name: 'Apicose', color: exports.SaccharideColors.Green, type: SaccharideType.Assigned },
    { abbr: 'Fru', name: 'Fructose', color: exports.SaccharideColors.Green, type: SaccharideType.Assigned },
    { abbr: 'Tag', name: 'Tagatose', color: exports.SaccharideColors.Yellow, type: SaccharideType.Assigned },
    { abbr: 'Sor', name: 'Sorbose', color: exports.SaccharideColors.Orange, type: SaccharideType.Assigned },
    { abbr: 'Psi', name: 'Psicose', color: exports.SaccharideColors.Pink, type: SaccharideType.Assigned },
];
...
exports.MonosaccharidesColorTable = [
    ['Glc-family', exports.SaccharideColors.Blue],
    ['Man-family', exports.SaccharideColors.Green],
    ['Gal-family', exports.SaccharideColors.Yellow],
    ['Gul-family', exports.SaccharideColors.Orange],
    ['Alt-family', exports.SaccharideColors.Pink],
    ['All-family', exports.SaccharideColors.Purple],
    ['Tal-family', exports.SaccharideColors.LightBlue],
    ['Ido-family', exports.SaccharideColors.Brown],
    ['Fuc-family', exports.SaccharideColors.Red],
    ['Generic/Unknown/Secondary', exports.SaccharideColors.Secondary],
];
...
const DefaultSaccharideCompIdMap = (function () {
    ...
    saccharides_1.SaccharideNames.forEach(name => {
        if (!map.has(name))
