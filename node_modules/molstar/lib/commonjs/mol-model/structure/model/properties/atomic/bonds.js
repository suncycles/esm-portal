...
exports.getInterBondOrderFromTable = exports.getIntraBondOrderFromTable = void 0;
 ...
 */
function getIntraBondOrderFromTable(compId, atomId1, atomId2) {
    [atomId1, atomId2] = atomId1 < atomId2 ? [atomId1, atomId2] : [atomId2, atomId1];
    if (types_1.AminoAcidNames.has(compId) && atomId1 === 'C' && atomId2 === 'O')
        return 2;
    if (types_1.BaseNames.has(compId) && atomId1 === 'OP1' && atomId2 === 'P')
        return 2;
    return IntraBondOrderTable.get(`${compId}|${atomId1}|${atomId2}`) || 1;
}
exports.getIntraBondOrderFromTable = getIntraBondOrderFromTable;
/**
...
exports.getInterBondOrderFromTable = getInterBondOrderFromTable;
