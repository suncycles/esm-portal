...
exports.ColorSwatch = exports.getAdjustedColorMap = exports.ColorMap = exports.ColorTable = exports.ColorList = exports.Color = void 0;
...
(function (Color) {
    ...
    function saturate(c, amount) {
        if (!hasHue(c))
            return c;
        hcl_1.Hcl.fromColor(tmpSaturateHcl, c);
        return hcl_1.Hcl.toColor(hcl_1.Hcl.saturate(tmpSaturateHcl, tmpSaturateHcl, amount));
    }
    ...
    function darken(c, amount) {
        lab_1.Lab.fromColor(tmpDarkenLab, c);
        return lab_1.Lab.toColor(lab_1.Lab.darken(tmpDarkenLab, tmpDarkenLab, amount));
    }
    Color.darken = darken;
...
function ColorTable(o) { return o; }
exports.ColorTable = ColorTable;
function ColorMap(o) { return o; }
...
exports.getAdjustedColorMap = getAdjustedColorMap;
function ColorSwatch(l) { return l; }
