...
exports.getPartialMarkerAverage = exports.getMarkerInfo = exports.applyMarkerAction = exports.applyMarkerActionAtPosition = exports.setMarkerValue = exports.MarkerActions = exports.MarkerAction = void 0;
...
})(MarkerAction || (exports.MarkerAction = MarkerAction = {}));
var MarkerActions;
(function (MarkerActions) {
    MarkerActions.is = bit_flags_1.BitFlags.has;
...
})(MarkerActions || (exports.MarkerActions = MarkerActions = {}));
function setMarkerValue(array, status, count) {
    array.fill(status, 0, count);
}
exports.setMarkerValue = setMarkerValue;
...
exports.applyMarkerActionAtPosition = applyMarkerActionAtPosition;
function applyMarkerAction(array, set, action) {
    if (action === MarkerAction.None)
        return false;
    if (int_1.Interval.is(set)) {
        const start = int_1.Interval.start(set);
        const end = int_1.Interval.end(set);
        ...
        switch (action) {
            ...
            case MarkerAction.Clear:
                ...
                break;
            default:
                (0, type_helpers_1.assertUnreachable)(action);
        }
...
exports.applyMarkerAction = applyMarkerAction;
...
exports.getPartialMarkerAverage = getPartialMarkerAverage;
