...
function getSchema() {
    function detail(i) {
        return `${i} (${Math.round(100 * config_1.LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel[i] / 1000 / 1000) / 100}M voxels)`;
    }
    const detailMax = config_1.LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel.length - 1;
    const sources = config_1.ServerConfig.idMap.map(m => m[0]);
    return {
        openapi: '3.0.0',
        info: {
        ...
        paths: {
            [`${config_1.ServerConfig.apiPrefix}/{source}/{id}/`]: {
                get: {
                    tags: ['General'],
            ...
            [`${config_1.ServerConfig.apiPrefix}/{source}/{id}/box/{a1,a2,a3}/{b1,b2,b3}/`]: {
                get: {
                    tags: ['General'],
            ...
            [`${config_1.ServerConfig.apiPrefix}/{source}/{id}/cell/`]: {
                get: {
                    tags: ['General'],
