...
exports.decode = exports.encode = exports.obj = exports.array = exports.str = exports.float = exports.int = exports.bool = void 0;
const tslib_1 = require("tslib");
const UTF8 = tslib_1.__importStar(require("../../../mol-io/common/utf8"));
exports.bool = { kind: 'bool' };
exports.int = { kind: 'int' };
exports.float = { kind: 'float' };
exports.str = { kind: 'string' };
function array(element) { return { kind: 'array', element }; }
exports.array = array;
function obj(schema) {
    return {
        kind: 'object',
