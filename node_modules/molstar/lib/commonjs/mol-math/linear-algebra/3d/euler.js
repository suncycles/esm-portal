...
(function (Euler) {
    ...
    function fromMat4(out, m, order) {
        ...
        switch (order) {
            case 'XYZ':
                out[1] = Math.asin((0, interpolate_1.clamp)(m13, -1, 1));
                ...
                break;
            case 'YXZ':
                out[0] = Math.asin(-(0, interpolate_1.clamp)(m23, -1, 1));
                ...
                break;
            case 'ZXY':
                out[0] = Math.asin((0, interpolate_1.clamp)(m32, -1, 1));
                ...
                break;
            case 'ZYX':
                out[1] = Math.asin(-(0, interpolate_1.clamp)(m31, -1, 1));
                ...
                break;
            case 'YZX':
                out[2] = Math.asin((0, interpolate_1.clamp)(m21, -1, 1));
                ...
                break;
            case 'XZY':
                out[2] = Math.asin(-(0, interpolate_1.clamp)(m12, -1, 1));
