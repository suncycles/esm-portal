...
exports.SpheresRenderable = exports.SpheresSchema = void 0;
...
function SpheresRenderable(ctx, id, values, state, materialId, transparency) {
    const schema = { ...schema_1.GlobalUniformSchema, ...schema_1.GlobalTextureSchema, ...schema_1.InternalSchema, ...exports.SpheresSchema };
