...
export declare const GraphicsRenderVariants: ("color" | "emissive" | "depth" | "pick" | "marking")[];
...
export declare function createGraphicsRenderItem(ctx: WebGLContext, drawMode: DrawMode, shaderCode: ShaderCode, schema: RenderableSchema, values: RenderableValues, materialId: number, transparency: Transparency): RenderItem<"color" | "emissive" | "depth" | "pick" | "marking">;
