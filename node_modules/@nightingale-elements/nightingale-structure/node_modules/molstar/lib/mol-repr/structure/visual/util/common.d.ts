...
export declare function createUnitsTransform(structureGroup: StructureGroup, includeParent: boolean, transformData?: TransformData): TransformData;
...
export declare function isHydrogen(structure: Structure, unit: Unit, element: ElementIndex, variant: 'all' | 'non-polar'): boolean;
