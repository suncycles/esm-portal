...
var ViewportHelpContent = /** @class */ (function (_super) {
    ...
    ViewportHelpContent.prototype.render = function () {
        ...
        return _jsxs(_Fragment, { children: [(!this.props.selectOnly && this.plugin.canvas3d) && _jsx(HelpGroup, __assign({ header: 'Moving in 3D' }, { children: _jsx(BindingsHelp, { bindings: this.plugin.canvas3d.props.trackball.bindings }) }), 'trackball'), !!interactionBindings && _jsx(HelpGroup, __assign({ header: 'Mouse & Key Controls' }, { children: _jsx(BindingsHelp, { bindings: interactionBindings }) }), 'interactions')] });
    };
