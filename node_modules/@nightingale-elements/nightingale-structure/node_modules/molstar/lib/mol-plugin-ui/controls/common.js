...
export function SectionHeader(props) {
    return _jsxs("div", __assign({ className: "msp-section-header".concat(props.accent ? ' msp-transform-header-brand-' + props.accent : '') }, { children: [props.icon && _jsx(Icon, { svg: props.icon }), props.title, " ", _jsx("small", { children: props.desc })] }));
}
...
export function IconButton(props) {
    ...
    return _jsxs("button", __assign({ className: className, onClick: props.onClick, title: props.title, disabled: props.disabled, "data-id": props['data-id'], style: style }, { children: [props.svg && _jsx(Icon, { svg: props.svg }), props.extraContent] }));
}
var ToggleButton = /** @class */ (function (_super) {
    ...
    ToggleButton.prototype.render = function () {
        ...
        return _jsx(Button, __assign({ icon: this.props.icon, onClick: this.onClick, title: this.props.title, inline: this.props.inline, disabled: props.disabled, style: props.style, className: className }, { children: label && this.props.isSelected ? _jsx("b", { children: label }) : label }));
    };
    return ToggleButton;
}(React.PureComponent));
export { ToggleButton };
var ExpandGroup = /** @class */ (function (_super) {
    ...
    ExpandGroup.prototype.render = function () {
        return _jsxs(_Fragment, { children: [_jsx("div", __assign({ className: 'msp-control-group-header', style: { marginTop: this.props.marginTop !== void 0 ? this.props.marginTop : '1px', marginLeft: this.props.headerLeftMargin } }, { children: _jsxs("button", __assign({ className: 'msp-btn msp-form-control msp-btn-block', onClick: this.toggleExpanded, style: this.props.headerStyle }, { children: [_jsx(Icon, { svg: this.state.isExpanded ? ArrowDropDownSvg : ArrowRightSvg }), this.props.header] })) })), this.state.isExpanded &&
                    (this.props.noOffset
                        ? this.props.children
                        : _jsx("div", __assign({ className: this.props.accent ? 'msp-accent-offset' : 'msp-control-offset' }, { children: this.props.children })))] });
    };
    return ExpandGroup;
}(React.PureComponent));
export { ExpandGroup };
export function ControlRow(props) {
    ...
    if (props.className)
        className += ' ' + props.className;
    return _jsxs("div", __assign({ className: className }, { children: [_jsx("span", __assign({ className: 'msp-control-row-label', title: props.title }, { children: props.label })), _jsx("div", __assign({ className: 'msp-control-row-ctrl' }, { children: props.control })), props.children] }));
}
