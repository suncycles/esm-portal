...
var _ScreenshotPreview = function (props) {
    ...
    return _jsx(_Fragment, { children: _jsxs("div", __assign({ style: { position: 'relative', width: '100%', height: '100%' } }, { children: [_jsx("canvas", { ref: canvasRef, onContextMenu: function (e) { e.preventDefault(); e.stopPropagation(); }, style: { display: 'block', width: '100%', height: '100%' } }), _jsx(ViewportFrame, { plugin: plugin, canvas: currentCanvas, color: cropFrameColor })] })) });
};
