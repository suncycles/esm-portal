...
var ActionMenu = /** @class */ (function (_super) {
    ...
    ActionMenu.prototype.render = function () {
        ...
        return _jsxs("div", __assign({ className: "msp-action-menu-options".concat(cmd.header ? '' : ' msp-action-menu-options-no-header') }, { children: [cmd.header && _jsx(ControlGroup, __assign({ header: cmd.header, title: cmd.title, initialExpanded: true, hideExpander: true, hideOffset: true, onHeaderClick: this.hide, topRightIcon: CloseSvg }, { children: section })), !cmd.header && section] }));
    };
    return ActionMenu;
}(React.PureComponent));
export { ActionMenu };
...
var Action = function (_a) {
    ...
    return _jsxs(Button, __assign({ icon: item.icon, noOverflow: true, className: 'msp-action-menu-button', onClick: function (e) { return onSelect(multiselect ? [item] : item, e); }, disabled: item.disabled, style: style, title: item.description }, { children: [isCurrent || item.selected ? _jsx("b", { children: item.label }) : item.label, item.addOn] }));
};
function isItems(x) {
