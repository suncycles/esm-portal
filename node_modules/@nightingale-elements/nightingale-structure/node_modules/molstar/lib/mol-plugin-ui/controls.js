...
var StateSnapshotViewportControls = /** @class */ (function (_super) {
    ...
    StateSnapshotViewportControls.prototype.render = function () {
        ...
        return _jsxs("div", __assign({ className: 'msp-state-snapshot-viewport-controls' }, { children: [_jsxs("select", __assign({ className: 'msp-form-control', value: current || 'none', onChange: this.change, disabled: this.state.isBusy || isPlaying }, { children: [!current && _jsx("option", { value: 'none' }, 'none'), snapshots.state.entries.valueSeq().map(function (e, i) { return _jsxs("option", __assign({ value: e.snapshot.id }, { children: ["[".concat(i + 1, "/").concat(count, "]"), " ", e.name || new Date(e.timestamp).toLocaleString()] }), e.snapshot.id); })] })), _jsx(IconButton, { svg: isPlaying ? StopSvg : PlayArrowSvg, title: isPlaying ? 'Pause' : 'Cycle States', onClick: this.togglePlay, disabled: isPlaying ? false : this.state.isBusy }), !isPlaying && _jsxs(_Fragment, { children: [_jsx(IconButton, { svg: NavigateBeforeSvg, title: 'Previous State', onClick: this.prev, disabled: this.state.isBusy || isPlaying }), _jsx(IconButton, { svg: NavigateNextSvg, title: 'Next State', onClick: this.next, disabled: this.state.isBusy || isPlaying })] })] }));
    };
...
var SelectionViewportControls = /** @class */ (function (_super) {
    ...
    SelectionViewportControls.prototype.render = function () {
        if (!this.plugin.selectionMode)
            return null;
        return _jsx("div", __assign({ className: 'msp-selection-viewport-controls' }, { children: _jsx(StructureSelectionActionsControls, {}) }));
    };
...
var LociLabels = /** @class */ (function (_super) {
    ...
    LociLabels.prototype.render = function () {
        ...
        return _jsx("div", __assign({ className: 'msp-highlight-info' }, { children: this.state.labels.map(function (e, i) { return _jsx("div", { dangerouslySetInnerHTML: { __html: e } }, '' + i); }) }));
    };
    return LociLabels;
}(PluginUIComponent));
export { LociLabels };
