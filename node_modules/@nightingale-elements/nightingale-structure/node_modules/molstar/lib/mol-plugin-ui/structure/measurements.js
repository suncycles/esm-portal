...
var MeasurementControls = /** @class */ (function (_super) {
    ...
    MeasurementControls.prototype.add = function () {
        ...
        return _jsxs(_Fragment, { children: [_jsx(ActionMenu, { items: this.actions, onSelect: this.selectAction }), entries.length > 0 && _jsx("div", __assign({ className: 'msp-control-offset' }, { children: entries })), entries.length === 0 && _jsx("div", __assign({ className: 'msp-control-offset msp-help-text' }, { children: _jsxs("div", __assign({ className: 'msp-help-description' }, { children: [_jsx(Icon, { svg: HelpOutlineSvg, inline: true }), "Add one or more selections", toggleHint] })) }))] });
    };
