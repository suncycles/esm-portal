...
var GenericEntryListControls = /** @class */ (function (_super) {
    ...
    GenericEntryListControls.prototype.render = function () {
        return _jsx(_Fragment, { children: _jsxs("div", __assign({ style: { marginTop: '6px' } }, { children: [this.unitcell, this.customControls] })) });
    };
