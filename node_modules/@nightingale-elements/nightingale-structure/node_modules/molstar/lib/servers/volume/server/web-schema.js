...
export function getSchema() {
    var _a;
    function detail(i) {
        return "".concat(i, " (").concat(Math.round(100 * LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel[i] / 1000 / 1000) / 100, "M voxels)");
    }
    var detailMax = LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel.length - 1;
    var sources = ServerConfig.idMap.map(function (m) { return m[0]; });
    return {
        openapi: '3.0.0',
        info: {
        ...
        paths: (_a = {},
            _a["".concat(ServerConfig.apiPrefix, "/{source}/{id}/")] = {
                get: {
                    tags: ['General'],
            ...
            _a["".concat(ServerConfig.apiPrefix, "/{source}/{id}/box/{a1,a2,a3}/{b1,b2,b3}/")] = {
                get: {
                    tags: ['General'],
            ...
            _a["".concat(ServerConfig.apiPrefix, "/{source}/{id}/cell/")] = {
                get: {
                    tags: ['General'],
