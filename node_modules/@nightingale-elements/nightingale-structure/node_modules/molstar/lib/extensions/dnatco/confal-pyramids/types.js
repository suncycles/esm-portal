...
(function (ConfalPyramidsTypes) {
    function Location(step, isLower) {
        return DataLocation(DnatcoTypes.DataTag, { step: step, isLower: isLower }, {});
    }
    ...
    function Loci(data, elements) {
        return DataLoci(DnatcoTypes.DataTag, data, elements, undefined, function () { return elements[0] !== undefined ? confalPyramidLabel(data[elements[0]]) : ''; });
    }
