...
var tmpPos = (0, linear_algebra_1.Vec3)();
var tmpNorm = (0, linear_algebra_1.Vec3)();
...
var Canvas3dInteractionHelper = /** @class */ (function () {
    function Canvas3dInteractionHelper(canvasIdentify, lociGetter, input, camera, controls, props) {
        ...
        this.props = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(exports.Canvas3dInteractionHelperParams)), props);
    ...
    Canvas3dInteractionHelper.prototype.getLoci = function (pickingId, position) {
        ...
        if (position && repr && structure_1.Bond.isLoci(loci) && loci.bonds.length === 2) {
            ...
            if (linear_algebra_1.Vec3.distance(tmpPos, tmpPosA) < radius) {
                return { repr: repr, loci: structure_1.Bond.toFirstStructureElementLoci(loci) };
            }
        }
