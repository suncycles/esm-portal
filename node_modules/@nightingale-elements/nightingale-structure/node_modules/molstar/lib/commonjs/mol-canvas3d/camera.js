...
var transition_1 = require("./camera/transition");
var rxjs_1 = require("rxjs");
var type_helpers_1 = require("../mol-util/type-helpers");
var tmpPos1 = (0, linear_algebra_1.Vec3)();
var tmpPos2 = (0, linear_algebra_1.Vec3)();
var tmpClip = (0, linear_algebra_1.Vec4)();
var Camera = /** @class */ (function () {
    function Camera(state, viewport, props) {
        if (viewport === void 0) { viewport = util_1.Viewport.create(0, 0, 128, 128); }
    ...
    Object.defineProperty(Camera.prototype, "position", {
        ...
        set: function (v) { linear_algebra_1.Vec3.copy(this.state.position, v); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Camera.prototype, "up", {
        get: function () { return this.state.up; },
        set: function (v) { linear_algebra_1.Vec3.copy(this.state.up, v); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Camera.prototype, "target", {
        get: function () { return this.state.target; },
        set: function (v) { linear_algebra_1.Vec3.copy(this.state.target, v); },
        enumerable: false,
        configurable: true
    });
    Camera.prototype.update = function () {
        ...
        var height = 2 * Math.tan(snapshot.fov / 2) * linear_algebra_1.Vec3.distance(snapshot.position, snapshot.target);
        ...
        var changed = !linear_algebra_1.Mat4.areEqual(this.projection, this.prevProjection, linear_algebra_1.EPSILON) || !linear_algebra_1.Mat4.areEqual(this.view, this.prevView, linear_algebra_1.EPSILON);
        if (changed) {
    ...
    Camera.prototype.getPixelSize = function (point) {
        ...
        return linear_algebra_1.Vec3.distance(tmpPos1, tmpPos2);
    };
    return Camera;
}());
...
function updateClip(camera) {
    ...
    var cameraDistance = linear_algebra_1.Vec3.distance(camera.position, camera.target);
