...
var Key = binding_1.Binding.TriggerKey;
...
(function (TrackballControls) {
    function create(input, camera, scene, props) {
        ...
        var p = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(exports.TrackballControlsParams)), props), { 
            // include default bindings for backwards state compatibility
            bindings: tslib_1.__assign(tslib_1.__assign({}, exports.DefaultTrackballBindings), props.bindings) });
        var b = p.bindings;
        ...
        var _rotLastAngle = 0;
        var _rollPrev = (0, linear_algebra_1.Vec2)();
        var _rollCurr = (0, linear_algebra_1.Vec2)();
        ...
        var rollQuat = (0, linear_algebra_1.Quat)();
        var rollDir = (0, linear_algebra_1.Vec3)();
        function rollCamera() {
        ...
        var pitchQuat = (0, linear_algebra_1.Quat)();
        var pitchDir = (0, linear_algebra_1.Vec3)();
        ...
        var yawQuat = (0, linear_algebra_1.Quat)();
        var yawDir = (0, linear_algebra_1.Vec3)();
        function yawCamera() {
        ...
        var moveDir = (0, linear_algebra_1.Vec3)();
        var moveEye = (0, linear_algebra_1.Vec3)();
        function moveCamera(deltaT) {
            ...
            if (keyState.moveForward === 1) {
                ...
                var dt = linear_algebra_1.Vec3.distance(camera.target, camera.position);
                var ds = linear_algebra_1.Vec3.distance(scene.boundingSphereVisible.center, camera.position);
            ...
            if (p.flyMode || input.pointerLock) {
                var cameraDistance = linear_algebra_1.Vec3.distance(camera.position, scene.boundingSphereVisible.center);
        ...
        function onDrag(_a) {
            ...
            var dragRotate = binding_1.Binding.match(b.dragRotate, buttons, modifiers);
            var dragRotateZ = binding_1.Binding.match(b.dragRotateZ, buttons, modifiers);
            var dragPan = binding_1.Binding.match(b.dragPan, buttons, modifiers);
            var dragZoom = binding_1.Binding.match(b.dragZoom, buttons, modifiers);
            var dragFocus = binding_1.Binding.match(b.dragFocus, buttons, modifiers);
            var dragFocusZoom = binding_1.Binding.match(b.dragFocusZoom, buttons, modifiers);
        ...
        function onKeyDown(_a) {
            ...
            if (outsideViewport(x, y))
                return;
            if (binding_1.Binding.matchKey(b.keyMoveForward, code, modifiers)) {
                keyState.moveForward = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyMoveBack, code, modifiers)) {
                keyState.moveBack = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyMoveLeft, code, modifiers)) {
                keyState.moveLeft = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyMoveRight, code, modifiers)) {
                keyState.moveRight = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyMoveUp, code, modifiers)) {
                keyState.moveUp = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyMoveDown, code, modifiers)) {
                keyState.moveDown = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyRollLeft, code, modifiers)) {
                keyState.rollLeft = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyRollRight, code, modifiers)) {
                keyState.rollRight = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyPitchUp, code, modifiers)) {
                keyState.pitchUp = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyPitchDown, code, modifiers)) {
                keyState.pitchDown = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyYawLeft, code, modifiers)) {
                keyState.yawLeft = 1;
            }
            else if (binding_1.Binding.matchKey(b.keyYawRight, code, modifiers)) {
                keyState.yawRight = 1;
            }
            if (binding_1.Binding.matchKey(b.boostMove, code, modifiers)) {
                keyState.boostMove = 1;
            }
            if (binding_1.Binding.matchKey(b.enablePointerLock, code, modifiers)) {
        ...
        function onKeyUp(_a) {
            ...
            for (var _i = 0, codes_1 = codes; _i < codes_1.length; _i++) {
                ...
                if (binding_1.Binding.matchKey(b.keyMoveForward, code_1, modifiers)) {
                    keyState.moveForward = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveBack, code_1, modifiers)) {
                    keyState.moveBack = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveLeft, code_1, modifiers)) {
                    keyState.moveLeft = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveRight, code_1, modifiers)) {
                    keyState.moveRight = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveUp, code_1, modifiers)) {
                    keyState.moveUp = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveDown, code_1, modifiers)) {
                    keyState.moveDown = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyRollLeft, code_1, modifiers)) {
                    keyState.rollLeft = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyRollRight, code_1, modifiers)) {
                    keyState.rollRight = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyPitchUp, code_1, modifiers)) {
                    keyState.pitchUp = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyPitchDown, code_1, modifiers)) {
                    keyState.pitchDown = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyYawLeft, code_1, modifiers)) {
                    keyState.yawLeft = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyYawRight, code_1, modifiers)) {
                    keyState.yawRight = 0;
                }
            }
            if (binding_1.Binding.matchKey(b.boostMove, code, modifiers)) {
        ...
        function resetCameraMove() {
            ...
            var cameraDistance = linear_algebra_1.Vec3.distance(camera.position, center);
            if (cameraDistance > radius) {
                var focus_1 = camera.getFocus(center, radius);
                camera.setState(tslib_1.__assign(tslib_1.__assign({}, focus_1), { minFar: 0 }));
            }
            else {
                camera.setState({
                    minFar: 0,
