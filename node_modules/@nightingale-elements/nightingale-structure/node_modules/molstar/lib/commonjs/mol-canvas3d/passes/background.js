...
var background_frag_1 = require("../../mol-gl/shader/background.frag");
var background_vert_1 = require("../../mol-gl/shader/background.vert");
...
var vec2_1 = require("../../mol-math/linear-algebra/3d/vec2");
var color_1 = require("../../mol-util/color");
var assets_1 = require("../../mol-util/assets");
var vec4_1 = require("../../mol-math/linear-algebra/3d/vec4");
var SharedParams = {
...
var SkyboxParams = tslib_1.__assign({ faces: param_definition_1.ParamDefinition.MappedStatic('urls', {
    ...
    }), blur: param_definition_1.ParamDefinition.Numeric(0, { min: 0.0, max: 1.0, step: 0.01 }, { description: 'Note, this only works in WebGL2 or when "EXT_shader_texture_lod" is available.' }) }, SharedParams);
var ImageParams = tslib_1.__assign(tslib_1.__assign({ source: param_definition_1.ParamDefinition.MappedStatic('url', {
        url: param_definition_1.ParamDefinition.Text(''),
        file: param_definition_1.ParamDefinition.File({ accept: 'image/*' }),
    }) }, SharedParams), { coverage: param_definition_1.ParamDefinition.Select('viewport', param_definition_1.ParamDefinition.arrayToOptions(['viewport', 'canvas'])) });
...
var BackgroundPass = /** @class */ (function () {
    ...
    BackgroundPass.prototype.updateSkybox = function (camera, props, onload) {
        ...
        if (!this.skybox || !tf || !areSkyboxTexturePropsEqual(props.faces, this.skybox.props.faces)) {
            ...
            this.skybox = { texture: texture, props: tslib_1.__assign({}, props), assets: assets, loaded: false };
        ...
        if (camera.state.mode === 'orthographic') {
            this.camera.setState(tslib_1.__assign(tslib_1.__assign({}, camera.state), { mode: 'perspective' }));
            this.camera.update();
            cam = this.camera;
        }
    ...
    BackgroundPass.prototype.updateImage = function (props, onload) {
        ...
        if (!this.image || !this.image.props.source.params || !areImageTexturePropsEqual(props.source, this.image.props.source)) {
            ...
            this.image = { texture: texture, props: tslib_1.__assign({}, props), asset: asset, loaded: false };
...
var SkyboxShaderCode = (0, shader_code_1.ShaderCode)('background', background_vert_1.background_vert, background_frag_1.background_frag, {
...
function getBackgroundRenderable(ctx, width, height) {
    ...
    var schema = tslib_1.__assign({}, BackgroundSchema);
    var renderItem = (0, render_item_1.createComputeRenderItem)(ctx, 'triangles', SkyboxShaderCode, schema, values);
