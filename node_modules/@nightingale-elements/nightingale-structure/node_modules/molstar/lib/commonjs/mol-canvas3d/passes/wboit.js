...
var evaluate_wboit_frag_1 = require("../../mol-gl/shader/evaluate-wboit.frag");
var linear_algebra_1 = require("../../mol-math/linear-algebra");
var debug_1 = require("../../mol-util/debug");
var compat_1 = require("../../mol-gl/webgl/compat");
var EvaluateWboitSchema = tslib_1.__assign(tslib_1.__assign({}, util_1.QuadSchema), { tWboitA: (0, schema_1.TextureSpec)('texture', 'rgba', 'float', 'nearest'), tWboitB: (0, schema_1.TextureSpec)('texture', 'rgba', 'float', 'nearest'), uTexSize: (0, schema_1.UniformSpec)('v2') });
var EvaluateWboitShaderCode = (0, shader_code_1.ShaderCode)('evaluate-wboit', quad_vert_1.quad_vert, evaluate_wboit_frag_1.evaluateWboit_frag);
function getEvaluateWboitRenderable(ctx, wboitATexture, wboitBTexture) {
    var values = tslib_1.__assign(tslib_1.__assign({}, util_1.QuadValues), { tWboitA: mol_util_1.ValueCell.create(wboitATexture), tWboitB: mol_util_1.ValueCell.create(wboitBTexture), uTexSize: mol_util_1.ValueCell.create(linear_algebra_1.Vec2.create(wboitATexture.getWidth(), wboitATexture.getHeight())) });
    var schema = tslib_1.__assign({}, EvaluateWboitSchema);
    var renderItem = (0, render_item_1.createComputeRenderItem)(ctx, 'triangles', EvaluateWboitShaderCode, schema, values);
