...
function mountControls(orbitals, parent) {
    (0, client_1.createRoot)(parent).render((0, jsx_runtime_1.jsx)(plugin_1.PluginContextContainer, tslib_1.__assign({ plugin: orbitals.plugin }, { children: (0, jsx_runtime_1.jsx)(Controls, { orbitals: orbitals }) })));
}
...
function Controls(_a) {
    ...
    return (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: params, values: values, onChangeValues: function (vs) { return orbitals.state.next(vs); } });
}
