...
var MolStarProteopediaWrapper = /** @class */ (function () {
    function MolStarProteopediaWrapper() {
        ...
        this.coloring = {
            evolutionaryConservation: function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (!params || !!params.sequence) {
                                tree.to(helpers_1.StateElements.SequenceVisual).update(transforms_1.StateTransforms.Representation.StructureRepresentation3D, function (old) { return (tslib_1.__assign(tslib_1.__assign({}, old), { colorTheme: colorTheme })); });
                            }
                            if (params && !!params.het) {
                                tree.to(helpers_1.StateElements.HetVisual).update(transforms_1.StateTransforms.Representation.StructureRepresentation3D, function (old) { return (tslib_1.__assign(tslib_1.__assign({}, old), { colorTheme: colorTheme })); });
                            }
        ...
        this.experimentalData = {
            init: function (parent) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var asm, params;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        this.hetGroups = {
            ...
            focusFirst: function (compId, options) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                data = _a.sent();
                                (0, download_1.download)(data, "mol-star_state_".concat((0, date_1.getFormattedTime)(), ".").concat(type));
                                return [2 /*return*/];
                        }
                    });
                });
                ...
                return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                data = _a.sent();
                                this.loadedParams = tslib_1.__assign({}, this.emptyLoadedParams);
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        tree.to(helpers_1.StateElements.Assembly).update(transforms_1.StateTransforms.Model.StructureFromModel, function (p) { return (tslib_1.__assign(tslib_1.__assign({}, p), props_1)); });
    ...
    MolStarProteopediaWrapper.prototype.setBackground = function (color) {
        ...
        commands_1.PluginCommands.Canvas3D.SetSettings(this.plugin, { settings: { renderer: tslib_1.__assign(tslib_1.__assign({}, renderer), { backgroundColor: (0, color_1.Color)(color) }) } });
    };
    MolStarProteopediaWrapper.prototype.toggleSpin = function () {
        ...
        commands_1.PluginCommands.Canvas3D.SetSettings(this.plugin, {
            settings: {
                trackball: tslib_1.__assign(tslib_1.__assign({}, trackball), { animate: trackball.animate.name === 'spin'
                        ? { name: 'off', params: {} }
