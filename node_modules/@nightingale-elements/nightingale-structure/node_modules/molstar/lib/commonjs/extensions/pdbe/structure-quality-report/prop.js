...
(function (StructureQualityReport) {
    ...
    StructureQualityReport.Schema = {
        ...
        pdbe_structure_quality_report_issues: tslib_1.__assign(tslib_1.__assign({ id: db_1.Column.Schema.int }, mmcif_extras_1.mmCIF_residueId_schema), { pdbx_PDB_model_num: db_1.Column.Schema.int, issue_type_group_id: db_1.Column.Schema.int }),
...
exports.StructureQualityReportProvider = custom_model_property_1.CustomModelProperty.createProvider({
    ...
    obtain: function (ctx, data, props) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    p = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(exports.StructureQualityReportParams)), props);
