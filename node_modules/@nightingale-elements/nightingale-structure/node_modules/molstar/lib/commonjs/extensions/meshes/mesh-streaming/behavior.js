...
var utils_1 = require("../../volumes-and-segmentations/volseg-api/utils");
var mesh_extension_1 = require("../mesh-extension");
var DEFAULT_SEGMENT_NAME = 'Untitled segment';
var DEFAULT_SEGMENT_COLOR = names_1.ColorNames.lightgray;
...
var MeshStreaming = /** @class */ (function (_super) {
    tslib_1.__extends(MeshStreaming, _super);
    function MeshStreaming() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return MeshStreaming;
}(objects_1.PluginStateObject.CreateBehavior({ name: 'Mesh Streaming' })));
exports.MeshStreaming = MeshStreaming;
(function (MeshStreaming) {
    var Params;
    (function (Params) {
        Params.ViewTypeChoice = new helpers_1.Choice({ off: 'Off', select: 'Select', all: 'All' }, 'select'); // TODO add camera target?
        ...
        function copyValues(params) {
            return {
                view: {
                    ...
                    params: tslib_1.__assign({}, params.view.params),
                }
            };
        }
    ...
    var Behavior = /** @class */ (function (_super) {
        ...
        function Behavior(plugin, data, params) {
            ...
            (0, rxjs_1.map)(function (evt) { return evt.current.loci; }), (0, rxjs_1.map)(function (loci) { return (loci.kind === 'group-loci') ? loci.shape.sourceData : null; }), (0, rxjs_1.map)(function (data) { return ((data === null || data === void 0 ? void 0 : data.ownerId) === _this.id) ? data : null; }), // do not process shapes created by others
            (0, rxjs_1.distinctUntilChanged)(function (old, current) { return (old === null || old === void 0 ? void 0 : old.segmentId) === (current === null || current === void 0 ? void 0 : current.segmentId); }));
            _this.focusSubscription = undefined;
            _this.backgroundSegmentsInitialized = false;
            _this.id = mol_util_1.UUID.create22();
                    ...
                    switch (_b.label) {
                        ...
                        case 11:
                            ...
                            if (params.view.name === 'select' && !this.focusSubscription) {
                                this.focusSubscription = this.subscribeObservable(this.focusObservable, function (data) { var _a; _this.selectSegment((_a = data === null || data === void 0 ? void 0 : data.segmentId) !== null && _a !== void 0 ? _a : exports.NO_SEGMENT); });
                            }
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            asset = _a.sent();
                            return [4 /*yield*/, this.plugin.runTask(cif_1.CIF.parseBinary(asset.data))];
                        case 2:
                            parsed = _a.sent();
                            if (parsed.isError) {
                                throw new Error("Failed parsing CIF file from ".concat(url));
                            }
                            return [4 /*yield*/, mesh_extension_1.MeshlistData.fromCIF(parsed.result, visual.segmentId, visual.segmentName, visual.detail)];
                        case 3:
                ...
                return tslib_1.__generator(this, function (_a) {
                    ...
                    for (tag in this.visuals) {
                        ...
                        if (visual.detailType === 'low' && visual.data) {
                            bbox = mesh_extension_1.MeshlistData.bbox(visual.data);
                            if (bbox) {
                                bboxes[visual.segmentId] = bbox;
                            }
                        }
                    }
                    totalBbox = mesh_extension_1.MeshlistData.combineBBoxes(Object.values(bboxes));
                    totalVolume = totalBbox ? geometry_1.Box3D.volume(totalBbox) : 0.0;
                    isBgSegment = {};
                    for (segid in bboxes) {
                        bbox = bboxes[segid];
                        bboxVolume = geometry_1.Box3D.volume(bbox);
...
})(MeshStreaming = exports.MeshStreaming || (exports.MeshStreaming = {}));
exports.MeshStreaming = MeshStreaming;
