...
declare const MeshStreaming_base: {
    ...
    type: PluginStateObject.TypeInfo;
    is(obj?: import("../../../mol-state/object").StateObject<any, import("../../../mol-state/object").StateObject.Type<any>> | undefined): obj is import("../../../mol-state/object").StateObject<MeshStreaming.Behavior, PluginStateObject.TypeInfo>;
};
