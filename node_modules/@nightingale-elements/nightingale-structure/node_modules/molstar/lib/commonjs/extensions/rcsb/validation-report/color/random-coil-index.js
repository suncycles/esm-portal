...
function RandomCoilIndexColorTheme(ctx, props) {
    ...
    var scale = color_2.ColorScale.create({
        reverse: true,
        domain: [0, 0.6],
...
exports.RandomCoilIndexColorThemeProvider = {
    ...
    isApplicable: function (ctx) { return !!ctx.structure && prop_1.ValidationReport.isApplicable(ctx.structure.models[0]) && structure_1.Model.isFromNmr(ctx.structure.models[0]); },
