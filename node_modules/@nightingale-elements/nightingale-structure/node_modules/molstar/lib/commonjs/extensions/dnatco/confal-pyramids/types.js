...
(function (ConfalPyramidsTypes) {
    function Location(step, isLower) {
        return (0, location_1.DataLocation)(types_1.DnatcoTypes.DataTag, { step: step, isLower: isLower }, {});
    }
    ...
    function Loci(data, elements) {
        return (0, loci_1.DataLoci)(types_1.DnatcoTypes.DataTag, data, elements, undefined, function () { return elements[0] !== undefined ? (0, behavior_1.confalPyramidLabel)(data[elements[0]]) : ''; });
    }
