...
function getTransformLegacy(trans, rot) {
    ...
    var m = linear_algebra_1.Mat4.fromQuat((0, linear_algebra_1.Mat4)(), q);
                ...
                case 4:
                    ...
                    if (pcp) {
                        ...
                        if (ingredient.offset) {
                            ...
                            if (!linear_algebra_1.Vec3.exactEquals(o, (0, linear_algebra_1.Vec3)())) { // -1, 1, 4e-16 ??
                                if (location !== 'surface') {
                        ...
                        if (pcp) {
                            ...
                            if (!linear_algebra_1.Vec3.exactEquals(p, linear_algebra_1.Vec3.unitZ)) {
                                ...
                                m = linear_algebra_1.Mat4.fromQuat((0, linear_algebra_1.Mat4)(), q);
                                structure = structure_1.Structure.transform(structure, m);
                            }
                        }
                    }
...
function createStructureFromCellPack(plugin, packing, baseUrl, ingredientFiles) {
    var _this = this;
    return mol_task_1.Task.create('Create Packing Structure', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
var LoadCellPackModelParams = {
    ...
    preset: param_definition_1.ParamDefinition.Group({
        ...
        adjustStyle: param_definition_1.ParamDefinition.Boolean(true),
...
exports.LoadCellPackModel = mol_state_1.StateAction.build({
    ...
    return mol_task_1.Task.create('CellPack Loader', function (taskCtx) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (params.preset.adjustStyle) {
                        ...
                        ctx.managers.structure.component.setOptions(tslib_1.__assign(tslib_1.__assign({}, ctx.managers.structure.component.state.options), { visualQuality: 'custom', ignoreLight: true, hydrogens: 'hide-all' }));
