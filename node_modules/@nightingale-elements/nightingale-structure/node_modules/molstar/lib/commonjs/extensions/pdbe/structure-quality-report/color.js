...
exports.StructureQualityReportColorThemeProvider = exports.StructureQualityReportColorTheme = exports.StructureQualityReportColorThemeParams = void 0;
...
var ValidationColors = [
    color_2.Color.fromRgb(170, 170, 170),
    color_2.Color.fromRgb(0, 255, 0),
    color_2.Color.fromRgb(255, 255, 0),
    color_2.Color.fromRgb(255, 128, 0),
    color_2.Color.fromRgb(255, 0, 0), // 3 or more
];
...
function StructureQualityReportColorTheme(ctx, props) {
    ...
    if (ctx.structure && !ctx.structure.isEmpty && ctx.structure.models[0].customProperties.has(prop_1.StructureQualityReportProvider.descriptor)) {
        var getIssues_1 = prop_1.StructureQualityReport.getIssues;
        ...
        if (props.type.name === 'issue-count') {
            ...
            color = function (location) {
                if (structure_1.StructureElement.Location.is(location) && getIssues_1(location).indexOf(issue_1) >= 0) {
...
exports.StructureQualityReportColorThemeProvider = {
    ...
    isApplicable: function (ctx) { var _a; return prop_1.StructureQualityReport.isApplicable((_a = ctx.structure) === null || _a === void 0 ? void 0 : _a.models[0]); },
    ensureCustomProperties: {
        attach: function (ctx, data) { return data.structure ? prop_1.StructureQualityReportProvider.attach(ctx, data.structure.models[0], void 0, true) : Promise.resolve(); },
        detach: function (data) { return data.structure && prop_1.StructureQualityReportProvider.ref(data.structure.models[0], false); }
    }
};
