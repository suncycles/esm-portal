                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (!structureCell || !model)
                            return [2 /*return*/, {}];
                        return [4 /*yield*/, plugin.runTask(mol_task_1.Task.create('Confal Pyramids', function (runtime) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    case 4:
                        _d.sent();
                        return [2 /*return*/, { components: tslib_1.__assign(tslib_1.__assign({}, components), { pyramids: pyramids }), representations: tslib_1.__assign(tslib_1.__assign({}, representations), { pyramidsRepr: pyramidsRepr }) }];
                }
            });
        });
    }
