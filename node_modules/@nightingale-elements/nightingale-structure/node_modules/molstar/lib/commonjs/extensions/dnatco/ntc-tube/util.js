...
function getAtomPosition(vec, loc, residue, names, altId, insCode) {
    var eI = util_1.DnatcoUtil.getAtomIndex(loc, residue, names, altId, insCode);
    if (eI !== -1) {
...
var NtCTubeSegmentsIterator = /** @class */ (function () {
    function NtCTubeSegmentsIterator(structure, unit) {
        ...
        var prop = property_1.NtCTubeProvider.get(unit.model).value;
    ...
    NtCTubeSegmentsIterator.prototype.toSegment = function (r0, r1, r2, r3) {
        var indices = util_1.DnatcoUtil.getStepIndices(this.data.data, this.loc, r1);
        if (indices.length === 0)
            return void 0;
        ...
        if (!points)
            return void 0;
        return tslib_1.__assign(tslib_1.__assign({}, points), { stepIdx: stepIdx, followsGap: followsGap, firstInChain: !r0, capEnd: !this.residueNext || precedesDiscontinuity || hasGapElements(r2, this.loc.unit) });
    };
