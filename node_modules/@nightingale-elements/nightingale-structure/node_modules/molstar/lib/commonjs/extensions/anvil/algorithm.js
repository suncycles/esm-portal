...
exports.MaxAsa = exports.isHydrophobic = exports.isInMembranePlane = exports.calculate = exports.computeANVIL = exports.ANVILParams = void 0;
...
var shrake_rupley_1 = require("../../mol-model-props/computed/accessible-surface-area/shrake-rupley");
...
function computeANVIL(structure, props) {
    var _this = this;
    return mol_task_1.Task.create('Compute Membrane Orientation', function (runtime) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
var v3clone = linear_algebra_1.Vec3.clone;
var v3create = linear_algebra_1.Vec3.create;
...
var v3zero = linear_algebra_1.Vec3.zero;
var centroidHelper = new centroid_helper_1.CentroidHelper();
function initialize(structure, props, accessibleSurfaceArea) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            l = structure_1.StructureElement.Location.create(structure);
            _a = structure_1.StructureProperties.atom, label_atom_id = _a.label_atom_id, label_comp_id = _a.label_comp_id, x = _a.x, y = _a.y, z = _a.z;
            ...
            return [2 /*return*/, tslib_1.__assign(tslib_1.__assign({}, props), { structure: structure, offsets: offsets, exposed: exposed, hydrophobic: hydrophobic, centroid: centroid, extent: extent, large: offsets.length > LARGE_CA_THRESHOLD })];
        });
    });
}
function calculate(runtime, structure, params) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    asaProps = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(accessible_surface_area_1.AccessibleSurfaceAreaParams)), { probeSize: 4.0, traceOnly: true, numberOfSpherePoints: 184 });
                    return [4 /*yield*/, shrake_rupley_1.AccessibleSurfaceArea.compute(structure, asaProps).runInContext(runtime)];
                case 1:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    p = tslib_1.__assign(tslib_1.__assign({}, ctx), { maxThickness: maxThickness, stepSize: step });
...
function membraneSegments(ctx, membrane) {
    ...
    var auth_seq_id = structure_1.StructureProperties.residue.auth_seq_id;
...
function adjustExtent(ctx, membrane, centroid) {
    ...
    var l = structure_1.StructureElement.Location.create(structure);
    var testPoint = v3zero();
    var _a = structure_1.StructureProperties.atom, x = _a.x, y = _a.y, z = _a.z;
    var d1 = -v3dot(normalVector, planePoint1);
    var d2 = -v3dot(normalVector, planePoint2);
    var dMin = Math.min(d1, d2);
    var dMax = Math.max(d1, d2);
