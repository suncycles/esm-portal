...
exports.encodeMp4Animation = void 0;
var tslib_1 = require("tslib");
var HME = tslib_1.__importStar(require("h264-mp4-encoder"));
var model_1 = require("../../mol-plugin-state/animation/model");
function encodeMp4Animation(plugin, ctx, params) {
    var _a, _b, _c;
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    durationMs = model_1.PluginStateAnimation.getDuration(plugin, params.animation);
                ...
                case 2:
                    ...
                    if (vh % 2 !== 0)
                        vh -= 1;
                    normalizedViewport = tslib_1.__assign(tslib_1.__assign({}, params.viewport), { width: vw, height: vh });
                    encoder.width = vw;
                    encoder.height = vh;
