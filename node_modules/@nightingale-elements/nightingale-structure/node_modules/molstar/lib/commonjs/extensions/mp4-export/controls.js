...
var Mp4Controls = /** @class */ (function (_super) {
    tslib_1.__extends(Mp4Controls, _super);
    ...
    Mp4Controls.prototype.setCurrentParams = function (values) {
        this.behaviors.current.next(tslib_1.__assign(tslib_1.__assign({}, this.behaviors.current.value), { values: values }));
    };
    ...
    Mp4Controls.prototype.render = function () {
        var _this = this;
        var task = mol_task_1.Task.create('Export Animation', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        anim = this.current;
                        return [4 /*yield*/, (0, encoder_1.encodeMp4Animation)(this.plugin, ctx, tslib_1.__assign(tslib_1.__assign({ animation: {
