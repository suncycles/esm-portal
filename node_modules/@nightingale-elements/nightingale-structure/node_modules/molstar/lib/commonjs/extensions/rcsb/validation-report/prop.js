...
exports.ValidationReportProvider = custom_model_property_1.CustomModelProperty.createProvider({
    ...
    obtain: function (ctx, data, props) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    p = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(exports.ValidationReportParams)), props);
    ...
    for (var i = 0, il = groups.length; i < il; ++i) {
        ...
        if (isPolymer) {
            ...
            for (var j = 0, jl = molBondOutliers.length; j < jl; ++j) {
                ...
                bondOutliers.data.push(tslib_1.__assign({ tag: 'bond-outlier', atomA: atomA, atomB: atomB }, getMolInfo(bo)));
            }
            ...
            for (var j = 0, jl = molAngleOutliers.length; j < jl; ++j) {
                ...
                angleOutliers.data.push(tslib_1.__assign({ tag: 'angle-outlier', atomA: atomA, atomB: atomB, atomC: atomC }, getMolInfo(ao)));
            }
            ...
            for (var j = 0, jl = mogBondOutliers.length; j < jl; ++j) {
                ...
                addIndex(idx, atomA, bondOutliers.index);
                addIndex(idx, atomB, bondOutliers.index);
                bondOutliers.data.push(tslib_1.__assign({ tag: 'mog-bond-outlier', atomA: atomA, atomB: atomB }, getMogInfo(mbo)));
            }
            ...
            for (var j = 0, jl = mogAngleOutliers.length; j < jl; ++j) {
                ...
                addIndex(idx, atomB, angleOutliers.index);
                addIndex(idx, atomC, angleOutliers.index);
                angleOutliers.data.push(tslib_1.__assign({ tag: 'mog-angle-outlier', atomA: atomA, atomB: atomB, atomC: atomC }, getMogInfo(mao)));
            }
        }
