...
exports.sphericalCollocation = void 0;
var tslib_1 = require("tslib");
var linear_algebra_1 = require("../../mol-math/linear-algebra");
var array_1 = require("../../mol-util/array");
var spherical_functions_1 = require("./spherical-functions");
function sphericalCollocation(grid, orbital, taskCtx) {
        ...
        return tslib_1.__generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 3:
                    ...
                    L = _m[_l];
                    alpha = (0, spherical_functions_1.normalizeBasicOrder)(L, orbital.alpha.slice(baseIndex, baseIndex + 2 * L + 1), sphericalOrder);
                    baseIndex += 2 * L + 1;
...
function collocationBasis(matrix, grid, L, coefficients, exponents, center, cutoffThreshold, alpha) {
    ...
    var sphericalFunc = spherical_functions_1.SphericalFunctions[L];
...
function getRadiusBox(grid, center, radius) {
    var r = linear_algebra_1.Vec3.create(radius, radius, radius);
    var min = linear_algebra_1.Vec3.scaleAndAdd((0, linear_algebra_1.Vec3)(), center, r, -1);
    var max = linear_algebra_1.Vec3.add((0, linear_algebra_1.Vec3)(), center, r);
