...
var orbitals_1 = require("./orbitals");
...
var BasisAndOrbitals = /** @class */ (function (_super) {
    tslib_1.__extends(BasisAndOrbitals, _super);
    function BasisAndOrbitals() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return BasisAndOrbitals;
}(objects_1.PluginStateObject.Create({ name: 'Basis', typeClass: 'Object' })));
...
var CreateOrbitalVolumeParamBase = {
    ...
    gridSpacing: param_definition_1.ParamDefinition.ObjectList({ atomCount: param_definition_1.ParamDefinition.Numeric(0), spacing: param_definition_1.ParamDefinition.Numeric(0.35, { min: 0.1, max: 2, step: 0.01 }) }, function (e) { return "Atoms ".concat(e.atomCount, ": ").concat(e.spacing); }, {
        defaultValue: [
...
exports.CreateOrbitalVolume = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function (a) {
        if (!a) {
            return tslib_1.__assign({ index: param_definition_1.ParamDefinition.Numeric(0) }, CreateOrbitalVolumeParamBase);
        }
        return tslib_1.__assign({ index: param_definition_1.ParamDefinition.Select(0, a.data.orbitals.map(function (o, i) { return [i, "[".concat(i + 1, "] ").concat(o.energy.toFixed(4))]; })) }, CreateOrbitalVolumeParamBase);
    }
})({
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Orbital Volume', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, volume;
            var _a, _b, _c, _d, _e;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, (0, orbitals_1.createSphericalCollocationGrid)({
                            basis: a.data.basis,
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new objects_1.PluginStateObject.Volume.Data(volume, { label: 'Orbital Volume' })];
                }
            });
        }); });
    }
...
exports.CreateOrbitalDensityVolume = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Orbital Volume', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, (0, density_1.createSphericalCollocationDensityGrid)({
                            basis: a.data.basis,
                            cutoffThreshold: params.cutoffThreshold,
                            sphericalOrder: a.data.order,
                            boxExpand: params.boxExpand,
...
exports.CreateOrbitalRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Orbitals Representation 3D', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        repr = provider.factory(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.volume.themes), provider.getParams);
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, new objects_1.PluginStateObject.Volume.Representation3D({ repr: repr, sourceData: a.data }, { label: provider.label, description: representation_1.VolumeRepresentation3DHelpers.getDescription(props) })];
                }
            });
        }); });
    },
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        props = tslib_1.__assign(tslib_1.__assign({}, b.data.repr.props), newParams.type.params);
