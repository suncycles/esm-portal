...
(function (ColorScale) {
    function create(props) {
        var _a = tslib_1.__assign(tslib_1.__assign({}, exports.DefaultColorScaleProps), props), domain = _a.domain, reverse = _a.reverse, listOrName = _a.listOrName;
        ...
        if (hasOffsets) {
            var sorted = tslib_1.__spreadArray([], colors, true);
