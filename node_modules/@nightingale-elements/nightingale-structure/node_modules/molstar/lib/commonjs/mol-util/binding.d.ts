...
declare namespace Binding {
    ...
    function matchKey(binding: Binding, code: KeyCode, modifiers: ModifiersKeys): boolean;
    ...
    namespace Trigger {
        ...
        function matchKey(trigger: Trigger, code: KeyCode, modifiers: ModifiersKeys): boolean;
