...
(function (ParamDefinition) {
    ...
    function merge(params, a, b) {
        if (a === undefined)
            return tslib_1.__assign({}, b);
        if (b === undefined)
            return tslib_1.__assign({}, a);
    ...
    function mergeParam(p, a, b) {
        if (a === undefined)
            return typeof b === 'object' && !Array.isArray(b) ? tslib_1.__assign({}, b) : b;
        if (b === undefined)
            return typeof a === 'object' && !Array.isArray(a) ? tslib_1.__assign({}, a) : a;
        if (p.type === 'group') {
