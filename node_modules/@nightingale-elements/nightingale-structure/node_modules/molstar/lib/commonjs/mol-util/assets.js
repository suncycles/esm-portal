...
(function (Asset) {
    function Url(url, options) {
        return tslib_1.__assign({ kind: 'url', id: uuid_1.UUID.create22(), url: url }, options);
    }
    Asset.Url = Url;
    function File(file) {
...
var AssetManager = /** @class */ (function () {
    ...
    AssetManager.prototype.resolve = function (asset, type, store) {
        ...
        if (Asset.isUrl(asset)) {
            return mol_task_1.Task.create("Download ".concat(asset.title || asset.url), function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 2:
                            ...
                            _d = (_c = Asset).Wrapper;
                            return [4 /*yield*/, (0, data_source_1.ajaxGet)(tslib_1.__assign(tslib_1.__assign({}, asset), { type: type })).runInContext(ctx)];
                        case 3: return [2 /*return*/, _d.apply(_c, [_g.sent(), asset, this])];
                        case 4: return [4 /*yield*/, (0, data_source_1.ajaxGet)(tslib_1.__assign(tslib_1.__assign({}, asset), { type: 'binary' })).runInContext(ctx)];
                        case 5:
                            data = _g.sent();
                            file = new nodejs_shims_1.File_([data], 'raw-data');
            ...
            return mol_task_1.Task.create("Read ".concat(asset.name), function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
