...
var MonadicParser = /** @class */ (function () {
    ...
    MonadicParser.prototype.atLeast = function (n) {
        return MonadicParser.seq(this.times(n), this.many()).map(function (r) { return tslib_1.__spreadArray(tslib_1.__spreadArray([], r[0], true), r[1], true); });
    };
    ;
...
(function (MonadicParser) {
    ...
    function sepBy1(parser, separator) {
        ...
        return seq(parser, pairs).map(function (r) { return tslib_1.__spreadArray([r[0]], r[1], true); });
    }
...
})(MonadicParser = exports.MonadicParser || (exports.MonadicParser = {}));
exports.MonadicParser = MonadicParser;
