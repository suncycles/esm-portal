...
(function (InputObserver) {
    function create(props) {
        ...
        var _a = tslib_1.__assign(tslib_1.__assign({}, exports.DefaultInputObserverProps), props), noScroll = _a.noScroll, noContextMenu = _a.noContextMenu;
        return tslib_1.__assign(tslib_1.__assign({ noScroll: noScroll, noContextMenu: noContextMenu, pointerLock: false, width: 0, height: 0, pixelRatio: 1 }, createEvents()), { requestPointerLock: mol_util_1.noop, exitPointerLock: mol_util_1.noop, dispose: mol_util_1.noop });
    }
    InputObserver.create = create;
    function fromElement(element, props) {
        if (props === void 0) { props = {}; }
        var _a = tslib_1.__assign(tslib_1.__assign({}, exports.DefaultInputObserverProps), props), noScroll = _a.noScroll, noMiddleClickScroll = _a.noMiddleClickScroll, noContextMenu = _a.noContextMenu, noPinchZoom = _a.noPinchZoom, noTextSelect = _a.noTextSelect, mask = _a.mask, pixelScale = _a.pixelScale, preventGestures = _a.preventGestures;
        var width = element.clientWidth * pixelRatio();
        var height = element.clientHeight * pixelRatio();
        var isLocked = false;
        var lockedViewport = (0, util_1.Viewport)();
        ...
        function getModifierKeys() {
            return tslib_1.__assign({}, modifierKeys);
        }
        ...
        function handleKeyDown(event) {
            ...
            if (getKeyOnElement(event) && isInside) {
                keyDown.next(tslib_1.__assign(tslib_1.__assign({ key: event.key, code: event.code, modifiers: getModifierKeys() }, position), { preventDefault: function () { return event.preventDefault(); } }));
            }
        }
        function handleKeyUp(event) {
            ...
            if (getKeyOnElement(event) && isInside) {
                keyUp.next(tslib_1.__assign(tslib_1.__assign({ key: event.key, code: event.code, modifiers: getModifierKeys() }, position), { preventDefault: function () { return event.preventDefault(); } }));
            }
        }
        function handleKeyPress(event) {
            if (!getKeyOnElement(event) || !isInside)
                return;
            key.next(tslib_1.__assign(tslib_1.__assign({ key: event.key, code: event.code, modifiers: getModifierKeys() }, position), { preventDefault: function () { return event.preventDefault(); } }));
        }
        ...
        function onMouseWheel(ev) {
            ...
            if (normalized.dx || normalized.dy || normalized.dz) {
                wheel.next(tslib_1.__assign(tslib_1.__assign({ x: x, y: y, pageX: pageX, pageY: pageY }, normalized), { buttons: buttons, button: button, modifiers: getModifierKeys() }));
            }
        }
        ...
        return tslib_1.__assign(tslib_1.__assign({ get noScroll() { return noScroll; },
