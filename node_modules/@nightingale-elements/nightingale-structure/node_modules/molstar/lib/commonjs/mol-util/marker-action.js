...
})(MarkerAction = exports.MarkerAction || (exports.MarkerAction = {}));
var MarkerActions;
...
})(MarkerActions = exports.MarkerActions || (exports.MarkerActions = {}));
...
function applyMarkerAction(array, set, action) {
    ...
    if (int_1.Interval.is(set)) {
        var start = int_1.Interval.start(set);
        var end = int_1.Interval.end(set);
