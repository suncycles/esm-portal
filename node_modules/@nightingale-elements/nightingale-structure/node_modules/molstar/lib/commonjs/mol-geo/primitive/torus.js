...
function Torus(props) {
    var _a = tslib_1.__assign(tslib_1.__assign({}, exports.DefaultTorusProps), props), radius = _a.radius, tube = _a.tube, radialSegments = _a.radialSegments, tubularSegments = _a.tubularSegments, arc = _a.arc;
    // buffers
    var indices = [];
    var vertices = [];
    var normals = [];
