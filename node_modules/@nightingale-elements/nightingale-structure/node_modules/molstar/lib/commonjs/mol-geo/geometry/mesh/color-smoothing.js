...
function getTrilinearlyInterpolated(input) {
    ...
    var instanceCount = isInstanceType ? input.instanceCount : 1;
    var image = (0, util_1.createTextureImage)(Math.max(1, instanceCount * vertexCount), outputStride, Uint8Array);
    ...
    for (var i = 0; i < instanceCount; ++i) {
        for (var j = 0; j < vertexCount; ++j) {
            ...
            for (var k = 0; k < outputStride; ++k) {
                ...
                var s00 = (0, interpolate_1.lerp)(s000, s100, xd);
                var s01 = (0, interpolate_1.lerp)(s001, s101, xd);
                var s10 = (0, interpolate_1.lerp)(s010, s110, xd);
                var s11 = (0, interpolate_1.lerp)(s011, s111, xd);
                var s0 = (0, interpolate_1.lerp)(s00, s10, yd);
                var s1 = (0, interpolate_1.lerp)(s01, s11, yd);
