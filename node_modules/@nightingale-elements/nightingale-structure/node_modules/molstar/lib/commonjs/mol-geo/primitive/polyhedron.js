...
exports.Polyhedron = exports.DefaultPolyhedronProps = void 0;
...
function Polyhedron(_vertices, _indices, props) {
    var _a = tslib_1.__assign(tslib_1.__assign({}, exports.DefaultPolyhedronProps), props), radius = _a.radius, detail = _a.detail;
    ...
    function subdivideFace(a, b, c, detail) {
        ...
        for (var i = 0; i <= cols; ++i) {
            v[i] = [];
            var aj = (0, linear_algebra_1.Vec3)();
            linear_algebra_1.Vec3.lerp(aj, a, c, i / cols);
            var bj = (0, linear_algebra_1.Vec3)();
            ...
            for (var j = 0; j <= rows; ++j) {
                if (j === 0 && i === cols) {
                    ...
                    var abj = (0, linear_algebra_1.Vec3)();
