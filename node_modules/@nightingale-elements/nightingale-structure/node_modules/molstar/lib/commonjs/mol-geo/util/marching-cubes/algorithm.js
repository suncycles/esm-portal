...
exports.computeMarchingCubesLines = exports.computeMarchingCubesMesh = void 0;
...
function getInputParams(params) {
    return tslib_1.__assign(tslib_1.__assign({}, params), { bottomLeft: (0, mol_util_1.defaults)(params.bottomLeft, [0, 0, 0]), topRight: (0, mol_util_1.defaults)(params.topRight, params.scalarField.space.dimensions) });
}
...
function computeMarchingCubesMesh(params, mesh) {
    var _this = this;
    return mol_task_1.Task.create('Marching Cubes Mesh', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    builder = (0, builder_1.MarchinCubesMeshBuilder)(vertexChunkSize, mesh);
...
function computeMarchingCubesLines(params, lines) {
    var _this = this;
    return mol_task_1.Task.create('Marching Cubes Lines', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var inputParams, _a, dX, dY, dZ, vertexChunkSize, builder;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = getExtent(inputParams), dX = _a.dX, dY = _a.dY, dZ = _a.dZ;
                    vertexChunkSize = Math.min(262144, Math.max(dX * dY * dZ / 32, 1024));
                    builder = (0, builder_1.MarchinCubesLinesBuilder)(vertexChunkSize, lines);
                    return [4 /*yield*/, (new MarchingCubesComputation(ctx, builder, inputParams)).run()];
                case 1:
                    _b.sent();
                    return [2 /*return*/, builder.get()];
...
var MarchingCubesState = /** @class */ (function () {
    ...
    MarchingCubesState.prototype.interpolate = function (edgeNum) {
        var info = tables_1.EdgeIdInfo[edgeNum];
