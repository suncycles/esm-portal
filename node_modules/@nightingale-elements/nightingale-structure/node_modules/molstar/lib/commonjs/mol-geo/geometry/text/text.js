...
(function (Text) {
    ...
    function createValuesSimple(text, props, colorValue, sizeValue, transform) {
        ...
        var p = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(Text.Params)), props);
