...
(function (Spheres) {
    ...
    function update(centers, mappings, indices, groups, sphereCount, spheres) {
        if (sphereCount > spheres.sphereCount) {
            mol_util_1.ValueCell.update(spheres.mappingBuffer, mappings);
            mol_util_1.ValueCell.update(spheres.indexBuffer, indices);
        }
...
})(Spheres = exports.Spheres || (exports.Spheres = {}));
