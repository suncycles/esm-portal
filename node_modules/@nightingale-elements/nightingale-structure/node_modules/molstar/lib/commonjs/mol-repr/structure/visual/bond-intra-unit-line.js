...
function createIntraUnitBondLines(ctx, unit, structure, theme, props, lines) {
    ...
    if (child && !childUnit)
        return lines_1.Lines.createEmpty(lines);
    var location = structure_1.StructureElement.Location.create(structure, unit);
...
exports.IntraUnitBondLineParams = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, units_visual_1.UnitsLinesParams), bond_1.BondLineParams), { includeParent: param_definition_1.ParamDefinition.Boolean(false) });
