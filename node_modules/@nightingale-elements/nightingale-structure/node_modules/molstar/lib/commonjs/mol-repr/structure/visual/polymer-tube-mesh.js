...
function createPolymerTubeMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    var i = 0;
    var polymerTraceIt = (0, polymer_1.PolymerTraceIterator)(unit, structure, { ignoreSecondaryStructure: true });
...
exports.PolymerTubeParams = tslib_1.__assign(tslib_1.__assign({}, units_visual_1.UnitsMeshParams), exports.PolymerTubeMeshParams);
