...
var SecStrucTypeNA = types_1.SecondaryStructureType.create(536870912 /* SecondaryStructureType.Flag.NA */);
...
var AtomicPolymerTraceIterator = /** @class */ (function () {
    function AtomicPolymerTraceIterator(unit, structure, options) {
        ...
        if (options.useHelixOrientation) {
            var helixOrientation = helix_orientation_1.HelixOrientationProvider.get(unit.model).value;
            if (!helixOrientation)
