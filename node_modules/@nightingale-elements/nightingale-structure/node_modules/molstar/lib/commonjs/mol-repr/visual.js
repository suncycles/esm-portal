...
(function (Visual) {
    ...
    function setTransform(renderObject, transform, instanceTransforms) {
        ...
        var boundingSphere = (0, util_1.calculateTransformBoundingSphere)(values.invariantBoundingSphere.ref.value, values.aTransform.ref.value, values.instanceCount.ref.value, 0);
