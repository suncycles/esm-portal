...
exports.eachAtomicPolymerBackboneElement = exports.eachPolymerBackboneElement = exports.eachPolymerBackboneLink = void 0;
/**
...
function eachAtomicPolymerBackboneLink(unit, callback) {
    ...
    var polymerIt = sorted_ranges_1.SortedRanges.transientSegments((0, polymer_1.getPolymerRanges)(unit), unit.elements);
    var residueIt = int_1.Segmentation.transientSegments(unit.model.atomicHierarchy.residueAtomSegments, unit.elements);
