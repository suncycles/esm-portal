...
var single_async_queue_1 = require("../../../../mol-util/single-async-queue");
var VolumeStreaming = /** @class */ (function (_super) {
    tslib_1.__extends(VolumeStreaming, _super);
...
(function (VolumeStreaming) {
    ...
    function createDetailParams(availablePrecisions, preferredPrecision, info) {
        return param_definition_1.ParamDefinition.Select(Math.min(preferredPrecision, availablePrecisions.length - 1), availablePrecisions.map(function (p, i) { return [i, "".concat(i + 1, " [ ").concat(Math.pow(p.maxVoxels, 1 / 3) | 0, "^3 cells ]")]; }), tslib_1.__assign({ description: 'Determines the maximum number of voxels. Depending on the size of the volume options are in the range from 1 (0.52M voxels) to 7 (25.17M voxels).' }, info));
    }
            ...
            entry: {
                ...
                params: {
                    ...
                    view: {
                        ...
                        params: tslib_1.__assign({}, origParams.entry.params.view.params),
                    }
                }
            }
        };
    ...
    var Behavior = /** @class */ (function (_super) {
        ...
        function Behavior(plugin, data) {
            ...
            _this.ref = '';
            _this.cameraTargetObservable = _this.plugin.canvas3d.didDraw.pipe((0, rxjs_1.throttleTime)(500, undefined, { 'leading': true, 'trailing': true }), (0, rxjs_1.map)(function () { var _a; return (_a = _this.plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.camera.getSnapshot(); }), (0, rxjs_1.distinctUntilChanged)(function (a, b) { return _this.isCameraTargetSame(a, b); }), (0, rxjs_1.filter)(function (a) { return a !== undefined; }));
            ...
            _this.updateQueue = new single_async_queue_1.SingleAsyncQueue();
            return _this;
        }
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, commands_1.PluginCommands.State.Update(this.plugin, { state: state, tree: update, options: { doNotUpdateCurrent: true } })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Behavior.prototype.isCameraTargetSame = function (a, b) {
            if (!a || !b)
                return false;
            var targetSame = linear_algebra_1.Vec3.equals(a.target, b.target);
            var sqDistA = linear_algebra_1.Vec3.squaredDistance(a.target, a.position);
            var sqDistB = linear_algebra_1.Vec3.squaredDistance(b.target, b.position);
        ...
        Behavior.prototype.updateAuto = function (loci) {
            var _this = this;
            this.updateQueue.enqueue(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.lastLoci = loci;
                            if (!(0, loci_1.isEmptyLoci)(loci)) return [3 /*break*/, 2];
        ...
        Behavior.prototype.boxFromCameraTarget = function (snapshot, boundByBoundarySize) {
            ...
            if (boundByBoundarySize) {
                var bBoxSize = linear_algebra_1.Vec3.zero();
        ...
        Behavior.prototype.decideDetail = function (box, baseDetail) {
            ...
            var boxVolume = geometry_1.Box3D.volume(box);
