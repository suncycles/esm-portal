...
exports.InitVolumeStreaming = mol_state_1.StateAction.build({
    ...
    return mol_task_1.Task.create('Volume Streaming', function (taskCtx) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
...
exports.BoxifyVolumeStreaming = mol_state_1.StateAction.build({
    ...
    var newParams = tslib_1.__assign(tslib_1.__assign({}, params), { entry: {
            name: params.entry.name,
            params: tslib_1.__assign(tslib_1.__assign({}, params.entry.params), { view: {
                    name: 'box',
                    params: {
                        bottomLeft: box.min,
                        topRight: box.max
...
var CreateVolumeStreamingInfo = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('', function (taskCtx) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, plugin.fetch({ url: (0, url_1.urlCombine)(params.serverUrl, "".concat(e.source.name, "/").concat(dataId.toLocaleLowerCase())), type: 'json' }).runInContext(taskCtx)];
                    case 3:
                        header = _a.sent();
                        entries.push({
                            dataId: dataId,
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, new model_1.VolumeServerInfo(data, { label: 'Volume Server', description: "".concat(entries.map(function (e) { return e.dataId; }).join(', ')) })];
                }
            });
        }); });
    }
...
var CreateVolumeStreamingBehavior = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Volume streaming', function (_) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var behavior;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    update: function (_a) {
        ...
        return mol_task_1.Task.create('Update Volume Streaming', function (_) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
var VolumeStreamingVisual = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Volume Representation', function (ctx) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new objects_1.PluginStateObject.Volume.Representation3D({ repr: repr, sourceData: channel.data }, { label: "".concat(Math.round(channel.isoValue.relativeValue * 100) / 100, " \u03C3 [").concat(srcParams.channel, "]") })];
                }
            });
        }); });
    },
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        props = tslib_1.__assign(tslib_1.__assign({}, b.data.repr.props), params.type.params);
