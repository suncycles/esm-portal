...
var ViewportScreenshotHelper = /** @class */ (function (_super) {
    tslib_1.__extends(ViewportScreenshotHelper, _super);
    ...
    ViewportScreenshotHelper.prototype.createPass = function (mutlisample) {
        ...
        return c.getImagePass({
            ...
            postprocessing: tslib_1.__assign(tslib_1.__assign({}, c.props.postprocessing), { occlusion: aoProps.name === 'on'
                    ? { name: 'on', params: tslib_1.__assign(tslib_1.__assign({}, aoProps.params), { samples: 128, resolutionScale: c.webgl.pixelRatio }) }
                    : aoProps }),
            marking: tslib_1.__assign({}, c.props.marking)
        });
    };
    ...
    ViewportScreenshotHelper.prototype.toggleAutocrop = function () {
        if (this.cropParams.auto) {
            this.behaviors.cropParams.next(tslib_1.__assign(tslib_1.__assign({}, this.cropParams), { auto: false }));
            this.resetCrop();
        }
        else {
            this.behaviors.cropParams.next(tslib_1.__assign(tslib_1.__assign({}, this.cropParams), { auto: true }));
        }
    };
    ...
    ViewportScreenshotHelper.prototype.copyToClipboardTask = function () {
        ...
        return mol_task_1.Task.create('Copy Image', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var blob, item;
    ...
    ViewportScreenshotHelper.prototype.getImageDataUri = function () {
        var _this = this;
        return this.plugin.runTask(mol_task_1.Task.create('Generate Image', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.draw(ctx)];
                    case 1:
    ...
    ViewportScreenshotHelper.prototype.downloadTask = function (filename) {
        var _this = this;
        return mol_task_1.Task.create('Download Image', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var blob;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.draw(ctx)];
