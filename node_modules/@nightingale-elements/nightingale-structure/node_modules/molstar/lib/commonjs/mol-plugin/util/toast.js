...
var PluginToastManager = /** @class */ (function (_super) {
    tslib_1.__extends(PluginToastManager, _super);
    function PluginToastManager(plugin) {
        var _this = _super.call(this, { entries: (0, immutable_1.OrderedMap)() }) || this;
        _this.events = {
            changed: _this.ev()
        };
        _this.serialNumber = 0;
        _this.serialId = 0;
        commands_1.PluginCommands.Toast.Show.subscribe(plugin, function (e) { return _this.show(e); });
        commands_1.PluginCommands.Toast.Hide.subscribe(plugin, function (e) { return _this.hide(_this.findByKey(e.key)); });
        return _this;
    }
