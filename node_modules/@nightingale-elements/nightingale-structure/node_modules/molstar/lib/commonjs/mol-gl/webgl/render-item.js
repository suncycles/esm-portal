...
exports.createRenderItem = exports.createComputeRenderItem = exports.createGraphicsRenderItem = exports.ComputeRenderVariants = exports.GraphicsRenderVariantsDpoit = exports.GraphicsRenderVariantsWboit = exports.GraphicsRenderVariantsBlended = exports.GraphicsRenderVariants = exports.getDrawMode = void 0;
...
var getNextRenderItemId = (0, id_factory_1.idFactory)();
...
exports.GraphicsRenderVariantsBlended = exports.GraphicsRenderVariants.filter(function (v) { return !['colorWboit', 'colorDpoit'].includes(v); });
exports.GraphicsRenderVariantsWboit = exports.GraphicsRenderVariants.filter(function (v) { return !['colorBlended', 'colorDpoit'].includes(v); });
exports.GraphicsRenderVariantsDpoit = exports.GraphicsRenderVariants.filter(function (v) { return !['colorWboit', 'colorBlended'].includes(v); });
...
function createProgramVariant(ctx, variant, defineValues, shaderCode, schema) {
    defineValues = tslib_1.__assign(tslib_1.__assign({}, defineValues), { dRenderVariant: mol_util_1.ValueCell.create(variant) });
...
function createRenderItem(ctx, drawMode, shaderCode, schema, values, materialId, renderVariants) {
    ...
    var _b = (0, schema_1.splitValues)(schema, values), attributeValues = _b.attributeValues, defineValues = _b.defineValues, textureValues = _b.textureValues, materialTextureValues = _b.materialTextureValues, uniformValues = _b.uniformValues, materialUniformValues = _b.materialUniformValues, bufferedUniformValues = _b.bufferedUniformValues;
    ...
    var frontBufferUniformValueEntries = Object.entries((0, uniform_1.cloneUniformValues)(bufferedUniformValues));
    var defineValueEntries = Object.entries(defineValues);
    var versions = (0, schema_1.getValueVersions)(values);
    ...
    var textures = (0, texture_1.createTextures)(ctx, schema, textureValues);
    var materialTextures = (0, texture_1.createTextures)(ctx, schema, materialTextureValues);
    var attributeBuffers = (0, buffer_1.createAttributeBuffers)(ctx, schema, attributeValues);
    var elementsBuffer;
