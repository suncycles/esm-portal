...
function getGLContext(canvas, attribs) {
    ...
    if (debug_1.isDebugMode)
        console.log("isWebgl2: ".concat((0, compat_1.isWebGL2)(gl)));
    return gl;
}
...
function createContext(gl, props) {
    ...
    var timer = (0, timer_1.createTimer)(gl, extensions, stats);
    var parameters = {
    ...
    if ((0, compat_1.isWebGL2)(gl)) {
        ...
        readPixelsAsync = function (x, y, width, height, buffer) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return {
        ...
        createRenderTarget: function (width, height, depth, type, filter, format) {
            var renderTarget = (0, render_target_1.createRenderTarget)(gl, resources, width, height, depth, type, filter, format);
            renderTargets.add(renderTarget);
            return tslib_1.__assign(tslib_1.__assign({}, renderTarget), { destroy: function () {
