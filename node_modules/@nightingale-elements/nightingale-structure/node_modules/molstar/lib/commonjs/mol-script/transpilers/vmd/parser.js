...
var lang = P.MonadicParser.createLanguage({
    ...
    RangeListProperty: function (r) {
        var _a;
        return P.MonadicParser.seq((_a = P.MonadicParser).alt.apply(_a, h.getPropertyNameRules(properties_1.properties, /\s/)).skip(P.MonadicParser.whitespace), P.MonadicParser.alt(r.ValueRange, r.Value).sepBy1(P.MonadicParser.whitespace)).map(function (x) {
            var _a;
    ...
    ValuePropertyNames: function () {
        var _a;
        return (_a = P.MonadicParser).alt.apply(_a, h.getPropertyNameRules(properties_1.properties, /=~|==|>=|<=|=|!=|>|<|\)|\s|\+|-|\*|\//i));
    },
    ...
    ValueFunctions: function (r) {
        var _a;
        return (_a = P.MonadicParser).alt.apply(_a, h.getFunctionRules(functions_1.functions, r.ValueOperator));
    },
