...
export declare namespace Types {
    ...
    const Set: <T extends Type>(t?: T | undefined) => Type.Container<Set<T["@type"]>>;
    const List: <T extends Type>(t?: T | undefined) => Type.Container<List<T["@type"]>>;
    const Fn: <T extends Type>(t?: T | undefined, alias?: string) => Type.Container<(env: any) => T["@type"]>;
