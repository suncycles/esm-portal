...
var symbols = [
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.filter.within, function (ctx, xs) {
        var _a, _b, _c;
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.filter.isConnectedTo, function (ctx, xs) {
        var _a, _b;
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.bondProperty.key, function (ctx, xs) { return ctx.atomicBond.key; }),
