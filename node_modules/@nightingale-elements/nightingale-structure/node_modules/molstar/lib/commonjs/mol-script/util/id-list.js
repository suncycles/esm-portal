...
exports.compileIdListSelection = void 0;
...
function atomEntriesToQuery(xs) {
    var set = generic_1.UniqueArray.create();
    ...
    var query = builder_1.MolScriptBuilder.struct.generator.atomGroups({
        'atom-test': builder_1.MolScriptBuilder.core.set.has([builder_1.MolScriptBuilder.set.apply(builder_1.MolScriptBuilder, set.array), builder_1.MolScriptBuilder.ammp('id')])
    });
    return (0, base_1.compile)(query);
}
