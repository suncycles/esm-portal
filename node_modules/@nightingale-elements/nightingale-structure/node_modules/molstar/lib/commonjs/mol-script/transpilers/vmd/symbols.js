...
exports.Functions = [];
for (var name_3 in functions_1.functions) {
    if (!functions_1.functions[name_3].map)
        continue;
    exports.Functions.push(name_3);
}
exports.all = { Properties: exports.Properties, Operators: tslib_1.__spreadArray(tslib_1.__spreadArray([], exports.Operators, true), exports.Functions, true), Keywords: exports.Keywords };
