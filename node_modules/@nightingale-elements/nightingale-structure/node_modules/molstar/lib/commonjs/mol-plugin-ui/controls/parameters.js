...
var ParameterControls = /** @class */ (function (_super) {
    tslib_1.__extends(ParameterControls, _super);
    function ParameterControls() {
        ...
        _this.onChange = function (params) {
            ...
            if (_this.props.onChangeValues) {
                var values = tslib_1.__assign(tslib_1.__assign({}, _this.props.values), (_a = {}, _a[params.name] = params.value, _a));
    ...
    ParameterControls.prototype.renderGroup = function (group) {
        ...
        if (!ctrls)
            return null;
        if (category) {
            return [(0, jsx_runtime_1.jsx)(common_1.ExpandGroup, tslib_1.__assign({ header: category }, { children: ctrls }), category)];
        }
        return ctrls;
    };
    ...
    ParameterControls.prototype.render = function () {
        ...
        if (essentials && advanced) {
            return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [essentials, (0, jsx_runtime_1.jsx)(common_1.ExpandGroup, tslib_1.__assign({ header: 'Advanced Options' }, { children: advanced }))] });
        }
        else if (essentials) {
            return essentials;
        }
...
var ParameterMappingControl = /** @class */ (function (_super) {
    tslib_1.__extends(ParameterMappingControl, _super);
    function ParameterMappingControl() {
        ...
        _this.setSettings = function (p, old) {
            var _a;
            var values = tslib_1.__assign(tslib_1.__assign({}, old), (_a = {}, _a[p.name] = p.value, _a));
...
var ParamHelp = /** @class */ (function (_super) {
    tslib_1.__extends(ParamHelp, _super);
    function ParamHelp() {
    ...
    ParamHelp.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-help-text' }, { children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-help-description' }, { children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: icons_1.HelpOutlineSvg, inline: true }), description] })), Legend && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-help-legend' }, { children: (0, jsx_runtime_1.jsx)(Legend, { legend: legend }) }))] }) }));
    };
    return ParamHelp;
}(React.PureComponent));
...
function renderSimple(options) {
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { className: className, title: desc, label: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [label, hasHelp &&
                            (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ className: 'msp-help msp-btn-link msp-btn-icon msp-control-group-expander', onClick: toggleHelp, title: desc || "".concat(state.showHelp ? 'Hide' : 'Show', " help"), style: { background: 'transparent', textAlign: 'left', padding: '0' } }, { children: (0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: icons_1.HelpOutlineSvg }) }))] }), control: control }), hasHelp && state.showHelp && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: (0, jsx_runtime_1.jsx)(ParamHelp, { legend: help.legend, description: help.description }) })), addOn] });
}
var SimpleParam = /** @class */ (function (_super) {
    tslib_1.__extends(SimpleParam, _super);
...
var BoolControl = /** @class */ (function (_super) {
    tslib_1.__extends(BoolControl, _super);
    ...
    BoolControl.prototype.renderControl = function () {
        return (0, jsx_runtime_1.jsxs)("button", tslib_1.__assign({ onClick: this.onClick, disabled: this.props.isDisabled }, { children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: this.props.value ? icons_1.CheckSvg : icons_1.ClearSvg }), this.props.value ? 'On' : 'Off'] }));
    };
    return BoolControl;
}(SimpleParam));
exports.BoolControl = BoolControl;
var LineGraphControl = /** @class */ (function (_super) {
    tslib_1.__extends(LineGraphControl, _super);
...
var NumberInputControl = /** @class */ (function (_super) {
    tslib_1.__extends(NumberInputControl, _super);
...
var NumberRangeControl = /** @class */ (function (_super) {
    tslib_1.__extends(NumberRangeControl, _super);
...
var PureSelectControl = /** @class */ (function (_super) {
    ...
    PureSelectControl.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)("select", tslib_1.__assign({ className: 'msp-form-control', title: this.props.title, value: this.props.value !== void 0 ? this.props.value : this.props.param.defaultValue, onChange: this.onChange, disabled: this.props.isDisabled }, { children: [isInvalid && (0, jsx_runtime_1.jsx)("option", tslib_1.__assign({ value: this.props.value }, { children: "[Invalid] ".concat(this.props.value) }), this.props.value), this.props.param.options.map(function (_a) {
                    var value = _a[0], label = _a[1];
                    return (0, jsx_runtime_1.jsx)("option", tslib_1.__assign({ value: value }, { children: label }), value);
                })] }));
    };
...
var SelectControl = /** @class */ (function (_super) {
    ...
    SelectControl.prototype.renderControl = function () {
        ...
        var icon = this.props.param.cycle
            ...
            : void 0;
        return (0, jsx_runtime_1.jsx)(common_1.ToggleButton, { disabled: this.props.isDisabled, style: { textAlign: textAlign, overflow: 'hidden', textOverflow: 'ellipsis' }, label: label, title: label, icon: icon, toggle: toggle, isSelected: this.state.showOptions });
    };
...
var ValueRefControl = /** @class */ (function (_super) {
    tslib_1.__extends(ValueRefControl, _super);
...
var IntervalControl = /** @class */ (function (_super) {
    tslib_1.__extends(IntervalControl, _super);
    function IntervalControl() {
        ...
        _this.componentChange = function (_a) {
            ...
            var v = tslib_1.__spreadArray([], _this.props.value, true);
            v[+name] = value;
            _this.change(v);
        };
        _this.toggleExpanded = function (e) {
    ...
    IntervalControl.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ onClick: this.toggleExpanded, disabled: this.props.isDisabled }, { children: value })) }), this.state.isExpanded && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: (0, jsx_runtime_1.jsx)(ParameterControls, { params: this.components, values: v, onChange: this.componentChange, onEnter: this.props.onEnter }) }))] });
    };
    return IntervalControl;
}(React.PureComponent));
exports.IntervalControl = IntervalControl;
var BoundedIntervalControl = /** @class */ (function (_super) {
    tslib_1.__extends(BoundedIntervalControl, _super);
...
var ColorControl = /** @class */ (function (_super) {
    ...
    ColorControl.prototype.renderControl = function () {
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ style: { position: 'relative' } }, { children: [(0, jsx_runtime_1.jsxs)("select", tslib_1.__assign({ value: this.props.value, onChange: this.onChange }, { children: [(0, color_2.ColorValueOption)(this.props.value), (0, color_2.ColorOptions)()] })), (0, jsx_runtime_1.jsx)("div", { style: this.stripStyle() })] }));
    };
    return ColorControl;
}(SimpleParam));
...
var ColorListControl = /** @class */ (function (_super) {
    tslib_1.__extends(ColorListControl, _super);
    ...
    ColorListControl.prototype.renderControl = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("button", tslib_1.__assign({ onClick: this.toggleEdit, style: { position: 'relative', paddingRight: '33px' } }, { children: [value.colors.length === 1 ? '1 color' : "".concat(value.colors.length, " colors"), (0, jsx_runtime_1.jsx)("div", { style: colorStripStyle(value, '33px') })] })), (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.BookmarksOutlinedSvg, onClick: this.togglePresets, toggleState: this.state.show === 'presets', title: 'Color Presets', style: { padding: 0, position: 'absolute', right: 0, top: 0, width: '32px' } })] });
    };
    ColorListControl.prototype.renderColors = function () {
        ...
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: [(0, jsx_runtime_1.jsx)(ObjectListControl, { name: 'colors', param: ColorsParam, value: values, onChange: this.colorsChanged, isDisabled: this.props.isDisabled, onEnter: this.props.onEnter }), (0, jsx_runtime_1.jsx)(BoolControl, { name: 'isInterpolated', param: IsInterpolatedParam, value: this.props.value.kind === 'interpolate', onChange: this.isInterpolatedChanged, isDisabled: this.props.isDisabled, onEnter: this.props.onEnter })] }));
    };
...
var OffsetColorListControl = /** @class */ (function (_super) {
    tslib_1.__extends(OffsetColorListControl, _super);
    ...
    OffsetColorListControl.prototype.renderColors = function () {
        ...
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: [(0, jsx_runtime_1.jsx)(ObjectListControl, { name: 'colors', param: OffsetColorsParam, value: values, onChange: this.colorsChanged, isDisabled: this.props.isDisabled, onEnter: this.props.onEnter }), (0, jsx_runtime_1.jsx)(BoolControl, { name: 'isInterpolated', param: IsInterpolatedParam, value: this.props.value.kind === 'interpolate', onChange: this.isInterpolatedChanged, isDisabled: this.props.isDisabled, onEnter: this.props.onEnter })] }));
    };
...
var Vec3Control = /** @class */ (function (_super) {
    tslib_1.__extends(Vec3Control, _super);
...
var Mat4Control = /** @class */ (function (_super) {
    tslib_1.__extends(Mat4Control, _super);
    ...
    Object.defineProperty(Mat4Control.prototype, "grid", {
        get: function () {
            ...
            for (var i = 0; i < 4; i++) {
                ...
                rows.push((0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-flex-row' }, { children: row }), i));
            }
            return (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-parameter-matrix' }, { children: rows }));
        },
        enumerable: false,
        configurable: true
    });
    Mat4Control.prototype.render = function () {
        ...
        var label = this.props.param.label || (0, string_1.camelCaseToWords)(this.props.name);
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ onClick: this.toggleExpanded, disabled: this.props.isDisabled }, { children: '4\u00D74 Matrix' })) }), this.state.isExpanded && (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: [this.grid, (0, jsx_runtime_1.jsx)(ParameterControls, { params: this.components, values: v, onChange: this.componentChange, onEnter: this.props.onEnter })] }))] });
    };
    return Mat4Control;
}(React.PureComponent));
exports.Mat4Control = Mat4Control;
var UrlControl = /** @class */ (function (_super) {
    tslib_1.__extends(UrlControl, _super);
    function UrlControl() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onChange = function (e) {
            var value = e.target.value;
...
var FileListControl = /** @class */ (function (_super) {
    tslib_1.__extends(FileListControl, _super);
    ...
    FileListControl.prototype.renderControl = function () {
        ...
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-btn msp-btn-block msp-btn-action msp-loader-msp-btn-file', style: { marginTop: '1px' } }, { children: [label, " ", (0, jsx_runtime_1.jsx)("input", { disabled: this.props.isDisabled, onChange: this.onChangeFileList, type: 'file', multiple: true, accept: this.props.param.accept })] }));
    };
...
var MultiSelectControl = /** @class */ (function (_super) {
    tslib_1.__extends(MultiSelectControl, _super);
    ...
    MultiSelectControl.prototype.render = function () {
        ...
        var label = this.props.param.label || (0, string_1.camelCaseToWords)(this.props.name);
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ onClick: this.toggleExpanded, disabled: this.props.isDisabled }, { children: current.length === 0 && emptyLabel ? emptyLabel : "".concat(current.length, " of ").concat(this.props.param.options.length) })) }), this.state.isExpanded && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: this.props.param.options.map(function (_a) {
                        var value = _a[0], label = _a[1];
                        var sel = current.indexOf(value) >= 0;
                        return (0, jsx_runtime_1.jsx)(common_1.Button, tslib_1.__assign({ onClick: _this.toggle(value), disabled: _this.props.isDisabled, style: { marginTop: '1px' } }, { children: (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ style: { float: sel ? 'left' : 'right' } }, { children: sel ? "\u2713 ".concat(label) : "".concat(label, " \u2717") })) }), value);
                    }) }))] });
    };
...
var GroupControl = /** @class */ (function (_super) {
    tslib_1.__extends(GroupControl, _super);
    function GroupControl() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = { isExpanded: !!_this.props.param.isExpanded, showPresets: false, showHelp: false };
        _this.onChangeParam = function (e) {
            var _a;
            _this.change(tslib_1.__assign(tslib_1.__assign({}, _this.props.value), (_a = {}, _a[e.name] = e.value, _a)));
        };
    ...
    GroupControl.prototype.pivoted = function () {
        ...
        var ctrl = (0, jsx_runtime_1.jsx)(Control, { name: key, param: pivot, value: this.props.value[key], onChange: this.onChangeParam, onEnter: this.props.onEnter, isDisabled: this.props.isDisabled });
        if (!this.state.isExpanded) {
            return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-mapped-parameter-group' }, { children: [ctrl, (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.MoreHorizSvg, onClick: this.toggleExpanded, toggleState: this.state.isExpanded, title: "More Options" })] }));
        }
        ...
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-mapped-parameter-group' }, { children: [ctrl, (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.MoreHorizSvg, onClick: this.toggleExpanded, toggleState: this.state.isExpanded, title: "More Options" }), (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: [this.pivotedPresets(), (0, jsx_runtime_1.jsx)(ParameterControls, { params: filtered, onEnter: this.props.onEnter, values: this.props.value, onChange: this.onChangeParam, isDisabled: this.props.isDisabled })] }))] }));
    };
    GroupControl.prototype.render = function () {
        ...
        if (this.props.param.pivot)
            return this.pivoted();
        var label = this.props.param.label || (0, string_1.camelCaseToWords)(this.props.name);
        var controls = (0, jsx_runtime_1.jsx)(ParameterControls, { params: params, onChange: this.onChangeParam, values: this.props.value, onEnter: this.props.onEnter, isDisabled: this.props.isDisabled });
        if (this.props.inMapped) {
            return (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: controls }));
        }
        if (this.props.param.isFlat) {
            return controls;
        }
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-group-wrapper', style: { position: 'relative' } }, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-group-header' }, { children: (0, jsx_runtime_1.jsxs)("button", tslib_1.__assign({ className: 'msp-btn msp-form-control msp-btn-block', onClick: this.toggleExpanded }, { children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: this.state.isExpanded ? icons_1.ArrowDropDownSvg : icons_1.ArrowRightSvg }), label] })) })), this.presets(), this.state.isExpanded && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: controls }))] }));
    };
    return GroupControl;
}(React.PureComponent));
exports.GroupControl = GroupControl;
var MappedControl = /** @class */ (function (_super) {
    tslib_1.__extends(MappedControl, _super);
    ...
    MappedControl.prototype.render = function () {
        ...
        var select = help
            ? tslib_1.__assign(tslib_1.__assign({}, this.props.param.select), { help: function (name) { return help({ name: name, params: _this.getValues(name) }); } }) : this.props.param.select;
        var Select = (0, jsx_runtime_1.jsx)(SelectControl, { param: select, isDisabled: this.props.isDisabled, onChange: this.onChangeName, onEnter: this.props.onEnter, name: label, value: value.name });
        if (!Mapped) {
            return Select;
        }
        if (param.type === 'group' && !param.isFlat) {
            if (!this.areParamsEmpty(param.params)) {
                return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-mapped-parameter-group' }, { children: [Select, (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.MoreHorizSvg, onClick: this.toggleExpanded, toggleState: this.state.isExpanded, title: "".concat(label, " Properties") }), this.state.isExpanded && (0, jsx_runtime_1.jsx)(GroupControl, { inMapped: true, param: param, value: value.params, name: value.name, onChange: this.onChangeParam, onEnter: this.props.onEnter, isDisabled: this.props.isDisabled })] }));
            }
            return Select;
        }
...
var ObjectListEditor = /** @class */ (function (_super) {
    tslib_1.__extends(ObjectListEditor, _super);
    function ObjectListEditor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = { current: _this.props.value };
        _this.onChangeParam = function (e) {
            var _a;
            _this.setState({ current: tslib_1.__assign(tslib_1.__assign({}, _this.state.current), (_a = {}, _a[e.name] = e.value, _a)) });
        };
    ...
    ObjectListEditor.prototype.render = function () {
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ParameterControls, { params: this.props.params, onChange: this.onChangeParam, values: this.state.current, onEnter: this.apply, isDisabled: this.props.isDisabled }), (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ className: "msp-btn msp-btn-block msp-form-control msp-control-top-offset", onClick: this.apply, disabled: this.props.isDisabled }, { children: this.props.isUpdate ? 'Update' : 'Add' }))] });
    };
    return ObjectListEditor;
}(React.PureComponent));
var ObjectListItem = /** @class */ (function (_super) {
    tslib_1.__extends(ObjectListItem, _super);
    ...
    ObjectListItem.prototype.render = function () {
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-param-object-list-item' }, { children: [(0, jsx_runtime_1.jsxs)("button", tslib_1.__assign({ className: 'msp-btn msp-btn-block msp-form-control', onClick: this.toggleExpanded }, { children: [(0, jsx_runtime_1.jsx)("span", { children: "".concat(this.props.index + 1, ": ") }), this.props.param.getLabel(this.props.value)] })), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.ArrowDownwardSvg, title: 'Move Up', onClick: this.moveUp, small: true }), (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.ArrowUpwardSvg, title: 'Move Down', onClick: this.moveDown, small: true }), (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.DeleteOutlinedSvg, title: 'Remove', onClick: this.remove, small: true })] })] })), this.state.isExpanded && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: (0, jsx_runtime_1.jsx)(ObjectListEditor, { params: this.props.param.element, apply: this.update, value: this.props.value, isUpdate: true, isDisabled: this.props.isDisabled }) }))] });
    };
    return ObjectListItem;
}(React.PureComponent));
var ObjectListControl = /** @class */ (function (_super) {
    tslib_1.__extends(ObjectListControl, _super);
    function ObjectListControl() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = { isExpanded: false };
        _this.add = function (v) {
            _this.change(tslib_1.__spreadArray(tslib_1.__spreadArray([], _this.props.value, true), [v], false));
        };
        _this.actions = {
            update: function (v, i) {
    ...
    ObjectListControl.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.ControlRow, { label: label, control: (0, jsx_runtime_1.jsx)("button", tslib_1.__assign({ onClick: this.toggleExpanded, disabled: this.props.isDisabled }, { children: value })) }), this.state.isExpanded && (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-offset' }, { children: [this.props.value.map(function (v, i) { return (0, jsx_runtime_1.jsx)(ObjectListItem, { param: _this.props.param, value: v, index: i, actions: _this.actions, isDisabled: _this.props.isDisabled }, i); }), (0, jsx_runtime_1.jsx)(common_1.ControlGroup, tslib_1.__assign({ header: 'New Item' }, { children: (0, jsx_runtime_1.jsx)(ObjectListEditor, { params: this.props.param.element, apply: this.add, value: this.props.param.ctor(), isDisabled: this.props.isDisabled }) }))] }))] });
    };
    return ObjectListControl;
}(React.PureComponent));
exports.ObjectListControl = ObjectListControl;
var ConditionedControl = /** @class */ (function (_super) {
    tslib_1.__extends(ConditionedControl, _super);
    ...
    ConditionedControl.prototype.render = function () {
        ...
        var select = (0, jsx_runtime_1.jsx)(SelectControl, { param: this.props.param.select, isDisabled: this.props.isDisabled, onChange: this.onChangeCondition, onEnter: this.props.onEnter, name: "".concat(label, " Kind"), value: condition });
        if (!Conditioned) {
            return select;
        }
...
var ConvertedControl = /** @class */ (function (_super) {
    tslib_1.__extends(ConvertedControl, _super);
...
var ScriptControl = /** @class */ (function (_super) {
    tslib_1.__extends(ScriptControl, _super);
    function ScriptControl() {
        ...
        _this.onChange = function (_a) {
            ...
            if (value !== _this.props.value[k]) {
                _this.props.onChange({ param: _this.props.param, name: _this.props.name, value: tslib_1.__assign(tslib_1.__assign({}, _this.props.value), (_b = {}, _b[k] = value, _b)) });
            }
        };
        return _this;
    }
    ScriptControl.prototype.render = function () {
        ...
        var select = (0, jsx_runtime_1.jsx)(SelectControl, { param: selectParam, isDisabled: this.props.isDisabled, onChange: this.onChange, onEnter: this.props.onEnter, name: 'language', value: this.props.value.language });
        var textParam = {
            defaultValue: this.props.value.language,
            type: 'text',
        };
        var text = (0, jsx_runtime_1.jsx)(TextControl, { param: textParam, isDisabled: this.props.isDisabled, onChange: this.onChange, name: 'expression', value: this.props.value.expression });
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [select, this.props.value.language !== 'mol-script' && (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-help-text', style: { padding: '10px' } }, { children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: icons_1.WarningSvg }), " Support for PyMOL, VMD, and Jmol selections is an experimental feature and may not always work as intended."] })), text] });
    };
