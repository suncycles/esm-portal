...
var ActionMenu = /** @class */ (function (_super) {
    tslib_1.__extends(ActionMenu, _super);
    function ActionMenu() {
    ...
    ActionMenu.prototype.render = function () {
        var cmd = this.props;
        var section = (0, jsx_runtime_1.jsx)(Section, { items: cmd.items, onSelect: cmd.onSelect, current: cmd.current, multiselect: this.props.multiselect, noOffset: this.props.noOffset, noAccent: this.props.noAccent });
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: "msp-action-menu-options".concat(cmd.header ? '' : ' msp-action-menu-options-no-header') }, { children: [cmd.header && (0, jsx_runtime_1.jsx)(common_1.ControlGroup, tslib_1.__assign({ header: cmd.header, title: cmd.title, initialExpanded: true, hideExpander: true, hideOffset: true, onHeaderClick: this.hide, topRightIcon: icons_1.CloseSvg }, { children: section })), !cmd.header && section] }));
    };
    return ActionMenu;
}(React.PureComponent));
...
(function (ActionMenu) {
    function Header(label, options) {
        return options ? tslib_1.__assign({ kind: 'header', label: label }, options) : { kind: 'header', label: label };
    }
    ActionMenu.Header = Header;
    function Item(label, value, options) {
        return tslib_1.__assign({ kind: 'item', label: label, value: value }, options);
    }
    ...
    function createItemsFromSelectOptions(options, params) {
        return createItems(options, params ? tslib_1.__assign(tslib_1.__assign({}, _selectOptions), params) : _selectOptions);
    }
    ...
    //     }
    // }
})(ActionMenu = exports.ActionMenu || (exports.ActionMenu = {}));
exports.ActionMenu = ActionMenu;
var Section = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Section.prototype, "basicHeader", {
        get: function () {
            var _a = this.state, header = _a.header, hasCurrent = _a.hasCurrent;
            return (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-group-header', style: { marginTop: '1px' } }, { children: (0, jsx_runtime_1.jsx)(common_1.Button, tslib_1.__assign({ noOverflow: true, icon: this.state.isExpanded ? icons_1.ArrowDropDownSvg : icons_1.ArrowRightSvg, onClick: this.toggleExpanded, title: "Click to ".concat(this.state.isExpanded ? 'collapse' : 'expand', ". ").concat((header === null || header === void 0 ? void 0 : header.description) ? header === null || header === void 0 ? void 0 : header.description : '') }, { children: hasCurrent ? (0, jsx_runtime_1.jsx)("b", { children: header === null || header === void 0 ? void 0 : header.label }) : header === null || header === void 0 ? void 0 : header.label })) }));
        },
        enumerable: false,
        configurable: true
    });
    Section.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [header && (this.props.multiselect && this.state.isExpanded ? this.multiselectHeader : this.basicHeader), (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: this.props.noOffset ? void 0 : this.props.noAccent ? 'msp-control-offset' : 'msp-accent-offset' }, { children: (!header || this.state.isExpanded) && items.map(function (x, i) {
                        if (isHeader(x))
                            return null;
                        if (isItem(x))
                            return (0, jsx_runtime_1.jsx)(Action, { item: x, onSelect: onSelect, current: current, multiselect: _this.props.multiselect }, i);
                        return (0, jsx_runtime_1.jsx)(Section, { items: x, onSelect: onSelect, current: current, multiselect: _this.props.multiselect, noAccent: true }, i);
                    }) }))] });
    };
    return Section;
}(React.PureComponent));
var Action = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(common_1.Button, tslib_1.__assign({ icon: item.icon, noOverflow: true, className: 'msp-action-menu-button', onClick: function (e) { return onSelect(multiselect ? [item] : item, e); }, disabled: item.disabled, style: style, title: item.description }, { children: [isCurrent || item.selected ? (0, jsx_runtime_1.jsx)("b", { children: item.label }) : item.label, item.addOn] }));
};
function isItems(x) {
