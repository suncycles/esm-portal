...
var StructureSourceControls = /** @class */ (function (_super) {
    tslib_1.__extends(StructureSourceControls, _super);
    function StructureSourceControls() {
            ...
            switch (ref.kind) {
                case 'model': {
                    ...
                    if (model && structure_1.Model.TrajectoryInfo.get(model).size > 1) {
                        label = "".concat((_b = ref.cell.obj) === null || _b === void 0 ? void 0 : _b.data.entryId, " | Model ").concat(structure_1.Model.TrajectoryInfo.get(model).index + 1, " of ").concat(structure_1.Model.TrajectoryInfo.get(model).size);
                    }
                ...
                case 'structure': {
                    ...
                    if (model && structure_1.Model.TrajectoryInfo.get(model).size > 1) {
                        label = "".concat(model.entryId, " | ").concat((_f = ref.cell.obj) === null || _f === void 0 ? void 0 : _f.label, " (Model ").concat(structure_1.Model.TrajectoryInfo.get(model).index + 1, " of ").concat(structure_1.Model.TrajectoryInfo.get(model).size, ")");
                        break;
                    }
                    else if (model) {
        ...
        _this.getTrajectoryItems = function (t) {
            ...
            if (t.models.length === 0)
                return _this.item(t);
            return tslib_1.__spreadArray([action_menu_1.ActionMenu.Header((_a = t.cell.obj) === null || _a === void 0 ? void 0 : _a.label)], t.models.map(_this.getModelItems), true);
        };
        _this.getModelItems = function (m) {
            ...
            return tslib_1.__spreadArray([action_menu_1.ActionMenu.Header((_c = m.cell.obj) === null || _c === void 0 ? void 0 : _c.label)], m.structures.map(_this.item), true);
        };
        ...
        get: function () {
            ...
            if (models.length > 0) {
                ...
                if (models.length === 1) {
                    ...
                    if (model && structure_1.Model.TrajectoryInfo.get(model).size > 1) {
                        return "".concat((_l = t === null || t === void 0 ? void 0 : t.cell.obj) === null || _l === void 0 ? void 0 : _l.label, " | Model ").concat(structure_1.Model.TrajectoryInfo.get(model).index + 1, " of ").concat(structure_1.Model.TrajectoryInfo.get(model).size);
                    }
                    else {
    ...
    Object.defineProperty(StructureSourceControls.prototype, "transform", {
        get: function () {
            ...
            if (!pivot.cell.parent)
                return null;
            var t = mol_state_1.StateSelection.tryFindDecorator(this.plugin.state.data, pivot.cell.transform.ref, transforms_1.StateTransforms.Model.TransformStructureConformation);
            if (!t)
                return;
            return (0, jsx_runtime_1.jsx)(common_1.ExpandGroup, tslib_1.__assign({ header: "Conformation Transform" }, { children: (0, jsx_runtime_1.jsx)(update_transform_1.UpdateTransformControl, { state: t.parent, transform: t.transform, customHeader: 'none', noMargin: true, autoHideApply: true }) }));
        },
        enumerable: false,
        configurable: true
    });
