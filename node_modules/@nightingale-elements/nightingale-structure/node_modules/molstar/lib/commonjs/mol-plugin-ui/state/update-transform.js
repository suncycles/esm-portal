...
var UpdateTransformControl = /** @class */ (function (_super) {
    tslib_1.__extends(UpdateTransformControl, _super);
...
var TransformUpdaterControl = /** @class */ (function (_super) {
    tslib_1.__extends(TransformUpdaterControl, _super);
    ...
    TransformUpdaterControl.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsx)(UpdateTransformControl, { state: state, transform: transform, initiallyCollapsed: this.props.initiallyCollapsed, customHeader: this.props.header });
    };
