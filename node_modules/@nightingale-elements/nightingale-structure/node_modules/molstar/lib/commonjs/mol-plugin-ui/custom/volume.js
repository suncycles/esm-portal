...
var Channel = /** @class */ (function (_super) {
    ...
    function Channel() {
        ...
        _this.ref = mol_state_1.StateSelection.findTagInSubtree(_this.plugin.state.data.tree, _this.props.bCell.transform.ref, _this.props.name);
...
var VolumeStreamingCustomControls = /** @class */ (function (_super) {
    ...
    function VolumeStreamingCustomControls() {
        ...
        _this.changeParams = function (name, param, value) {
            ...
            _this.newParams(tslib_1.__assign(tslib_1.__assign({}, old), { entry: {
                    name: old.entry.name,
                    params: tslib_1.__assign(tslib_1.__assign({}, old.entry.params), { channels: tslib_1.__assign(tslib_1.__assign({}, old.entry.params.channels), (_a = {}, _a[name] = tslib_1.__assign(tslib_1.__assign({}, old.entry.params.channels[name]), (_b = {}, _b[param] = value, _b)), _a)) })
                } }));
        };
        _this.changeOption = function (_a) {
            ...
            if (name === 'entry') {
                ...
                var viewParams = tslib_1.__assign({}, oldView);
                ...
                _this.newParams(tslib_1.__assign(tslib_1.__assign({}, old), { entry: {
                        name: old.entry.name,
                        params: tslib_1.__assign(tslib_1.__assign({}, old.entry.params), { view: {
                                name: value.name,
                                params: viewParams
    ...
    VolumeStreamingCustomControls.prototype.convert = function (channel, stats, isRelative) {
        return tslib_1.__assign(tslib_1.__assign({}, channel), { isoValue: isRelative
    ...
    VolumeStreamingCustomControls.prototype.render = function () {
        ...
        var dynamicDetailLevel = tslib_1.__assign(tslib_1.__assign({}, detailLevel), { label: 'Dynamic Detail', defaultValue: entry.params.view.map('camera-target').params.dynamicDetailLevel.defaultValue });
        var selectionDetailLevel = tslib_1.__assign(tslib_1.__assign({}, detailLevel), { label: 'Selection Detail', defaultValue: entry.params.view.map('auto').params.selectionDetailLevel.defaultValue });
        var sampling = b.info.header.sampling[0];
        var isRelative = params.entry.params.channels[pivot].isoValue.kind === 'relative';
        var isRelativeParam = param_definition_1.ParamDefinition.Boolean(isRelative, { description: 'Use normalized or absolute isocontour scale.', label: 'Normalized' });
        var isUnbounded = !!params.entry.params.view.params.isUnbounded;
        var isUnboundedParam = param_definition_1.ParamDefinition.Boolean(isUnbounded, { description: 'Show full/limited range of iso-values for more fine-grained control.', label: 'Unbounded' });
        var isOff = params.entry.params.view.name === 'off';
        // TODO: factor common things out, cache
        var OptionsParams = {
            entry: param_definition_1.ParamDefinition.Select(params.entry.name, b.data.entries.map(function (info) { return [info.dataId, info.dataId]; }), { isHidden: isOff, description: 'Which entry with volume data to display.' }),
            view: param_definition_1.ParamDefinition.MappedStatic(params.entry.params.view.name, {
                ...
                'camera-target': param_definition_1.ParamDefinition.Group({
                    ...
                    detailLevel: tslib_1.__assign(tslib_1.__assign({}, detailLevel), { isHidden: true }),
