...
var Sequence = /** @class */ (function (_super) {
    ...
    function Sequence() {
        ...
        _this.mouseMove = function (e) {
            ...
            if (_this.lastMouseOverSeqIdx === seqIdx) {
                ...
                if (_this.mouseDownLoci !== undefined) {
                    var loci = _this.getLoci(seqIdx);
                    _this.hover(loci, input_observer_1.ButtonsType.Flag.None, input_observer_1.ButtonsType.Flag.None, tslib_1.__assign(tslib_1.__assign({}, modifiers), { shift: true }));
                }
                else {
    ...
    Sequence.prototype.componentDidMount = function () {
        ...
        this.subscribe(this.highlightQueue.pipe((0, operators_1.throttleTime)(3 * 16.666, void 0, { leading: true, trailing: true })), function (e) {
    ...
    Sequence.prototype.residue = function (seqIdx, label, marker) {
        return (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ "data-seqid": seqIdx, style: { backgroundColor: this.getBackgroundColor(marker) }, className: this.getResidueClass(seqIdx, label) }, { children: "\u200B".concat(label, "\u200B") }), seqIdx);
    };
    ...
    Sequence.prototype.getSequenceNumberSpan = function (seqIdx, label) {
        ...
        return (0, jsx_runtime_1.jsx)("span", tslib_1.__assign({ className: this.getSequenceNumberClass(seqIdx, seqNum, label) }, { children: this.padSeqNum(seqNum) }), "marker-".concat(seqIdx));
    };
    ...
    Sequence.prototype.render = function () {
        ...
        this.updateMarker();
        return (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-sequence-wrapper', onContextMenu: this.contextMenu, onMouseDown: this.mouseDown, onMouseUp: this.mouseUp, onMouseMove: this.mouseMove, onMouseLeave: this.mouseLeave, ref: this.parentDiv }, { children: elems }));
    };
    return Sequence;
