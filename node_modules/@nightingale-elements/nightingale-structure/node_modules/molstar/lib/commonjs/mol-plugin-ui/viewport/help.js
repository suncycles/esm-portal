...
function getBindingsList(bindings) {
    return Object.keys(bindings).map(function (k) { return [k, bindings[k]]; }).filter(function (b) { return binding_1.Binding.isBinding(b[1]); });
}
var BindingsHelp = /** @class */ (function (_super) {
    tslib_1.__extends(BindingsHelp, _super);
    ...
    BindingsHelp.prototype.getBindingComponents = function () {
        ...
        return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: bindingsList.map(function (value) {
                var name = value[0], binding = value[1];
                return !binding_1.Binding.isEmpty(binding)
                    ? (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ style: { marginBottom: '6px' } }, { children: [(0, jsx_runtime_1.jsx)("b", { children: binding.action }), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("span", { dangerouslySetInnerHTML: { __html: binding_1.Binding.format(binding, name) } })] }), name)
                    : null;
            }) });
    };
...
var HelpText = /** @class */ (function (_super) {
    tslib_1.__extends(HelpText, _super);
    function HelpText() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HelpText.prototype.render = function () {
        return (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-help-text' }, { children: (0, jsx_runtime_1.jsx)("div", { children: this.props.children }) }));
    };
    return HelpText;
}(React.PureComponent));
exports.HelpText = HelpText;
var HelpGroup = /** @class */ (function (_super) {
    tslib_1.__extends(HelpGroup, _super);
    function HelpGroup() {
    ...
    HelpGroup.prototype.render = function () {
        return (0, jsx_runtime_1.jsxs)("div", tslib_1.__assign({ className: 'msp-control-group-wrapper' }, { children: [(0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-group-header' }, { children: (0, jsx_runtime_1.jsxs)(common_1.Button, tslib_1.__assign({ onClick: this.toggleExpanded }, { children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: this.state.isExpanded ? icons_1.ArrowDropDownSvg : icons_1.ArrowRightSvg }), this.props.header] })) })), this.state.isExpanded && (0, jsx_runtime_1.jsx)("div", tslib_1.__assign({ className: 'msp-control-offset', style: { display: this.state.isExpanded ? 'block' : 'none' } }, { children: this.props.children }))] }));
    };
    return HelpGroup;
}(React.PureComponent));
...
var ViewportHelpContent = /** @class */ (function (_super) {
    tslib_1.__extends(ViewportHelpContent, _super);
    function ViewportHelpContent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.getInteractionBindings = (0, memoize_1.memoizeLatest)(function (cells) {
    ...
    ViewportHelpContent.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(!this.props.selectOnly && this.plugin.canvas3d) && (0, jsx_runtime_1.jsx)(HelpGroup, tslib_1.__assign({ header: 'Moving in 3D' }, { children: (0, jsx_runtime_1.jsx)(BindingsHelp, { bindings: this.plugin.canvas3d.props.trackball.bindings }) }), 'trackball'), !!interactionBindings && (0, jsx_runtime_1.jsx)(HelpGroup, tslib_1.__assign({ header: 'Mouse & Key Controls' }, { children: (0, jsx_runtime_1.jsx)(BindingsHelp, { bindings: interactionBindings }) }), 'interactions')] });
    };
...
var HelpContent = /** @class */ (function (_super) {
    tslib_1.__extends(HelpContent, _super);
