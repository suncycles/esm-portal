...
var PointComponent = /** @class */ (function (_super) {
    ...
    PointComponent.prototype.handleHover = function () {
        ...
        var point = linear_algebra_1.Vec2.create(this.props.nX, this.props.nY);
    ...
    PointComponent.prototype.render = function () {
        return ([
            (0, jsx_runtime_1.jsx)("circle", { r: "10", id: "".concat(this.props.id), cx: this.props.x, cy: this.props.y, onClick: this.props.onclick, onDoubleClick: this.props.delete(this.props.id), onMouseEnter: this.handleHover, onMouseLeave: this.handleHoverOff, onMouseDown: this.props.onmousedown, fill: "black" }, "".concat(this.props.id, "circle"))
        ]);
    };
