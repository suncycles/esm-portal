...
exports.refineInteractions = void 0;
...
function refineInteractions(structure, interactions) {
    ...
    for (var i = 0, il = contacts.edgeCount; i < il; ++i) {
        ...
        var infoA = features_1.Features.Info(structure, uA, unitsFeatures.get(e.unitA));
        infoA.feature = e.indexA;
        var infoB = features_1.Features.Info(structure, uB, unitsFeatures.get(e.unitB));
    ...
    while (true) {
        ...
        var infoB = features_1.Features.Info(structure, unit, features);
...
function hydrophobicRefiner(structure, interactions) {
    ...
    function handleEdge(edge, infoA, infoB, map, set) {
        ...
        var dist = features_1.Features.distance(infoA, infoB);
        handleResidueContact(dist, edge, keyA, map, set);
        handleResidueContact(dist, edge, keyB, map, set);
    }
    var residueInterMap = new Map();
    var setInterFiltered = function (i) { return contacts.edges[i].props.flag = common_1.InteractionFlag.Filtered; };
    var residueIntraMap;
    var setIntraFiltered;
    return {
        isApplicable: function (type) { return type === common_1.InteractionType.Hydrophobic; },
        ...
        startUnit: function (unit, contacts, features) {
            ...
            setIntraFiltered = function (i) { return contacts.edgeProps.flag[i] = common_1.InteractionFlag.Filtered; };
        },
...
function weakHydrogenBondsRefiner(structure, interactions) {
    ...
    return {
        isApplicable: function (type) { return type === common_1.InteractionType.WeakHydrogenBond; },
        handleInterContact: function (index, infoA, infoB) {
...
function saltBridgeRefiner(structure, interactions) {
    var contacts = interactions.contacts;
    return {
        isApplicable: function (type) { return type === common_1.InteractionType.Ionic; },
        handleInterContact: function (index, infoA, infoB) {
...
function piStackingRefiner(structure, interactions) {
    var contacts = interactions.contacts;
    return {
        isApplicable: function (type) { return type === common_1.InteractionType.Hydrophobic || type === common_1.InteractionType.CationPi; },
        handleInterContact: function (index, infoA, infoB) {
