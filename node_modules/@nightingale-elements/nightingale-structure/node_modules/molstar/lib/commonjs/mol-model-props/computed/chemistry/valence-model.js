...
exports.calcValenceModel = exports.ValenceModelParams = exports.calculateHydrogensCharge = exports.explicitValence = void 0;
 ...
 *
 */
var tmpConjBondItA = new structure_1.Bond.ElementBondIterator();
var tmpConjBondItB = new structure_1.Bond.ElementBondIterator();
/**
...
function isConjugated(structure, unit, index) {
    ...
    while (tmpConjBondItA.hasNext) {
        ...
        if (bA.order > 1)
            return true;
        if (hetero) {
            var elementB = (0, util_1.typeSymbol)(bA.otherUnit, bA.otherIndex);
...
var tmpChargeBondItA = new structure_1.Bond.ElementBondIterator();
var tmpChargeBondItB = new structure_1.Bond.ElementBondIterator();
/**
...
function calculateHydrogensCharge(structure, unit, index, props) {
    ...
    var degree = (0, util_1.bondCount)(structure, unit, index);
    ...
    var geom = geometry_1.AtomGeometry.Unknown;
    switch (element) {
        case "H" /* Elements.H */:
            if (assignCharge) {
                if (degree === 0) {
...
function calcValenceModel(ctx, structure, props) {
