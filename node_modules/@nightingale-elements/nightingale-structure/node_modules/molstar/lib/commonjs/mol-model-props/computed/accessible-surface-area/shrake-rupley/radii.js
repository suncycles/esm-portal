...
exports.assignRadiusForHeavyAtoms = void 0;
var common_1 = require("./common");
var common_2 = require("../../../../mol-model/structure/structure/unit/bonds/common");
...
function assignRadiusForHeavyAtoms(ctx) {
    var key = structure_1.StructureProperties.residue.key;
    var _a = structure_1.StructureProperties.atom, type_symbol = _a.type_symbol, label_atom_id = _a.label_atom_id, label_comp_id = _a.label_comp_id;
    ...
    for (var i = 0, m = 0, il = structure.units.length; i < il; ++i) {
        ...
        for (var j = 0, jl = elements.length; j < jl; ++j) {
            ...
            var elementIdx = (0, common_2.getElementIdx)(element);
            // skip hydrogen atoms
...
function handleNonStandardCase(element) {
    var radius = (0, atomic_1.VdwRadius)(element);
    var index = common_1.VdWLookup.indexOf(radius);
    if (index === -1) {
