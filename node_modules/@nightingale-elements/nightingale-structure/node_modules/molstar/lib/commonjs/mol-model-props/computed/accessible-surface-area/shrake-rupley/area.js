...
function computeArea(runtime, ctx) {
...
function computeRange(ctx, begin, end) {
    ...
    for (var aI = begin; aI < end; ++aI) {
        var vdw1 = common_1.VdWLookup[atomRadiusType[aI]];
        if (vdw1 === common_1.VdWLookup[0])
            continue;
        ...
        for (var iI = 0; iI < count; ++iI) {
            ...
            var vdw2 = common_1.VdWLookup[atomRadiusType[bI]];
            if ((aUnit === bUnit && aElementIndex === bElementIndex) || vdw2 === common_1.VdWLookup[0])
                continue;
