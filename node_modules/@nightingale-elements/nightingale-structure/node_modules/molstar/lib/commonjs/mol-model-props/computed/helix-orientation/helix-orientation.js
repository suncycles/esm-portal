...
exports.calcHelixOrientation = void 0;
var segmentation_1 = require("../../../mol-data/int/segmentation");
...
function calcHelixOrientation(model) {
    ...
    var elements = int_1.OrderedSet.ofBounds(0, model.atomicConformation.atomId.rowCount);
    var polymerIt = sorted_ranges_1.SortedRanges.transientSegments(model.atomicRanges.polymerRanges, elements);
    var residueIt = segmentation_1.Segmentation.transientSegments(model.atomicHierarchy.residueAtomSegments, elements);
    var centers = new Float32Array(n * 3);
    var axes = new Float32Array(n * 3);
    var i = 0;
    var j = -1;
    var s = -1;
    var a1 = (0, linear_algebra_1.Vec3)();
    var a2 = (0, linear_algebra_1.Vec3)();
    var a3 = (0, linear_algebra_1.Vec3)();
    var a4 = (0, linear_algebra_1.Vec3)();
    var r12 = (0, linear_algebra_1.Vec3)();
    var r23 = (0, linear_algebra_1.Vec3)();
    var r34 = (0, linear_algebra_1.Vec3)();
    var v1 = (0, linear_algebra_1.Vec3)();
    var v2 = (0, linear_algebra_1.Vec3)();
    var vt = (0, linear_algebra_1.Vec3)();
    var diff13 = (0, linear_algebra_1.Vec3)();
    var diff24 = (0, linear_algebra_1.Vec3)();
    var axis = (0, linear_algebra_1.Vec3)();
    var prevAxis = (0, linear_algebra_1.Vec3)();
    while (polymerIt.hasNext) {
        ...
        while (residueIt.hasNext) {
            ...
            linear_algebra_1.Vec3.set(a4, x[eI_1], y[eI_1], z[eI_1]);
            if (i < 3)
                continue;
            ...
            var tmp = Math.cos(linear_algebra_1.Vec3.angle(diff13, diff24));
            var diff13Length = linear_algebra_1.Vec3.magnitude(diff13);
            var diff24Length = linear_algebra_1.Vec3.magnitude(diff24);
