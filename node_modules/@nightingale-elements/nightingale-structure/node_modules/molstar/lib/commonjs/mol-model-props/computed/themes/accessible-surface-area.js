...
var accessible_surface_area_1 = require("../accessible-surface-area");
...
function AccessibleSurfaceAreaColorTheme(ctx, props) {
    ...
    var accessibleSurfaceArea = ctx.structure && accessible_surface_area_1.AccessibleSurfaceAreaProvider.get(ctx.structure);
    var contextHash = accessibleSurfaceArea ? (0, util_1.hash2)(accessibleSurfaceArea.id, accessibleSurfaceArea.version) : -1;
    if ((accessibleSurfaceArea === null || accessibleSurfaceArea === void 0 ? void 0 : accessibleSurfaceArea.value) && ctx.structure) {
        ...
        var getColor_1 = function (location) {
            var value = shrake_rupley_1.AccessibleSurfaceArea.getNormalizedValue(location, asa_1);
...
exports.AccessibleSurfaceAreaColorThemeProvider = {
    ...
    ensureCustomProperties: {
        attach: function (ctx, data) { return data.structure ? accessible_surface_area_1.AccessibleSurfaceAreaProvider.attach(ctx, data.structure, void 0, true) : Promise.resolve(); },
        detach: function (data) { return data.structure && accessible_surface_area_1.AccessibleSurfaceAreaProvider.ref(data.structure, false); }
    }
};
