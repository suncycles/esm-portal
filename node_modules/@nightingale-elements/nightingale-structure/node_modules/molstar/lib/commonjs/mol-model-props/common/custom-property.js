        ...
        Registry.prototype.getParams = function (data) {
            ...
            if (data) {
                ...
                while (true) {
                    ...
                    propertiesParams[provider.descriptor.name] = param_definition_1.ParamDefinition.Group(tslib_1.__assign({}, provider.getParams(data)), { label: provider.label, isHidden: provider.isHidden });
                }
            }
            return {
