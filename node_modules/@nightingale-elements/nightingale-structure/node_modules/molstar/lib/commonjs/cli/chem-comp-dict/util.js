...
function ensureAvailable(path, url, forceDownload) {
...
function ensureDataAvailable(options) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function readFileAsCollection(path, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var parsed, _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    parsed = _b.sent();
                    return [2 /*return*/, cif_1.CIF.toDatabaseCollection(schema, parsed.result)];
            }
        });
    });
}
...
function readCCD() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, readFileAsCollection(CCD_PATH, ccd_1.CCD_Schema)];
        });
    });
}
...
function readPVCD() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, readFileAsCollection(PVCD_PATH, ccd_1.CCD_Schema)];
        });
    });
}
...
function getEncodedCif(name, database, binary) {
    if (binary === void 0) { binary = false; }
    var encoder = cif_2.CifWriter.createEncoder({ binary: binary, encoderName: 'mol*' });
