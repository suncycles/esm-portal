...
exports.generateSchema = exports.getFieldType = void 0;
...
function getImportFrames(d, imports) {
    ...
    if (!('import' in d.categories))
        return frames;
    var importGet = (0, helper_1.parseImportGet)(d.categories['import'].getField('get').str(0));
...
function generateSchema(frames, imports) {
    if (imports === void 0) { imports = new Map(); }
    var tables = {};
    var aliases = tslib_1.__assign({}, EXTRA_ALIASES);
    var categories = {};
    var links = {};
