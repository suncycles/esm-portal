...
(function (Transformer) {
    ...
    function create(namespace, definition) {
        ...
        var t = {
            apply: function (parent, params, props) { return transform_1.StateTransform.create(parent, t, params, props); },
            toAction: function () { return action_1.StateAction.fromTransformer(t); },
            namespace: namespace,
            id: id,
    ...
    (function (Builder) {
        function root(namespace, info) {
            return function (def) { return create(namespace, tslib_1.__assign({ name: info.name, from: info.from instanceof Array ? info.from : [info.from], to: info.to instanceof Array ? info.to : [info.to], display: typeof info.display === 'string'
                    ? { name: info.display }
                    : !!info.display
                        ? info.display
                        : { name: (0, string_1.capitalize)(info.name.replace(/[-]/g, ' ')) }, params: typeof info.params === 'object'
...
exports.StateTransformer = Transformer;
