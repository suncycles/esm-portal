...
exports.ViewerAutoPreset = exports.Viewer = exports.consoleStats = exports.setTimingMode = exports.setProductionMode = exports.setDebugMode = exports.version = void 0;
...
var volumes_and_segmentations_1 = require("../../extensions/volumes-and-segmentations");
...
var zenodo_1 = require("../../extensions/zenodo");
...
var backgrounds_1 = require("../../extensions/backgrounds");
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        o = tslib_1.__assign(tslib_1.__assign({}, DefaultViewerOptions), definedOptions);
                        defaultSpec = (0, spec_1.DefaultPluginUISpec)();
                        spec = {
                            actions: defaultSpec.actions,
                            behaviors: tslib_1.__spreadArray(tslib_1.__spreadArray([], defaultSpec.behaviors, true), o.extensions.map(function (e) { return Extensions[e]; }), true),
                            animations: tslib_1.__spreadArray([], defaultSpec.animations || [], true),
        ...
        return this.plugin.runTask(this.plugin.state.data.applyAction(structure_1.DownloadStructure, {
            source: {
                ...
                params: {
                    ...
                    options: tslib_1.__assign(tslib_1.__assign({}, params.source.params.options), { representationParams: options === null || options === void 0 ? void 0 : options.representationParams }),
                }
            }
        }));
    };
    ...
    Viewer.prototype.loadAlphaFoldDb = function (afdb) {
        ...
        return this.plugin.runTask(this.plugin.state.data.applyAction(structure_1.DownloadStructure, {
            source: {
                ...
                params: {
                    id: afdb,
                    options: tslib_1.__assign(tslib_1.__assign({}, params.source.params.options), { representation: 'preset-structure-representation-ma-quality-assessment-plddt' }),
                }
            }
        }));
    };
            ...
            return tslib_1.__generator(this, function (_b) {
                ...
                if (options === null || options === void 0 ? void 0 : options.isLazy) {
                    ...
                    update.toRoot().apply(transforms_1.StateTransforms.Data.LazyVolume, {
                        ...
                        isBinary: isBinary,
                        isovalues: isovalues.map(function (v) { return (tslib_1.__assign({ alpha: 1, volumeIndex: 0 }, v)); })
                    });
