...
var structure_set_1 = require("../../../mol-model/structure/query/utils/structure-set");
...
var structure_overpaint_1 = require("../../helpers/structure-overpaint");
...
var structure_clipping_1 = require("../../helpers/structure-clipping");
var structure_transparency_1 = require("../../helpers/structure-transparency");
...
var StructureComponentManager = /** @class */ (function (_super) {
    tslib_1.__extends(StructureComponentManager, _super);
    function StructureComponentManager(plugin) {
        var _this = _super.call(this, { options: param_definition_1.ParamDefinition.getDefaultValues(StructureComponentManager.OptionsParams) }) || this;
        _this.plugin = plugin;
        _this.events = {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        s = _d[_i];
                        interactionParams = interactions_1.InteractionsProvider.getParams((_a = s.cell.obj) === null || _a === void 0 ? void 0 : _a.data);
                        if (!s.properties) return [3 /*break*/, 3];
                        oldParams = (_b = s.properties.cell.transform.params) === null || _b === void 0 ? void 0 : _b.properties[interactions_1.InteractionsProvider.descriptor.name];
                        ...
                        return [4 /*yield*/, this.dataState.build().to(s.properties.cell)
                                .update(function (old) {
                                old.properties[interactions_1.InteractionsProvider.descriptor.name] = _this.state.options.interactions;
                            })
                                .commit()];
                    case 2:
                        _e.sent();
    ...
    StructureComponentManager.prototype.syncPreset = function (root, preset) {
        ...
        (0, object_1.objectForEach)(preset.components, function (c) {
            if (c)
                keptRefs.add(c.ref);
        });
        if (preset.representations) {
            (0, object_1.objectForEach)(preset.representations, function (r) {
                if (r)
                    keptRefs.add(r.ref);
            });
        }
    ...
    StructureComponentManager.prototype.selectThis = function (components) {
        ...
        for (var _i = 0, components_1 = components; _i < components_1.length; _i++) {
            ...
            var loci = structure_1.Structure.toSubStructureElementLoci(c.structure.cell.obj.data, (_a = c.cell.obj) === null || _a === void 0 ? void 0 : _a.data);
    ...
    StructureComponentManager.prototype.modifyByCurrentSelection = function (components, action) {
        var _this = this;
        return this.plugin.runTask(mol_task_1.Task.create('Modify Component', function (taskCtx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        for (var _i = 0, components_8 = components; _i < components_8.length; _i++) {
            ...
            var _loop_1 = function (repr) {
                ...
                var colorTheme = params.color === 'default'
                    ? (0, structure_representation_params_1.createStructureColorThemeParams)(this_1.plugin, (_a = c.structure.cell.obj) === null || _a === void 0 ? void 0 : _a.data, old === null || old === void 0 ? void 0 : old.type.name)
                    : params.color
                        ? (0, structure_representation_params_1.createStructureColorThemeParams)(this_1.plugin, (_b = c.structure.cell.obj) === null || _b === void 0 ? void 0 : _b.data, old === null || old === void 0 ? void 0 : old.type.name, params.color, params.colorParams)
                        : void 0;
                var sizeTheme = params.size === 'default'
                    ? (0, structure_representation_params_1.createStructureSizeThemeParams)(this_1.plugin, (_c = c.structure.cell.obj) === null || _c === void 0 ? void 0 : _c.data, old === null || old === void 0 ? void 0 : old.type.name)
                    : params.color
                        ? (0, structure_representation_params_1.createStructureSizeThemeParams)(this_1.plugin, (_d = c.structure.cell.obj) === null || _d === void 0 ? void 0 : _d.data, old === null || old === void 0 ? void 0 : old.type.name, params.size, params.sizeParams)
                        : void 0;
    ...
    StructureComponentManager.prototype.tryFindComponent = function (structure, selection) {
        ...
        if (structure.components.length === 0)
            return;
        return this.plugin.runTask(mol_task_1.Task.create('Find Component', function (taskCtx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        if (!data)
                            return [2 /*return*/];
                        _b = (_a = structure_1.StructureSelection).unionStructure;
    ...
    StructureComponentManager.prototype.applyTheme = function (params, structures) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this.plugin.dataTransaction(function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (xs.length === 0)
                                        return [2 /*return*/];
                                    getLoci = function (s) { return tslib_1.__awaiter(_this, void 0, void 0, function () { var _a, _b; return tslib_1.__generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                _b = (_a = structure_1.StructureSelection).toLociWithSourceUnits;
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, (0, structure_overpaint_1.setStructureOverpaint)(this.plugin, s.components, p.color, getLoci, params.representations)];
                                case 2:
                                    _a.sent();
                                    return [3 /*break*/, 13];
                                case 3:
                                    if (!(params.action.name === 'resetColor')) return [3 /*break*/, 5];
                                    return [4 /*yield*/, (0, structure_overpaint_1.setStructureOverpaint)(this.plugin, s.components, -1, getLoci, params.representations)];
                                case 4:
                                    _a.sent();
                                    return [3 /*break*/, 13];
                                case 5:
                                    ...
                                    p = params.action.params;
                                    return [4 /*yield*/, (0, structure_transparency_1.setStructureTransparency)(this.plugin, s.components, p.value, getLoci, params.representations)];
                                case 6:
                                    _a.sent();
                                    return [3 /*break*/, 13];
                                case 7:
                                    ...
                                    p = params.action.params;
                                    return [4 /*yield*/, (0, structure_substance_1.setStructureSubstance)(this.plugin, s.components, p.material, getLoci, params.representations)];
                                case 8:
                                    _a.sent();
                                    return [3 /*break*/, 13];
                                case 9:
                                    if (!(params.action.name === 'resetMaterial')) return [3 /*break*/, 11];
                                    return [4 /*yield*/, (0, structure_substance_1.setStructureSubstance)(this.plugin, s.components, void 0, getLoci, params.representations)];
                                case 10:
                                    _a.sent();
                                    return [3 /*break*/, 13];
                                case 11:
                                    ...
                                    p = params.action.params;
                                    return [4 /*yield*/, (0, structure_clipping_1.setStructureClipping)(this.plugin, s.components, clipping_1.Clipping.Groups.fromNames(p.excludeGroups), getLoci, params.representations)];
                                case 12:
                                    _a.sent();
                                    _a.label = 13;
                                case 13:
    ...
    StructureComponentManager.prototype.modifyComponent = function (builder, component, by, action) {
        ...
        if (modified.elementCount === 0) {
            ...
            var bundle = structure_1.StructureElement.Bundle.fromSubStructure(parent, modified);
            var params = {
...
(function (StructureComponentManager) {
    ...
    function getAddParams(plugin, params) {
        ...
        params = tslib_1.__assign({ pivot: plugin.managers.structure.component.pivotStructure, allowNone: true, hideSelection: false, checkExisting: false }, params);
        return {
            ...
            options: param_definition_1.ParamDefinition.Group({
                ...
                checkExisting: param_definition_1.ParamDefinition.Boolean(!!(params === null || params === void 0 ? void 0 : params.checkExisting), { help: function () { return ({ description: 'Checks if a selection with the specifield elements already exists to avoid creating duplicate components.' }); } }),
            })
        };
    }
    ...
    function getRepresentationTypesSelect(plugin, pivot, custom, label) {
        var types = tslib_1.__spreadArray(tslib_1.__spreadArray([], custom, true), getRepresentationTypes(plugin, pivot), true);
        return param_definition_1.ParamDefinition.Select(types[0][0], types, { label: label });
    }
