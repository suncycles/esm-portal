...
exports.clearStructureSubstance = exports.setStructureSubstance = void 0;
...
function setStructureSubstance(plugin, components, material, lociGetter, types) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var _this = this;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, eachRepr(plugin, components, function (update, repr, substanceCell) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (substanceCell) {
                                        bundleLayers = tslib_1.__spreadArray(tslib_1.__spreadArray([], substanceCell.params.values.layers, true), [layer], false);
...
function clearStructureSubstance(plugin, components, types) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var _this = this;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    r = _b[_a];
                    substance = state.select(mol_state_1.StateSelection.Generators.ofTransformer(transforms_1.StateTransforms.Representation.SubstanceStructureRepresentation3DFromBundle, r.cell.transform.ref).withTag(SubstanceManagerTag));
...
function getFilteredBundle(layers, structure) {
    var substance = substance_1.Substance.ofBundle(layers, structure.root);
    var merged = substance_1.Substance.merge(substance);
