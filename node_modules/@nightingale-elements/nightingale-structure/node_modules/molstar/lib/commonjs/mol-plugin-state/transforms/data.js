...
var CCP4 = tslib_1.__importStar(require("../../mol-io/reader/ccp4/parser"));
var cif_1 = require("../../mol-io/reader/cif");
var DSN6 = tslib_1.__importStar(require("../../mol-io/reader/dsn6/parser"));
var PLY = tslib_1.__importStar(require("../../mol-io/reader/ply/parser"));
var parser_1 = require("../../mol-io/reader/psf/parser");
...
var parser_2 = require("../../mol-io/reader/cube/parser");
var parser_3 = require("../../mol-io/reader/dx/parser");
var names_1 = require("../../mol-util/color/names");
var type_helpers_1 = require("../../mol-util/type-helpers");
var parser_4 = require("../../mol-io/reader/prmtop/parser");
var parser_5 = require("../../mol-io/reader/top/parser");
var Download = objects_1.PluginStateTransform.BuiltIn({
    name: 'download',
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Download', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var url, asset;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = assets_1.Asset.getUrlAsset(plugin.managers.asset, p.url);
...
var DownloadBlob = objects_1.PluginStateTransform.BuiltIn({
    name: 'download-blob',
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Download Blob', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var entries, data, assets, i, r, src;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        entries = [];
                        return [4 /*yield*/, (0, data_source_1.ajaxGetMany)(ctx, plugin.managers.asset, params.sources, params.maxConcurrency || 4)];
                    case 1:
                        data = _a.sent();
                        assets = [];
                        ...
                        cache.assets = assets;
                        return [2 /*return*/, new objects_1.PluginStateObject.Data.Blob(entries, { label: 'Data Blob', description: "".concat(entries.length, " ").concat(entries.length === 1 ? 'entry' : 'entries') })];
                }
            });
        }); });
    },
    dispose: function (_a, plugin) {
        ...
        if (!assets)
            return;
        for (var _b = 0, assets_2 = assets; _b < assets_2.length; _b++) {
            var a = assets_2[_b];
            a.dispose();
        }
    }
...
var RawData = objects_1.PluginStateTransform.BuiltIn({
    name: 'raw-data',
    ...
    apply: function (_a) {
        var _this = this;
        var p = _a.params;
        return mol_task_1.Task.create('Raw Data', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (typeof p.data === 'string') {
                    return [2 /*return*/, new objects_1.PluginStateObject.Data.String(p.data, { label: p.label ? p.label : 'String' })];
                }
                else if (Array.isArray(p.data)) {
                    return [2 /*return*/, new objects_1.PluginStateObject.Data.Binary(new Uint8Array(p.data), { label: p.label ? p.label : 'Binary' })];
                }
                else if (p.data instanceof ArrayBuffer) {
                    return [2 /*return*/, new objects_1.PluginStateObject.Data.Binary(new Uint8Array(p.data), { label: p.label ? p.label : 'Binary' })];
                }
                else if (p.data instanceof Uint8Array) {
                    return [2 /*return*/, new objects_1.PluginStateObject.Data.Binary(p.data, { label: p.label ? p.label : 'Binary' })];
                }
                else {
...
var ReadFile = objects_1.PluginStateTransform.BuiltIn({
    name: 'read-file',
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var p = _a.params, cache = _a.cache;
        return mol_task_1.Task.create('Open File', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var asset, o;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
var ParseBlob = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-blob',
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Parse Blob', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (!map.has(e.id))
                            return [3 /*break*/, 3];
                        return [4 /*yield*/, (e.kind === 'string' ? cif_1.CIF.parse(e.data) : cif_1.CIF.parseBinary(e.data)).runInContext(ctx)];
                    case 2:
                        parsed = _e.sent();
                        if (parsed.isError)
                    ...
                    case 3:
                        _c++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, new objects_1.PluginStateObject.Format.Blob(entries, { label: 'Format Blob', description: "".concat(entries.length, " ").concat(entries.length === 1 ? 'entry' : 'entries') })];
                }
            });
        }); });
    },
...
var ParseCif = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-cif',
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse CIF', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var parsed;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (typeof a.data === 'string' ? cif_1.CIF.parse(a.data) : cif_1.CIF.parseBinary(a.data)).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Cif(parsed.result)];
                }
            });
        }); });
    }
...
var ParseCube = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-cube',
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse Cube', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var parsed;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, parser_2.parseCube)(a.data, a.label).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Cube(parsed.result)];
                }
            });
        }); });
    }
...
var ParsePsf = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-psf',
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Parse PSF', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, parser_1.parsePsf)(a.data).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Psf(parsed.result)];
                }
            });
        }); });
    }
...
var ParsePrmtop = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-prmtop',
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Parse PRMTOP', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, parser_4.parsePrmtop)(a.data).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Prmtop(parsed.result)];
                }
            });
        }); });
    }
...
var ParseTop = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-top',
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Parse TOP', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, parser_5.parseTop)(a.data).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Top(parsed.result)];
                }
            });
        }); });
    }
...
var ParsePly = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-ply',
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse PLY', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var parsed;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Ply(parsed.result, { label: parsed.result.comments[0] || 'PLY Data' })];
                }
            });
        }); });
    }
...
var ParseCcp4 = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-ccp4',
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Ccp4(parsed.result)];
                }
            });
        }); });
    }
...
var ParseDsn6 = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-dsn6',
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Dsn6(parsed.result)];
                }
            });
        }); });
    }
...
var ParseDx = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-dx',
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Parse DX', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, parser_3.parseDx)(a.data, a.label).runInContext(ctx)];
                    case 1:
                        parsed = _a.sent();
                        if (parsed.isError)
                            throw new Error(parsed.message);
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Dx(parsed.result)];
                }
            });
        }); });
    }
...
var ImportString = objects_1.PluginStateTransform.BuiltIn({
    name: 'import-string',
...
var ImportJson = objects_1.PluginStateTransform.BuiltIn({
    name: 'import-json',
...
var ParseJson = objects_1.PluginStateTransform.BuiltIn({
    name: 'parse-json',
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse JSON', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var json;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        json = _a.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Format.Json(json)];
                }
            });
        }); });
    }
...
var LazyVolume = objects_1.PluginStateTransform.BuiltIn({
    name: 'lazy-volume',
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Lazy Volume', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var entryId;
            return tslib_1.__generator(this, function (_a) {
                entryId = Array.isArray(params.entryId) ? params.entryId.join(', ') : params.entryId;
                return [2 /*return*/, new objects_1.PluginStateObject.Volume.Lazy(params, { label: "".concat(entryId || params.url), description: 'Lazy Volume' })];
            });
        }); });
    }
});
