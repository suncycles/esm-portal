...
(function (StructureQueryHelper) {
    ...
    function create(structure, query) {
        var script = script_1.Script.is(query) ? query : void 0;
        var expression = script_1.Script.is(query) ? script_1.Script.toExpression(query) : query;
...
exports.StructureQueryHelper = StructureQueryHelper;
