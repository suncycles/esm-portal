...
exports.createVolumeSizeThemeParams = exports.createVolumeColorThemeParams = exports.getVolumeThemeTypes = exports.createVolumeRepresentationParams = void 0;
...
function createVolumeColorThemeParams(ctx, volume, typeName, themeName, params) {
    ...
    var colorDefaultParams = param_definition_1.ParamDefinition.getDefaultValues(color.getParams({ volume: volume || volume_1.Volume.One }));
...
function createVolumeSizeThemeParams(ctx, volume, typeName, themeName, params) {
    ...
    var sizeDefaultParams = param_definition_1.ParamDefinition.getDefaultValues(size.getParams({ volume: volume || volume_1.Volume.One }));
...
function createParamsProvider(ctx, volume, props) {
    ...
    var reprDefaultParams = param_definition_1.ParamDefinition.getDefaultValues(repr.getParams(themeCtx, volume));
