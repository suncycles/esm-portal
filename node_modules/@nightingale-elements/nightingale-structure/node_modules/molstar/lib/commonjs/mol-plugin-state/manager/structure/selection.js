...
var StructureSelectionManager = /** @class */ (function (_super) {
    tslib_1.__extends(StructureSelectionManager, _super);
    ...
    StructureSelectionManager.prototype.getEntry = function (s) {
        ...
        if (!this.entries.has(ref)) {
            var entry = new SelectionEntry(structure_1.StructureElement.Loci(s, []));
    ...
    StructureSelectionManager.prototype.calcStats = function () {
        ...
        var label = (0, label_1.structureElementStatsLabel)(stats, { countsOnly: true });
    ...
    StructureSelectionManager.prototype.tryAddHistory = function (loci) {
        ...
        var label = (0, label_1.structureElementStatsLabel)(stats, { reverse: true });
        this.additionsHistory.unshift({ id: mol_util_1.UUID.create22(), loci: loci, label: label });
    ...
    StructureSelectionManager.prototype.getPrincipalAxes = function () {
        var values = (0, util_1.iterableToArray)(this.entries.values());
        return structure_1.StructureElement.Loci.getPrincipalAxesMany(values.map(function (v) { return v.selection; }));
    };
    ...
    StructureSelectionManager.prototype.fromCompiledQuery = function (modifier, query, applyGranularity) {
        ...
        for (var _i = 0, _a = this.applicableStructures; _i < _a.length; _i++) {
            var s = _a[_i];
            var loci = query(new structure_1.QueryContext(s));
    ...
    StructureSelectionManager.prototype.fromSelections = function (ref) {
        var _a;
        var cell = mol_state_1.StateObjectRef.resolveAndCheck(this.plugin.state.data, ref);
        if (!cell || !cell.obj)
            return;
