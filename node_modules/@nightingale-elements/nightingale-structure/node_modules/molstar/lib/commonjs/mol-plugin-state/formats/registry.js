...
var DataFormatRegistry = /** @class */ (function () {
    function DataFormatRegistry() {
        ...
        for (var _i = 0, BuiltInVolumeFormats_1 = volume_1.BuiltInVolumeFormats; _i < BuiltInVolumeFormats_1.length; _i++) {
            var _a = BuiltInVolumeFormats_1[_i], id = _a[0], p = _a[1];
            this.add(id, p);
        }
        for (var _b = 0, BuiltInTopologyFormats_1 = topology_1.BuiltInTopologyFormats; _b < BuiltInTopologyFormats_1.length; _b++) {
            var _c = BuiltInTopologyFormats_1[_b], id = _c[0], p = _c[1];
            this.add(id, p);
        }
        for (var _d = 0, BuiltInCoordinatesFormats_1 = coordinates_1.BuiltInCoordinatesFormats; _d < BuiltInCoordinatesFormats_1.length; _d++) {
            var _e = BuiltInCoordinatesFormats_1[_d], id = _e[0], p = _e[1];
            this.add(id, p);
        }
        for (var _f = 0, BuiltInShapeFormats_1 = shape_1.BuiltInShapeFormats; _f < BuiltInShapeFormats_1.length; _f++) {
            var _g = BuiltInShapeFormats_1[_f], id = _g[0], p = _g[1];
            this.add(id, p);
        }
        for (var _h = 0, BuiltInTrajectoryFormats_1 = trajectory_1.BuiltInTrajectoryFormats; _h < BuiltInTrajectoryFormats_1.length; _h++) {
