...
exports.updateStructureComponent = exports.createStructureComponent = exports.StructureComponentParams = exports.StaticStructureComponentTypes = void 0;
var param_definition_1 = require("../../mol-util/param-definition");
var builder_1 = require("../../mol-script/language/builder");
var structure_1 = require("../../mol-model/structure");
var structure_query_1 = require("./structure-query");
var objects_1 = require("../objects");
var structure_selection_query_1 = require("./structure-selection-query");
...
var StructureComponentParams = function () { return ({
...
function createStructureComponent(a, params, cache) {
    cache.source = a;
    var component = structure_1.Structure.Empty;
    var label = void 0;
    switch (params.type.name) {
        case 'static': {
            ...
            var result = query(new structure_1.QueryContext(a));
            component = structure_1.StructureSelection.unionStructure(result);
            break;
        }
        case 'script':
        case 'expression': {
            var _a = structure_query_1.StructureQueryHelper.createAndRun(a, params.type.params), selection = _a.selection, entry = _a.entry;
            cache.entry = entry;
    ...
    var props = { label: "".concat(params.label || label || 'Component'), description: structure_1.Structure.elementDescription(component) };
...
function updateStructureComponent(a, b, oldParams, newParams, cache) {
    ...
    switch (newParams.type.name) {
        ...
        case 'expression': {
            ...
            var selection = structure_query_1.StructureQueryHelper.updateStructure(entry, a);
            cache.source = a;
