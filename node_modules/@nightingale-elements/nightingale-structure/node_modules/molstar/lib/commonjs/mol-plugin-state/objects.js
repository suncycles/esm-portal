...
(function (PluginStateObject) {
    ...
    function CreateRepresentation3D(type) {
        return PluginStateObject.Create(tslib_1.__assign(tslib_1.__assign({}, type), { typeClass: 'Representation3D' }));
    }
    PluginStateObject.CreateRepresentation3D = CreateRepresentation3D;
    function CreateBehavior(type) {
        return PluginStateObject.Create(tslib_1.__assign(tslib_1.__assign({}, type), { typeClass: 'Behavior' }));
    }
    ...
    (function (Format) {
        ...
        var Prmtop = /** @class */ (function (_super) {
            tslib_1.__extends(Prmtop, _super);
            function Prmtop() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return Prmtop;
    ...
    (function (Molecule) {
        ...
        var Trajectory = /** @class */ (function (_super) {
            tslib_1.__extends(Trajectory, _super);
            function Trajectory() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            return Trajectory;
        ...
        (function (Structure) {
            var Representation3D = /** @class */ (function (_super) {
                tslib_1.__extends(Representation3D, _super);
            ...
            var Representation3DState = /** @class */ (function (_super) {
                tslib_1.__extends(Representation3DState, _super);
...
})(PluginStateObject = exports.PluginStateObject || (exports.PluginStateObject = {}));
...
})(PluginStateTransform = exports.PluginStateTransform || (exports.PluginStateTransform = {}));
