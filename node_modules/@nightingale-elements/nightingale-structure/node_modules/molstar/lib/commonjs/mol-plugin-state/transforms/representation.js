...
var plane_1 = require("../../mol-repr/shape/loci/plane");
...
var StructureRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Structure Representation', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2:
                        repr = provider.factory(tslib_1.__assign({ webgl: (_b = plugin.canvas3d) === null || _b === void 0 ? void 0 : _b.webgl }, plugin.representation.structure.themes), provider.getParams);
...
var SpinStructureRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    from: objects_1.PluginStateObject.Molecule.Structure.Representation3D,
    to: objects_1.PluginStateObject.Molecule.Structure.Representation3DState,
    params: tslib_1.__assign({ t: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 1, step: 0.01 }) }, helpers_1.SpinStructureParams)
})({
    canAutoUpdate: function () {
        return true;
    },
...
var OverpaintStructureRepresentation3DFromScript = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function () { return ({
        ...
        }, function (e) { return "".concat(e.clear ? 'Clear' : color_1.Color.toRgbString(e.color)); }, {
            defaultValue: [{
...
var TransparencyStructureRepresentation3DFromScript = objects_1.PluginStateTransform.BuiltIn({
    ...
    update: function (_a) {
        ...
        var newTransparency = transparency_1.Transparency.ofScript(newParams.layers, newStructure);
...
var TransparencyStructureRepresentation3DFromBundle = objects_1.PluginStateTransform.BuiltIn({
    ...
    update: function (_a) {
        ...
        if (newGeometryVersion !== info.geometryVersion && (0, base_1.hasColorSmoothingProp)(a.data.repr.props))
            return mol_state_1.StateTransformer.UpdateResult.Recreate;
        var oldTransparency = b.data.state.transparency;
        var newTransparency = transparency_1.Transparency.ofBundle(newParams.layers, newStructure);
        if (transparency_1.Transparency.areEqual(oldTransparency, newTransparency))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
        info.geometryVersion = newGeometryVersion;
        b.data.state.transparency = newTransparency;
...
var SubstanceStructureRepresentation3DFromScript = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function () { return ({
        layers: param_definition_1.ParamDefinition.ObjectList({
            ...
            clear: param_definition_1.ParamDefinition.Boolean(false)
        }, function (e) { return "".concat(e.clear ? 'Clear' : material_1.Material.toString(e.material)); }, {
            defaultValue: [{
                    script: (0, script_1.Script)('(sel.atom.all)', 'mol-script'),
    ...
    apply: function (_a) {
        ...
        var structure = a.data.sourceData;
        var geometryVersion = a.data.repr.geometryVersion;
        var substance = substance_1.Substance.ofScript(params.layers, structure);
        return new objects_1.PluginStateObject.Molecule.Structure.Representation3DState({
    ...
    update: function (_a) {
        ...
        var newSubstance = substance_1.Substance.ofScript(newParams.layers, newStructure);
...
var SubstanceStructureRepresentation3DFromBundle = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        ...
        var structure = a.data.sourceData;
        var geometryVersion = a.data.repr.geometryVersion;
        var substance = substance_1.Substance.ofBundle(params.layers, structure);
        return new objects_1.PluginStateObject.Molecule.Structure.Representation3DState({
            state: { substance: substance },
            initialState: { substance: substance_1.Substance.Empty },
            info: { structure: structure, geometryVersion: geometryVersion },
    ...
    update: function (_a) {
        ...
        if (newGeometryVersion !== info.geometryVersion && (0, base_1.hasColorSmoothingProp)(a.data.repr.props))
            return mol_state_1.StateTransformer.UpdateResult.Recreate;
        var oldSubstance = b.data.state.substance;
        var newSubstance = substance_1.Substance.ofBundle(newParams.layers, newStructure);
        if (substance_1.Substance.areEqual(oldSubstance, newSubstance))
            return mol_state_1.StateTransformer.UpdateResult.Unchanged;
        info.geometryVersion = newGeometryVersion;
        b.data.state.substance = newSubstance;
...
var ThemeStrengthRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
...
(function (VolumeRepresentation3DHelpers) {
    ...
    function getDefaultParamsStatic(ctx, name, volumeParams, colorName, colorParams, sizeName, sizeParams) {
        ...
        var sizeType = ctx.representation.volume.themes.sizeThemeRegistry.get(sizeName || type.defaultSizeTheme.name);
        return ({
            type: { name: name, params: volumeParams ? tslib_1.__assign(tslib_1.__assign({}, type.defaultValues), volumeParams) : type.defaultValues },
            colorTheme: { name: type.defaultColorTheme.name, params: colorParams ? tslib_1.__assign(tslib_1.__assign({}, colorType.defaultValues), colorParams) : colorType.defaultValues },
            sizeTheme: { name: type.defaultSizeTheme.name, params: sizeParams ? tslib_1.__assign(tslib_1.__assign({}, sizeType.defaultValues), sizeParams) : sizeType.defaultValues }
        });
    }
...
var VolumeRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Volume Representation', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Shape Representation', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        props = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(a.data.params)), params);
...
var ModelUnitcell3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, unitcell_1.UnitcellParams)); }
})({
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Model Unit Cell', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        repr = (0, unitcell_1.UnitcellRepresentation)(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return unitcell_1.UnitcellParams; });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        props = tslib_1.__assign(tslib_1.__assign({}, b.data.repr.props), newParams);
                        data = (0, unitcell_1.getUnitcellData)(a.data, symmetry, props);
                        return [4 /*yield*/, b.data.repr.createOrUpdate(props, data).runInContext(ctx)];
                    case 1:
                        _a.sent();
...
var StructureBoundingBox3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-bounding-box-3d',
    display: 'Bounding Box',
    from: objects_1.PluginStateObject.Molecule.Structure,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: tslib_1.__assign({ radius: param_definition_1.ParamDefinition.Numeric(0.05, { min: 0.01, max: 4, step: 0.01 }, { isEssential: true }), color: param_definition_1.ParamDefinition.Color(names_1.ColorNames.red, { isEssential: true }) }, mesh_1.Mesh.Params)
})({
    canAutoUpdate: function () {
        return true;
    },
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Bounding Box', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var repr;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repr = (0, representation_1.ShapeRepresentation)(function (_, data, __, shape) {
                            var mesh = (0, shape_1.getBoxMesh)(data.box, data.radius, shape === null || shape === void 0 ? void 0 : shape.geometry);
                            return shape_2.Shape.create('Bouding Box', data, mesh, function () { return data.color; }, function () { return 1; }, function () { return 'Bounding Box'; });
                        }, mesh_1.Mesh.Utils);
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: a.data }, { label: "Bounding Box" })];
                }
            });
        }); });
    },
...
var StructureSelectionsDistance3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-distance-3d',
    display: '3D Distance',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, distance_1.DistanceParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Distance', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = (0, helpers_2.getDistanceDataFromStructureSelections)(a.data);
                        repr = (0, distance_1.DistanceRepresentation)(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return distance_1.DistanceParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Distance" })];
                }
            });
        }); });
    },
...
var StructureSelectionsAngle3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-angle-3d',
    display: '3D Angle',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, angle_1.AngleParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Angle', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = (0, helpers_2.getAngleDataFromStructureSelections)(a.data);
                        repr = (0, angle_1.AngleRepresentation)(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return angle_1.AngleParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Angle" })];
                }
            });
        }); });
    },
...
var StructureSelectionsDihedral3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-dihedral-3d',
    display: '3D Dihedral',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, dihedral_1.DihedralParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Dihedral', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = (0, helpers_2.getDihedralDataFromStructureSelections)(a.data);
                        repr = (0, dihedral_1.DihedralRepresentation)(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return dihedral_1.DihedralParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Dihedral" })];
                }
            });
        }); });
    },
...
var StructureSelectionsLabel3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-label-3d',
    display: '3D Label',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, label_1.LabelParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
...
var StructureSelectionsOrientation3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-orientation-3d',
    display: '3D Orientation',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, orientation_1.OrientationParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Orientation', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = (0, helpers_2.getOrientationDataFromStructureSelections)(a.data);
                        repr = (0, orientation_1.OrientationRepresentation)(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return orientation_1.OrientationParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Orientation" })];
                }
            });
        }); });
    },
...
var StructureSelectionsPlane3D = objects_1.PluginStateTransform.BuiltIn({
    name: 'structure-selections-plane-3d',
    display: '3D Plane',
    from: objects_1.PluginStateObject.Molecule.Structure.Selections,
    to: objects_1.PluginStateObject.Shape.Representation3D,
    params: function () { return (tslib_1.__assign({}, plane_1.PlaneParams)); }
})({
    canAutoUpdate: function (_a) {
        var oldParams = _a.oldParams, newParams = _a.newParams;
        return true;
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Structure Plane', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = (0, helpers_2.getPlaneDataFromStructureSelections)(a.data);
                        repr = (0, plane_1.PlaneRepresentation)(tslib_1.__assign({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return plane_1.PlaneParams; });
                        return [4 /*yield*/, repr.createOrUpdate(params, data).runInContext(ctx)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, new objects_1.PluginStateObject.Shape.Representation3D({ repr: repr, sourceData: data }, { label: "Plane" })];
                }
            });
        }); });
    },
