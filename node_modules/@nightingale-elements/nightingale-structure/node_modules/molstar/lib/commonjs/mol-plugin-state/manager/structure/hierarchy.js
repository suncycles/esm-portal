...
var hierarchy_state_1 = require("./hierarchy-state");
var StructureHierarchyManager = /** @class */ (function (_super) {
    tslib_1.__extends(StructureHierarchyManager, _super);
    ...
    StructureHierarchyManager.prototype.findStructure = function (structure) {
        ...
        if (!parent)
            return undefined;
        var root = this.plugin.state.data.selectQ(function (q) { return q.byValue(parent).rootOfType(objects_1.PluginStateObject.Molecule.Structure); })[0];
        if (!root)
            return undefined;
    ...
    StructureHierarchyManager.prototype.sync = function (notify) {
        ...
        if (this.state.syncedTree === this.dataState.tree) {
            if (notify && !this.state.notified) {
                ...
                this.behaviors.selection.next(tslib_1.__assign({ hierarchy: this.state.hierarchy }, this.state.selection));
            }
            return;
        }
        this.state.syncedTree = this.dataState.tree;
        var update = (0, hierarchy_state_1.buildStructureHierarchy)(this.plugin.state.data, this.current);
        if (!update.changed) {
            return;
        }
    ...
    StructureHierarchyManager.prototype.updateStructure = function (s, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.plugin.dataTransaction(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var root, children;
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        root = mol_state_1.StateTree.getDecoratorRoot(this.dataState.tree, s.cell.transform.ref);
...
})(StructureHierarchyManager = exports.StructureHierarchyManager || (exports.StructureHierarchyManager = {}));
exports.StructureHierarchyManager = StructureHierarchyManager;
