...
var PluginStateSnapshotManager = /** @class */ (function (_super) {
    tslib_1.__extends(PluginStateSnapshotManager, _super);
...
(function (PluginStateSnapshotManager) {
    function Entry(snapshot, params) {
        return tslib_1.__assign({ timestamp: +new Date(), snapshot: snapshot }, params);
    }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!p)
                            return [2 /*return*/];
                        return [4 /*yield*/, (0, util_1.canvasToBlob)(p.canvas, 'png')];
                    case 1:
                        blob = _a.sent();
                        file = new File([blob], name);
                        image = { kind: 'file', id: mol_util_1.UUID.create22(), name: name };
