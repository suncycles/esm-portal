...
exports.clearStructureOverpaint = exports.setStructureOverpaint = void 0;
...
function setStructureOverpaint(plugin, components, color, lociGetter, types) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, eachRepr(plugin, components, function (update, repr, overpaintCell) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (overpaintCell) {
                                        bundleLayers = tslib_1.__spreadArray(tslib_1.__spreadArray([], overpaintCell.params.values.layers, true), [layer], false);
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    r = _b[_a];
                    overpaint = state.select(mol_state_1.StateSelection.Generators.ofTransformer(transforms_1.StateTransforms.Representation.OverpaintStructureRepresentation3DFromBundle, r.cell.transform.ref).withTag(OverpaintManagerTag));
...
function getFilteredBundle(layers, structure) {
    var overpaint = overpaint_1.Overpaint.ofBundle(layers, structure.root);
    var merged = overpaint_1.Overpaint.merge(overpaint);
