...
(function (StructureRepresentationPresetProvider) {
    ...
    function reprBuilder(plugin, params, structure) {
        ...
        var ballAndStickColor = ((_c = params.theme) === null || _c === void 0 ? void 0 : _c.carbonColor) !== undefined
            ? tslib_1.__assign({ carbonColor: getCarbonColorParams((_d = params.theme) === null || _d === void 0 ? void 0 : _d.carbonColor) }, (_e = params.theme) === null || _e === void 0 ? void 0 : _e.globalColorParams) : tslib_1.__assign({}, (_f = params.theme) === null || _f === void 0 ? void 0 : _f.globalColorParams);
        var symmetryColor = structure && ((_g = params.theme) === null || _g === void 0 ? void 0 : _g.symmetryColor)
            ...
            : color;
        var symmetryColorParams = ((_j = params.theme) === null || _j === void 0 ? void 0 : _j.symmetryColorParams) ? tslib_1.__assign(tslib_1.__assign({}, (_k = params.theme) === null || _k === void 0 ? void 0 : _k.globalColorParams), (_l = params.theme) === null || _l === void 0 ? void 0 : _l.symmetryColorParams) : tslib_1.__assign({}, (_m = params.theme) === null || _m === void 0 ? void 0 : _m.globalColorParams);
        var globalColorParams = ((_o = params.theme) === null || _o === void 0 ? void 0 : _o.globalColorParams) ? tslib_1.__assign({}, (_p = params.theme) === null || _p === void 0 ? void 0 : _p.globalColorParams) : undefined;
    ...
    apply: function (ref, params, plugin) {
        ...
        switch (size) {
            ...
            case structure_1.Structure.Size.Small:
                ...
                return atomicDetail.apply(ref, tslib_1.__assign(tslib_1.__assign({}, params), { showCarbohydrateSymbol: true }), plugin);
            default:
            ...
            return tslib_1.__generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 8:
                        ...
                        representations = {
                            polymer: builder.buildRepresentation(update, components.polymer, { type: 'cartoon', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), cartoonProps), color: symmetryColor, colorParams: symmetryColorParams }, { tag: 'polymer' }),
                            ...
                            branchedBallAndStick: builder.buildRepresentation(update, components.branched, { type: 'ball-and-stick', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), { alpha: 0.3 }), color: color, colorParams: ballAndStickColor }, { tag: 'branched-ball-and-stick' }),
                            ...
                            water: builder.buildRepresentation(update, components.water, { type: waterType, typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), { alpha: 0.6, visuals: waterType === 'line' ? ['intra-bond', 'element-point'] : undefined }), color: color, colorParams: tslib_1.__assign({ carbonColor: { name: 'element-symbol', params: {} } }, globalColorParams) }, { tag: 'water' }),
                            ion: builder.buildRepresentation(update, components.ion, { type: 'ball-and-stick', typeParams: typeParams, color: color, colorParams: tslib_1.__assign({ carbonColor: { name: 'element-symbol', params: {} } }, globalColorParams) }, { tag: 'ion' }),
                            lipid: builder.buildRepresentation(update, components.lipid, { type: lipidType, typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), { alpha: 0.6, visuals: lipidType === 'line' ? ['intra-bond'] : undefined }), color: color, colorParams: tslib_1.__assign({ carbonColor: { name: 'element-symbol', params: {} } }, globalColorParams) }, { tag: 'lipid' }),
            ...
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        representations = {
                            protein: builder.buildRepresentation(update, components.protein, { type: 'cartoon', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), cartoonProps), color: symmetryColor, colorParams: symmetryColorParams }, { tag: 'protein' }),
                            nucleic: builder.buildRepresentation(update, components.nucleic, { type: 'gaussian-surface', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), gaussianProps), color: symmetryColor, colorParams: symmetryColorParams }, { tag: 'nucleic' })
                        };
            ...
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        _e = reprBuilder(plugin, params, structure), update = _e.update, builder = _e.builder, typeParams = _e.typeParams, symmetryColor = _e.symmetryColor, symmetryColorParams = _e.symmetryColorParams;
                        representations = {
                            polymer: builder.buildRepresentation(update, components.polymer, { type: 'gaussian-surface', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), gaussianProps), color: symmetryColor, colorParams: symmetryColorParams }, { tag: 'polymer' }),
                            lipid: builder.buildRepresentation(update, components.lipid, { type: 'gaussian-surface', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), gaussianProps), color: symmetryColor, colorParams: symmetryColorParams }, { tag: 'lipid' })
                        };
                        return [4 /*yield*/, update.commit({ revertOnError: true })];
                    case 3:
                        _g.sent();
...
var atomicDetail = StructureRepresentationPresetProvider({
    ...
    params: function () { return (tslib_1.__assign(tslib_1.__assign({}, CommonParams), { showCarbohydrateSymbol: param_definition_1.ParamDefinition.Boolean(false) })); },
    apply: function (ref, params, plugin) {
                ...
                switch (_o.label) {
                    ...
                    case 3:
                        ...
                        colorParams = lowResidueElementRatio && !bondsGiven
                            ? tslib_1.__assign({ carbonColor: { name: 'element-symbol', params: {} } }, globalColorParams) : ballAndStickColor;
                        representations = {
                        ...
                        if (showCarbohydrateSymbol) {
                            Object.assign(representations, {
                                snfg3d: builder.buildRepresentation(update, components.branched, { type: 'carbohydrate', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), { alpha: 0.4, visuals: ['carbohydrate-symbol'] }), color: color, colorParams: globalColorParams }, { tag: 'snfg-3d' }),
                            });
                        }
                        return [4 /*yield*/, update.commit({ revertOnError: true })];
                    case 4:
            ...
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        representations = {
                            all: builder.buildRepresentation(update, components.all, { type: 'spacefill', typeParams: tslib_1.__assign(tslib_1.__assign({}, typeParams), { ignoreLight: true }), color: 'illustrative' }, { tag: 'all' }),
                        };
                        return [4 /*yield*/, update.commit({ revertOnError: true })];
                    case 2:
                        _h.sent();
...
function presetSelectionComponent(plugin, structure, query, params) {
    return plugin.builders.structure.tryCreateComponentFromSelection(structure, structure_selection_query_1.StructureSelectionQueries[query], "selection-".concat(query), params);
}
