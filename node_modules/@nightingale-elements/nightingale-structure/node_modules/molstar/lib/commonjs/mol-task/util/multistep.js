...
function MultistepTask(name, steps, f, onAbort) {
    var _this = this;
    return function (params) { return task_1.Task.create(name, function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
