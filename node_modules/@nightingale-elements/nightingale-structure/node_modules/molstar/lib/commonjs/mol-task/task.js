...
var observable_1 = require("./execution/observable");
var synchronous_1 = require("./execution/synchronous");
...
(function (Task) {
    ...
    function constant(name, value) {
        var _this = this;
        return create(name, function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    ...
    function empty() {
        var _this = this;
        return create('', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/];
        }); }); });
    }
    Task.empty = empty;
    ...
    var getNextId = (0, id_factory_1.idFactory)(0, 0x3fffffff);
})(Task || (Task = {}));
exports.Task = Task;
