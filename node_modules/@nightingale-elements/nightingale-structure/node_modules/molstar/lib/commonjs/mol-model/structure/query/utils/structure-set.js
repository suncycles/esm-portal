...
exports.structureSubtract = exports.structureIntersect = exports.structureAreIntersecting = exports.structureAreEqual = exports.structureUnion = void 0;
...
function structureSubtract(a, b) {
    ...
    for (var i = 0, _i = aU.length; i < _i; i++) {
        ...
        var v = bU.get(u.id);
        var sub = int_1.SortedArray.subtract(u.elements, v.elements);
        if (sub.length > 0) {
