...
(function (AlignSequences) {
    function createSeqIdIndicesMap(element) {
        ...
        if (structure_1.Unit.isAtomic(element.unit)) {
            ...
            for (var i = 0, il = int_1.OrderedSet.size(element.indices); i < il; ++i) {
                var uI = int_1.OrderedSet.getAt(element.indices, i);
            ...
            var seq_id_begin = (structure_1.Unit.isSpheres(element.unit)
    ...
    function compute(input, options) {
        ...
        var indicesA = [];
        var indicesB = [];
        var _a = (0, alignment_1.align)(seqA.code.toArray(), seqB.code.toArray(), options), aliA = _a.aliA, aliB = _a.aliB, score = _a.score;
        ...
        var outA = int_1.OrderedSet.intersect(int_1.OrderedSet.ofSortedArray(indicesA), input.a.indices);
        var outB = int_1.OrderedSet.intersect(int_1.OrderedSet.ofSortedArray(indicesB), input.b.indices);
        return {
...
exports.AlignSequences = AlignSequences;
