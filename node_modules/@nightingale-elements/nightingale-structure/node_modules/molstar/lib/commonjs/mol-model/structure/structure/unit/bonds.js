...
(function (Bond) {
    ...
    function remapLoci(loci, structure) {
        ...
        loci.bonds.forEach(function (l) {
            ...
            var indexA = int_1.SortedArray.indexOf(unitA.elements, elementA);
            if (indexA === -1)
                return;
            var elementB = l.bUnit.elements[l.bIndex];
            var indexB = int_1.SortedArray.indexOf(unitB.elements, elementB);
            if (indexB === -1)
                return;
    ...
    function getBoundingSphere(loci, boundingSphere) {
        return centroid_helper_1.CentroidHelper.fromPairProvider(loci.bonds.length, function (i, pA, pB) {
