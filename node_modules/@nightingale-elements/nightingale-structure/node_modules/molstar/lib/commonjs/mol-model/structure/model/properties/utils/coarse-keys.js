...
function createLookUp(entities, chain, seq) {
    ...
    var findSequenceKey = function (e, c, s) {
        ...
        var idx = sorted_ranges_1.SortedRanges.firstIntersectionIndex(seqRanges, int_1.OrderedSet.ofSingleton(s));
...
function getCoarseKeys(data, entities) {
    ...
    for (var cI = 0; cI < chainElementSegments.count; cI++) {
        ...
        var seqMap = { elementIndices: elementIndices, seqRanges: sorted_ranges_1.SortedRanges.ofSortedRanges(seqRanges) };
