...
exports.all = all;
function residues(params) { return atoms(tslib_1.__assign(tslib_1.__assign({}, params), { groupBy: function (ctx) { return structure_1.StructureProperties.residue.key(ctx.element); } })); }
exports.residues = residues;
function chains(params) { return atoms(tslib_1.__assign(tslib_1.__assign({}, params), { groupBy: function (ctx) { return structure_1.StructureProperties.chain.key(ctx.element); } })); }
