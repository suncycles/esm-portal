...
function atomicProperty(p) {
    return property(function (l) { return unit_1.Unit.isAtomic(l.unit) ? p(l) : _wrongUnitKind('atomic'); });
}
exports.atomicProperty = atomicProperty;
function coarseProperty(p) {
    return property(function (l) { return unit_1.Unit.isCoarse(l.unit) ? p(l) : _wrongUnitKind('coarse'); });
}
