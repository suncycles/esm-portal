...
exports.checkStructureMaxRadiusDistance = exports.checkStructureMinMaxDistance = void 0;
...
var MinMaxDist;
(function (MinMaxDist) {
    var distVec = linear_algebra_1.Vec3.zero();
...
(function (MaxRadiusDist) {
    ...
    function inUnit(ctx, unit, p, eRadius, maxDist, elementRadius) {
        ...
        for (var i = 0, _i = elements.length; i < _i; i++) {
            var e = elements[i];
            ctx.element.element = e;
            if (Math.max(0, linear_algebra_1.Vec3.distance(p, position(e, dV)) - eRadius - elementRadius(ctx)) <= maxDist)
                return true;
        }
        return false;
    }
