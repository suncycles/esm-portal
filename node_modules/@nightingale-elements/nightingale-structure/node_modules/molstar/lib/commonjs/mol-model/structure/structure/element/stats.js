...
(function (Stats) {
        ...
        if (size === elements.length) {
            ...
            if (unit_1.Unit.isAtomic(unit)) {
                ...
                var _loop_1 = function () {
                    ...
                    ++j;
                    while (i < size) {
                        var eI_1 = elements[int_1.OrderedSet.getAt(indices, i)];
                        if (index[eI_1] !== rI)
                            break;
                    ...
                    if (offsets_1[rI + 1] - offsets_1[rI] === j) {
                        ...
                        if (stats.residueCount === 1) {
                            location_1.Location.set(stats.firstResidueLoc, structure, unit, offsets_1[rI]);
                        }
                    }
                    else {
                        // partial residue
    ...
    function handleUnitChainsSimple(stats, structure, element) {
        ...
        var segments = unit_1.Unit.isAtomic(unit)
        ...
        while (i < size) {
            ...
            ++j;
            while (i < size) {
                var eI_2 = elements[int_1.OrderedSet.getAt(indices, i)];
                if (index[eI_2] !== cI)
                    break;
                ++i;
                ++j;
    ...
    function handleUnitChainsPartitioned(stats, structure, lociElements, start, end) {
        ...
        var segments = unit_1.Unit.isAtomic(element.unit)
        ...
        for (var elIndex = start; elIndex < end; elIndex++) {
            ...
            while (i < size) {
                ...
                ++j;
                while (i < size) {
                    var eI_3 = elements[int_1.OrderedSet.getAt(indices, i)];
                    if (index[eI_3] !== cI)
                        break;
                    ++i;
                    ++j;
