...
(function (Model) {
    function _trajectoryFromModelAndCoordinates(model, coordinates) {
        ...
        for (var i = 0, il = frames.length; i < il; ++i) {
            ...
            var m = tslib_1.__assign(tslib_1.__assign({}, model), { id: uuid_1.UUID.create22(), modelNum: i, atomicConformation: coordinates_1.Coordinates.getAtomicConformation(f, {
    ...
    function trajectoryFromTopologyAndCoordinates(topology, coordinates) {
        var _this = this;
        return mol_task_1.Task.create('Create Trajectory', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var models, model, trajectory, bondData, indexPairBonds, coarseGrained, index, _a, trajectory_2, m;
