...
var principal_axes_1 = require("./util/principal-axes");
...
(function (Unit) {
    ...
    (function (SymmetryGroup) {
        ...
        function getUnitSymmetryGroupsIndexMap(symmetryGroups) {
            var unitSymmetryGroupsIndexMap = int_1.IntMap.Mutable();
    ...
    var Atomic = /** @class */ (function () {
        ...
        Atomic.prototype.remapModel = function (model, dynamicBonds, props) {
            var _a, _b;
            if (!props) {
                props = tslib_1.__assign(tslib_1.__assign({}, this.props), { bonds: dynamicBonds && !((_b = (_a = this.props.bonds) === null || _a === void 0 ? void 0 : _a.props) === null || _b === void 0 ? void 0 : _b.canRemap)
                        ? undefined
            ...
            if (operator.spgrOp !== -1 && symmetry && symmetry !== symmetry_1.ModelSymmetry.Provider.get(this.model)) {
                ...
                var ref = linear_algebra_1.Vec3.transformMat4((0, linear_algebra_1.Vec3)(), model_1.Model.getCenter(model), toFractional);
        ...
        Object.defineProperty(Atomic.prototype, "boundary", {
            get: function () {
                ...
                this.props.boundary = Traits.is(this.traits, Trait.FastBoundary)
                    ...
                    : (0, boundary_1.getBoundary)({ x: x, y: y, z: z, indices: this.elements });
                return this.props.boundary;
            },
            enumerable: false,
            configurable: true
        ...
        Object.defineProperty(Atomic.prototype, "lookup3d", {
            get: function () {
                ...
                var _a = this.model.atomicConformation, x = _a.x, y = _a.y, z = _a.z;
                this.props.lookup3d = (0, geometry_1.GridLookup3D)({ x: x, y: y, z: z, indices: this.elements }, this.boundary);
                return this.props.lookup3d;
            },
            enumerable: false,
            configurable: true
        ...
        Object.defineProperty(Atomic.prototype, "bonds", {
            get: function () {
                ...
                var cache = element_set_intra_bond_cache_1.ElementSetIntraBondCache.get(this.model);
        ...
        Object.defineProperty(Atomic.prototype, "residueCount", {
            get: function () {
                ...
                var residueCount = 0;
                var residueIt = int_1.Segmentation.transientSegments(this.model.atomicHierarchy.residueAtomSegments, this.elements);
    ...
    var Coarse = /** @class */ (function () {
        ...
        Coarse.prototype.remapModel = function (model, dynamicBonds, props) {
            ...
            if (!props) {
                props = tslib_1.__assign({}, this.props);
            ...
            var conformation = coarseConformation !== modelCoarseConformation
                ? symmetry_operator_1.SymmetryOperator.createMapping(this.conformation.operator, modelCoarseConformation)
                : this.conformation;
    ...
    var Spheres = /** @class */ (function (_super) {
        tslib_1.__extends(Spheres, _super);
        function Spheres() {
    ...
    var Gaussians = /** @class */ (function (_super) {
        tslib_1.__extends(Gaussians, _super);
        function Gaussians() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        return Gaussians;
    ...
    function tryRemapBonds(a, old, model, dynamicBonds) {
        ...
        if (a.model.atomicConformation.id === model.atomicConformation.id)
            return old;
        var oldIndex = index_pair_1.IndexPairBonds.Provider.get(a.model);
        if (oldIndex) {
            var newIndex = index_pair_1.IndexPairBonds.Provider.get(model);
    ...
    function isSameConformation(u, model) {
        var coordsHistory = model_1.Model.CoordinatesHistory.get(model_1.Model.getRoot(model));
        if (coordsHistory)
