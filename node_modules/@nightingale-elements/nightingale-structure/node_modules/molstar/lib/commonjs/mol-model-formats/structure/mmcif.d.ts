...
declare namespace MmcifFormat {
    ...
    function fromFrame(frame: CifFrame, db?: mmCIF_Database, source?: ModelFormat): MmcifFormat;
}
export declare function trajectoryFromMmCIF(frame: CifFrame): Task<Trajectory>;
