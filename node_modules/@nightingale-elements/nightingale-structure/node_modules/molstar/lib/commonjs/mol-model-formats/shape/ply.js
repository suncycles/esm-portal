...
function createPlyShapeParams(plyFile) {
    ...
    return tslib_1.__assign(tslib_1.__assign({}, mesh_1.Mesh.Params), { coloring: param_definition_1.ParamDefinition.MappedStatic(defaultColoring, {
...
function makeShapeGetter() {
    ...
    var _coloring;
    var _grouping;
    var getShape = function (ctx, plyFile, props, shape) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
function shapeFromPly(source, params) {
    var _this = this;
    return mol_task_1.Task.create('Shape Provider', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, {
                    label: 'Mesh',
                    data: source,
