...
exports.MinimizeRmsd = MinimizeRmsd;
...
function makeTransformMatrix(state) {
    ...
    var qX = matrix_1.Matrix.get(ev, 1, 3);
    var qY = matrix_1.Matrix.get(ev, 2, 3);
    var qZ = matrix_1.Matrix.get(ev, 3, 3);
    var qW = matrix_1.Matrix.get(ev, 0, 3);
    var n1 = 2 * qY * qY;
    var n2 = 2 * qZ * qZ;
    var n3 = 2 * qX * qX;
    var n4 = 2 * qX * qY;
