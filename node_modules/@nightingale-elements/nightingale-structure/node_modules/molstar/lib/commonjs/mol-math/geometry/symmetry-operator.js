...
var mat3_1 = require("../linear-algebra/3d/mat3");
var mat4_1 = require("../linear-algebra/3d/mat4");
var quat_1 = require("../linear-algebra/3d/quat");
...
(function (SymmetryOperator) {
    ...
    function create(name, matrix, info) {
        ...
        if (isIdentity)
            return { name: name, assembly: assembly, matrix: matrix, inverse: mat4_1.Mat4.identity(), isIdentity: true, hkl: _hkl, spgrOp: spgrOp, ncsId: ncsId, suffix: suffix, key: key };
        ...
        return { name: name, assembly: assembly, matrix: matrix, inverse: mat4_1.Mat4.invert((0, mat4_1.Mat4)(), matrix), isIdentity: false, hkl: _hkl, spgrOp: spgrOp, key: key, ncsId: ncsId, suffix: suffix };
    }
    ...
    function checkIfRotationAndTranslation(rot, offset) {
        var matrix = mat4_1.Mat4.identity();
        for (var i = 0; i < 3; i++) {
            for (var j = 0; j < 3; j++) {
                mat4_1.Mat4.setValue(matrix, i, j, mat3_1.Mat3.getValue(rot, i, j));
            }
        }
        mat4_1.Mat4.setTranslation(matrix, offset);
        return mat4_1.Mat4.isRotationAndTranslation(matrix, SymmetryOperator.RotationTranslationEpsilon);
    }
    ...
    var _q1 = quat_1.Quat.identity(), _q2 = (0, quat_1.Quat)(), _q3 = (0, quat_1.Quat)(), _axis = (0, vec3_1.Vec3)();
    function lerpFromIdentity(out, op, t) {
        ...
        var angle = quat_1.Quat.getAxisAngle(_axis, _q2);
    ...
    function slerp(out, src, tar, t) {
        ...
        var angle = quat_1.Quat.getAxisAngle(_axis, _q3);
        mat4_1.Mat4.fromRotation(out, angle, _axis);
        // interpolate translation
    ...
    function compose(first, second) {
        var matrix = mat4_1.Mat4.mul((0, mat4_1.Mat4)(), second.matrix, first.matrix);
