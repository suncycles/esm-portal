...
exports.GaussianDensityTexture3d = exports.GaussianDensityTexture2d = exports.GaussianDensityTexture = exports.GaussianDensityGPU = void 0;
...
var gaussian_density_vert_1 = require("../../../mol-gl/shader/gaussian-density.vert");
var gaussian_density_frag_1 = require("../../../mol-gl/shader/gaussian-density.frag");
...
function calcGaussianDensityTexture2d(webgl, position, box, radius, powerOfTwo, props, texture) {
    ...
    var gridTexDim = linear_algebra_1.Vec3.create(texDimX, texDimY, 0);
    var gridTexScale = linear_algebra_1.Vec2.create(texDimX / powerOfTwoSize, texDimY / powerOfTwoSize);
...
function calcGaussianDensityTexture3d(webgl, position, box, radius, props, texture) {
    ...
    var gridTexScale = linear_algebra_1.Vec2.create(1, 1);
    var radiusFactor = maxRadius * 2;
...
function prepareGaussianDensityData(position, box, radius, props) {
    ...
    var dim = geometry_1.Box3D.size((0, linear_algebra_1.Vec3)(), scaledBox);
    linear_algebra_1.Vec3.ceil(dim, dim);
    var scale = linear_algebra_1.Vec3.create(resolution, resolution, resolution);
...
function fieldFromTexture2d(ctx, texture, dim, texDim) {
    ...
    var space = linear_algebra_1.Tensor.Space(dim, [2, 1, 0], Float32Array);
    var data = space.create();
    var field = linear_algebra_1.Tensor.create(space, data);
    var idData = space.create();
    var idField = linear_algebra_1.Tensor.create(space, idData);
