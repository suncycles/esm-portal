...
export declare namespace IntAdjacencyGraph {
    ...
    function areEqual<I extends number, P extends IntAdjacencyGraph.EdgePropsBase>(a: IntAdjacencyGraph<I, P>, b: IntAdjacencyGraph<I, P>): boolean;
    ...
    class DirectedEdgeBuilder<VertexIndex extends number> {
        ...
        a: Int32Array;
        b: Int32Array;
        createGraph<EdgeProps extends IntAdjacencyGraph.EdgePropsBase>(edgeProps: EdgeProps): IntAdjacencyGraph<number, EdgeProps, unknown>;
        /**
         * @example
         *   const property = new Int32Array(builder.slotCount);
         *   for (let i = 0; i < builder.edgeCount; i++) {
    ...
    function fromVertexPairs<V extends number>(vertexCount: number, xs: V[], ys: V[]): IntAdjacencyGraph<V, {}, unknown>;
    function induceByVertices<V extends number, P extends IntAdjacencyGraph.EdgePropsBase>(graph: IntAdjacencyGraph<V, P>, vertexIndices: ArrayLike<number>): IntAdjacencyGraph<V, P>;
