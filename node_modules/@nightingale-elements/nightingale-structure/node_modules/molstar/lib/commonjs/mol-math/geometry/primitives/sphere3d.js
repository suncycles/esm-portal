...
(function (Sphere3D) {
    ...
    Sphere3D.zero = zero;
    function clone(a) {
        var out = create(linear_algebra_1.Vec3.clone(a.center), a.radius);
        if (hasExtrema(a))
            out.extrema = a.extrema.map(function (e) { return linear_algebra_1.Vec3.clone(e); });
        return out;
    }
    ...
    function copy(out, a) {
        ...
        out.radius = a.radius;
        if (hasExtrema(a))
            setExtrema(out, a.extrema.map(function (e) { return linear_algebra_1.Vec3.clone(e); }));
        return out;
    }
    Sphere3D.copy = copy;
    ...
    function transform(out, sphere, m) {
        ...
        if (hasExtrema(sphere)) {
            setExtrema(out, sphere.extrema.map(function (e) { return linear_algebra_1.Vec3.transformMat4((0, linear_algebra_1.Vec3)(), e, m); }));
        }
        return out;
    }
    ...
    function translate(out, sphere, v) {
        ...
        if (hasExtrema(sphere)) {
            setExtrema(out, sphere.extrema.map(function (e) { return linear_algebra_1.Vec3.add((0, linear_algebra_1.Vec3)(), e, v); }));
        }
        return out;
    }
    ...
    function fromDimensionsAndTransform(out, dimensions, transform) {
        ...
        var d = Math.max(linear_algebra_1.Vec3.distance(cpA, cpB), linear_algebra_1.Vec3.distance(cpC, cpD));
    ...
    var tmpAddVec3 = (0, linear_algebra_1.Vec3)();
    function addVec3(out, s, v) {
        var d = linear_algebra_1.Vec3.distance(s.center, v);
        if (d < s.radius)
