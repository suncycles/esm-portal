...
(function (Box3D) {
    ...
    function computeBounding(data) {
        var min = vec3_1.Vec3.create(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE);
        var max = vec3_1.Vec3.create(-Number.MAX_VALUE, -Number.MAX_VALUE, -Number.MAX_VALUE);
    ...
    Box3D.scale = scale;
    var tmpTransformV = (0, vec3_1.Vec3)();
