...
(function (SpacegroupCell) {
    ...
    function create(nameOrNumber, size, anglesInRadians) {
        var index = (0, tables_1.getSpacegroupIndex)(nameOrNumber);
        if (index < 0) {
...
(function (Spacegroup) {
    ...
    function create(cell) {
        ...
        var name = tables_1.SpacegroupName[cell.index];
        var num = tables_1.SpacegroupNumber[cell.index];
        return { name: name, num: num, cell: cell, operators: operators };
    }
    Spacegroup.create = create;
    var _ijkVec = (0, linear_algebra_1.Vec3)();
    var _tempMat = (0, linear_algebra_1.Mat4)();
    ...
    function getSymmetryOperator(spacegroup, spgrOp, i, j, k) {
        var operator = setOperatorMatrix(spacegroup, spgrOp, i, j, k, linear_algebra_1.Mat4.zero());
        return geometry_1.SymmetryOperator.create("".concat(spgrOp + 1, "_").concat(5 + i).concat(5 + j).concat(5 + k), operator, { hkl: linear_algebra_1.Vec3.create(i, j, k), spgrOp: spgrOp });
    }
    Spacegroup.getSymmetryOperator = getSymmetryOperator;
    var _translationRef = (0, linear_algebra_1.Vec3)();
    var _translationRefSymop = (0, linear_algebra_1.Vec3)();
    var _translationRefOffset = (0, linear_algebra_1.Vec3)();
    var _translationSymop = (0, linear_algebra_1.Vec3)();
    /**
    ...
    function getSymmetryOperatorRef(spacegroup, spgrOp, i, j, k, ref) {
        var operator = linear_algebra_1.Mat4.zero();
        linear_algebra_1.Vec3.set(_ijkVec, i, j, k);
        ...
        return geometry_1.SymmetryOperator.create("".concat(spgrOp + 1, "_").concat(5 + _i).concat(5 + _j).concat(5 + _k), operator, { hkl: linear_algebra_1.Vec3.create(_i, _j, _k), spgrOp: spgrOp });
    }
