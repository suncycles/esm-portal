...
exports.IntAdjacencyGraph = void 0;
...
(function (IntAdjacencyGraph) {
    ...
    var UniqueEdgeBuilder = /** @class */ (function () {
        ...
        UniqueEdgeBuilder.prototype.addEdge = function (i, j) {
            ...
            var id = (0, util_1.cantorPairing)(u, v);
    ...
    function induceByVertices(graph, vertexIndices) {
        ...
        for (var _a = 0, _b = Object.keys(edgeProps); _a < _b.length; _a++) {
            var key = _b[_a];
            newEdgeProps[key] = (0, util_1.arrayPickIndices)(edgeProps[key], edgeIndices);
        }
    ...
    function connectedComponents(graph) {
        ...
        var stack = [0];
        var list = (0, int_1.LinkedIndex)(vCount);
        list.remove(0);
    ...
    function areVertexSetsConnected(graph, verticesA, verticesB, maxDistance) {
        ...
        if (int_1.SortedArray.areIntersecting(verticesA, verticesB))
            return true;
        if (maxDistance < 1)
            return false;
        var visited = new Set();
...
})(IntAdjacencyGraph = exports.IntAdjacencyGraph || (exports.IntAdjacencyGraph = {}));
    ...
    for (var i = 0, il = frontier.length; i < il; ++i) {
        ...
        for (var j = offset[src], jl = offset[src + 1]; j < jl; ++j) {
            ...
            if (visited.has(other))
                continue;
            if (int_1.SortedArray.has(target, other))
                return true;
            visited.add(other);
