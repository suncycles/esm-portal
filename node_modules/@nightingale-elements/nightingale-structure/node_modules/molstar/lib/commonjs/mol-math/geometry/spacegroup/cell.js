...
(function (Cell) {
    ...
    function fromBasis(x, y, z) {
        var a = linear_algebra_1.Vec3.magnitude(x);
        var b = linear_algebra_1.Vec3.magnitude(y);
        var c = linear_algebra_1.Vec3.magnitude(z);
        var alpha = Math.acos(linear_algebra_1.Vec3.dot(y, z) / (b * c));
        var beta = Math.acos(linear_algebra_1.Vec3.dot(x, z) / (a * c));
        var gamma = Math.acos(linear_algebra_1.Vec3.dot(x, y) / (a * b));
