...
(function (PrincipalAxes) {
    ...
    function calculateNormalizedAxes(momentsAxes) {
        var a = geometry_1.Axes3D.clone(momentsAxes);
    ...
    function calculateBoxAxes(positions, momentsAxes) {
        ...
        for (var i = 0, il = positions.length; i < il; i += 3) {
            ...
            var dp1 = vec3_1.Vec3.dot(a.dirA, vec3_1.Vec3.normalize(t, vec3_1.Vec3.sub(t, p, center)));
            ...
            var dp2 = vec3_1.Vec3.dot(a.dirB, vec3_1.Vec3.normalize(t, vec3_1.Vec3.sub(t, p, center)));
            ...
            var dp3 = vec3_1.Vec3.dot(a.dirC, vec3_1.Vec3.normalize(t, vec3_1.Vec3.sub(t, p, center)));
        ...
        var dirA = vec3_1.Vec3.setMagnitude((0, vec3_1.Vec3)(), a.dirA, (d1a + d1b) / 2);
        var dirB = vec3_1.Vec3.setMagnitude((0, vec3_1.Vec3)(), a.dirB, (d2a + d2b) / 2);
        var dirC = vec3_1.Vec3.setMagnitude((0, vec3_1.Vec3)(), a.dirC, (d3a + d3b) / 2);
