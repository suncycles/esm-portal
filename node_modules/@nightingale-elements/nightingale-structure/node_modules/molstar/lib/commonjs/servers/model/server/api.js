...
var atoms_1 = require("../query/atoms");
var schemas_1 = require("../query/schemas");
...
exports.AtomSiteTestRestParams = (function () {
    var params = [];
    for (var _i = 0, _a = Object.keys(exports.AtomSiteSchemaElement); _i < _a.length; _i++) {
        var k = _a[_i];
        var p = exports.AtomSiteSchemaElement[k];
        p.name = k;
        params.push(p);
    }
    return params;
...
var QueryMap = {
    'full': Q({ niceName: 'Full Structure', query: function () { return structure_1.Queries.generators.all; }, description: 'The full structure.' }),
    'ligand': Q({
        niceName: 'Ligand',
        description: 'Coordinates of the first group satisfying the given criteria.',
        query: function (p, _s, numModels) {
            var tests = (0, atoms_1.getAtomsTests)(p.atom_site);
            var ligands = structure_1.Queries.combinators.merge(tests.map(function (test) { return structure_1.Queries.generators.atoms(tslib_1.__assign(tslib_1.__assign({}, test), { unitTest: function (ctx) { return structure_1.StructureProperties.unit.model_num(ctx.element) === numModels[0]; }, groupBy: function (ctx) { return structure_1.StructureProperties.residue.key(ctx.element); } })); }));
    ...
    'atoms': Q({
        ...
        query: function (p) {
            return structure_1.Queries.combinators.merge((0, atoms_1.getAtomsTests)(p.atom_site).map(function (test) { return structure_1.Queries.generators.atoms(test); }));
        },
        jsonParams: [AtomSiteTestJsonParam],
        restParams: exports.AtomSiteTestRestParams
    }),
    'symmetryMates': Q({
        ...
        query: function () { return structure_1.Queries.generators.all; },
    ...
    'residueInteraction': Q({
        ...
        query: function (p) {
            var tests = (0, atoms_1.getAtomsTests)(p.atom_site);
            var center = structure_1.Queries.combinators.merge(tests.map(function (test) { return structure_1.Queries.generators.atoms(tslib_1.__assign(tslib_1.__assign({}, test), { entityTest: test.entityTest
        ...
        restParams: tslib_1.__spreadArray(tslib_1.__spreadArray([], exports.AtomSiteTestRestParams, true), [RadiusParam, AssemblyNameParam], false),
    ...
    'residueSurroundings': Q({
        ...
        query: function (p) {
            var center = structure_1.Queries.combinators.merge((0, atoms_1.getAtomsTests)(p.atom_site).map(function (test) { return structure_1.Queries.generators.atoms(test); }));
        ...
        restParams: tslib_1.__spreadArray(tslib_1.__spreadArray([], exports.AtomSiteTestRestParams, true), [RadiusParam], false),
        filter: schemas_1.QuerySchemas.interaction
    }),
    'surroundingLigands': Q({
        ...
        restParams: tslib_1.__spreadArray(tslib_1.__spreadArray([], exports.AtomSiteTestRestParams, true), [RadiusParam, OmitWaterParam, AssemblyNameParam], false),
        filter: schemas_1.QuerySchemas.interaction
    }),
};
...
function normalizeRestCommonParams(params) {
    return {
        ...
        transform: params.transform ? ('' + params.transform).split(',').map(function (n) { return n.trim(); }).map(function (n) { return +n; }) : linear_algebra_1.Mat4.identity(),
