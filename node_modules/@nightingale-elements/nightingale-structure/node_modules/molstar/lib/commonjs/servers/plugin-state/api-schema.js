    ...
    return {
        ...
        paths: (_a = {},
            ...
            _a[mapPath("set/")] = {
                post: {
                    tags: ['General'],
                    summary: "Post Mol* Viewer state to the server. At most ".concat(config.max_states, " states can be stored. If the limit is reached, older states will be removed."),
                    operationId: 'set',
                    requestBody: {
                        content: {
                            'application/json': {
