        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    console_logger_1.ConsoleLogger.logId(guid, 'Info', "id=".concat(params.sourceId, ",encoding=").concat(params.asBinary ? 'binary' : 'text', ",detail=").concat(params.detail, ",").concat(queryBoxToString(params.box)));
                    _b.label = 1;
                case 1:
                ...
                case 4:
                    e_1 = _b.sent();
                    console_logger_1.ConsoleLogger.errorId(guid, e_1);
                    return [2 /*return*/, false];
                case 5:
                    if (sourceFile)
                        sourceFile.close();
                    console_logger_1.ConsoleLogger.logId(guid, 'Time', "".concat(Math.round(getTime() - start), "ms"));
                    state_1.State.pendingQueries--;
                    return [7 /*endfinally*/];
...
function createQuerySampling(data, sampling, queryBox) {
    ...
    var blocks = (0, identify_1.findUniqueBlocks)(data, sampling, fractionalBox);
    var ret = {
        sampling: sampling,
...
function pickSampling(data, queryBox, forcedLevel, precision) {
    ...
    var sizeLimit = config_1.LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel[precision] || (2 * 1024 * 1024);
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, compose_1.compose)(query)];
                case 3:
                    // Step 3b: Compose the result data
                    _a.sent();
                    _a.label = 4;
