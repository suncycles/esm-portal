...
exports.shortcutIconLink = exports.getSchema = void 0;
var version_1 = require("./version");
var config_1 = require("../config");
function getSchema() {
    var _a;
    function detail(i) {
        return "".concat(i, " (").concat(Math.round(100 * config_1.LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel[i] / 1000 / 1000) / 100, "M voxels)");
    }
    var detailMax = config_1.LimitsConfig.maxOutputSizeInVoxelCountByPrecisionLevel.length - 1;
    var sources = config_1.ServerConfig.idMap.map(function (m) { return m[0]; });
    return {
        openapi: '3.0.0',
        info: {
            version: version_1.VOLUME_SERVER_VERSION,
            title: 'Volume Server',
        ...
        paths: (_a = {},
            _a["".concat(config_1.ServerConfig.apiPrefix, "/{source}/{id}/")] = {
                get: {
                    tags: ['General'],
            ...
            _a["".concat(config_1.ServerConfig.apiPrefix, "/{source}/{id}/box/{a1,a2,a3}/{b1,b2,b3}/")] = {
                get: {
                    tags: ['General'],
            ...
            _a["".concat(config_1.ServerConfig.apiPrefix, "/{source}/{id}/cell/")] = {
                get: {
                    tags: ['General'],
        ...
        components: {
            ...
            parameters: {
                source: {
                    name: 'source',
                    in: 'path',
                    description: "Specifies the data source (determined by the experiment method). Currently supported sources are: ".concat(sources.join(', '), "."),
                    required: true,
                    schema: {
                        type: 'string',
                        enum: sources
                ...
                detail: {
                    name: 'detail',
                    in: 'query',
                    description: "Determines the maximum number of voxels the query can return. Possible values are in the range from ".concat(detail(0), " to ").concat(detail(detailMax), ". Default value is 0. Note: different detail levels might lead to the same result."),
                    schema: {
                        type: 'integer',
                    },
                    style: 'form'
