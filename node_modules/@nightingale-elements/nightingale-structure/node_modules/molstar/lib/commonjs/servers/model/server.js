...
function setupShutdown() {
    if (config_1.ModelServerConfig.shutdownTimeoutVarianceMinutes > config_1.ModelServerConfig.shutdownTimeoutMinutes) {
        ...
        console.log("----------------------------------------------------------------------------");
        console.log("  The server will shut down in ".concat(performance_monitor_1.PerformanceMonitor.format(tMs), " to prevent slow performance."));
...
function startServer() {
    ...
    console.log("Mol* ModelServer ".concat(version_1.VERSION));
    console.log("");
