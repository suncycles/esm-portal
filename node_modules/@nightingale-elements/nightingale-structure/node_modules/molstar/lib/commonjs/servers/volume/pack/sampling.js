...
var Downsampling = tslib_1.__importStar(require("./downsampling"));
var Writer = tslib_1.__importStar(require("./writer"));
        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    cubeBuffer = Buffer.from(new ArrayBuffer(channels.length * blockSize * blockSize * blockSize * (0, typed_array_1.getElementByteSize)(valueType)));
                    litteEndianCubeBuffer = simple_buffer_1.SimpleBuffer.IsNativeEndianLittle
                        ? cubeBuffer
                    ...
                    _d = {};
                    _b = file_handle_1.fileHandleFromDescriptor;
