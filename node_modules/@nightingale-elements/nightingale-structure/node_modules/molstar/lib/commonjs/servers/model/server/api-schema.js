...
function getPaths() {
    ...
    for (var _i = 0, QueryList_1 = api_1.QueryList; _i < QueryList_1.length; _i++) {
        ...
        ret["".concat(config_1.ModelServerConfig.apiPrefix, "/v1/{id}/").concat(name_1)] = getQueryInfo(definition);
    }
    ...
    ret["".concat(config_1.ModelServerConfig.apiPrefix, "/v1/query-many")] = {
        get: {
            tags: ['General'],
...
function getQueryInfo(def) {
    ...
    return {
        get: {
            ...
            parameters: tslib_1.__spreadArray(tslib_1.__spreadArray([
                { $ref: '#/components/parameters/id' }
            ], def.restParams.map(getParamInfo), true), api_1.CommonQueryParamsInfo.map(getParamInfo), true),
            responses: {
                200: {
        ...
        post: {
            ...
            parameters: tslib_1.__spreadArray([
                { $ref: '#/components/parameters/id' }
            ], api_1.CommonQueryParamsInfo.map(getParamInfo), true),
            requestBody: {
                content: {
                    'application/json': {
                        schema: { type: 'object' },
