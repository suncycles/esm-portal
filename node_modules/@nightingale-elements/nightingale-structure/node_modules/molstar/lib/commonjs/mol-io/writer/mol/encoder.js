...
var MolEncoder = /** @class */ (function (_super) {
    ...
    MolEncoder.prototype._writeCategory = function (category, context) {
        ...
        mol_util_1.StringBuilder.writeSafe(this.builder, "  0  0  ".concat(chiral ? 1 : 0, "  0  0  0  0  0  0\n"));
    ...
    MolEncoder.prototype.encode = function () {
        ...
        if (!!this.terminator) {
            mol_util_1.StringBuilder.writeSafe(this.builder, "".concat(this.terminator, "\n"));
        }
        this.encoded = true;
    };
    return MolEncoder;
