...
var encode_1 = require("../../../common/msgpack/encode");
var binary_cif_1 = require("../../../common/binary-cif");
var encoder_1 = require("../encoder");
var util_1 = require("./util");
var classifier_1 = require("../../../common/binary-cif/classifier");
...
function encodeField(categoryName, field, data, totalCount, format, encoderProvider, autoClassify) {
    ...
    var maskData = void 0;
    if (!allPresent) {
        var maskRLE = binary_cif_1.ArrayEncoder.by(binary_cif_1.ArrayEncoding.runLength).and(binary_cif_1.ArrayEncoding.byteArray).encode(mask);
