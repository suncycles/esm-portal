...
exports.parseGRO = void 0;
var tslib_1 = require("tslib");
var db_1 = require("../../../mol-data/db");
var tokenizer_1 = require("../common/text/tokenizer");
var fixed_1 = require("../common/text/column/fixed");
...
function handleNumberOfAtoms(state) {
    ...
    var line = tokenizer_1.Tokenizer.getTokenString(tokenizer);
...
function handleBoxVectors(state) {
    var tokenizer = state.tokenizer;
    var values = tokenizer_1.Tokenizer.readLine(tokenizer).trim().split(/\s+/g);
