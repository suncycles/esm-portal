...
exports.getCategoryInstanceData = exports.getIncludedFields = exports.getFieldDigitCount = void 0;
var mol_data_1 = require("../../../../mol-data");
...
function getCategoryInstanceData(category, ctx) {
    ...
    var source = sources.map(function (c) { return ({
        data: c.data,
        keys: function () { return c.keys ? c.keys() : mol_data_1.Iterator.Range(0, c.rowCount - 1); },
        rowCount: c.rowCount
    }); });
