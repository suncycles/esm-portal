...
exports.classifyFloatArray = exports.classifyIntArray = void 0;
var tslib_1 = require("tslib");
var array_encoder_1 = require("./array-encoder");
...
(function (IntClassifier) {
    ...
    function packingSize(data, info) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, byteSize(size)), { kind: 'pack' });
    }
    function deltaSize(data, info) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, byteSize(size)), { kind: 'delta' });
    }
    function rleSize(data, info) {
        ...
        incSize(info, size, run);
        return tslib_1.__assign(tslib_1.__assign({}, byteSize(size)), { kind: 'rle' });
    }
    function deltaRleSize(data, info) {
        ...
        incSizeSigned(size, prevValue);
        incSizeSigned(size, run);
        return tslib_1.__assign(tslib_1.__assign({}, byteSize(size)), { kind: 'delta-rle' });
    }
...
(function (FloatClassifier) {
    ...
    function classify(data) {
        var maxDigits = 4;
        var _a = (0, number_1.getArrayDigitCount)(data, maxDigits, delta), mantissaDigits = _a.mantissaDigits, integerDigits = _a.integerDigits;
        ...
        var size = sizes[0];
        var fp = array_encoder_1.ArrayEncoding.by(array_encoder_1.ArrayEncoding.fixedPoint(multiplier));
        switch (size.kind) {
