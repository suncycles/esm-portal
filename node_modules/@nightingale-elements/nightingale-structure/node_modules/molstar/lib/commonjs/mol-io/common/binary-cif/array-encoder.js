...
exports.ArrayEncoding = exports.ArrayEncoder = exports.ArrayEncoderImpl = void 0;
...
(function (ArrayEncoding) {
    ...
    function uint8(data) {
        return {
            encodings: [{ kind: 'ByteArray', type: encoding_1.Encoding.IntDataType.Uint8 }],
            data: data
        };
    }
    function int8(data) {
        return {
            encodings: [{ kind: 'ByteArray', type: encoding_1.Encoding.IntDataType.Int8 }],
            data: new Uint8Array(data.buffer, data.byteOffset)
        };
    }
    var writers = (_a = {},
        _a[encoding_1.Encoding.IntDataType.Int16] = function (v, i, a) { v.setInt16(2 * i, a, true); },
        _a[encoding_1.Encoding.IntDataType.Uint16] = function (v, i, a) { v.setUint16(2 * i, a, true); },
        _a[encoding_1.Encoding.IntDataType.Int32] = function (v, i, a) { v.setInt32(4 * i, a, true); },
        _a[encoding_1.Encoding.IntDataType.Uint32] = function (v, i, a) { v.setUint32(4 * i, a, true); },
        _a[encoding_1.Encoding.FloatDataType.Float32] = function (v, i, a) { v.setFloat32(4 * i, a, true); },
        _a[encoding_1.Encoding.FloatDataType.Float64] = function (v, i, a) { v.setFloat64(8 * i, a, true); },
        _a);
    var byteSizes = (_b = {},
        _b[encoding_1.Encoding.IntDataType.Int16] = 2,
        _b[encoding_1.Encoding.IntDataType.Uint16] = 2,
        _b[encoding_1.Encoding.IntDataType.Int32] = 4,
        _b[encoding_1.Encoding.IntDataType.Uint32] = 4,
        _b[encoding_1.Encoding.FloatDataType.Float32] = 4,
        _b[encoding_1.Encoding.FloatDataType.Float64] = 8,
        _b);
    function byteArray(data) {
        var type = encoding_1.Encoding.getDataType(data);
        if (type === encoding_1.Encoding.IntDataType.Int8)
            return int8(data);
        else if (type === encoding_1.Encoding.IntDataType.Uint8)
            return uint8(data);
    ...
    function runLength(data) {
        ...
        if (srcType === void 0) {
            ...
            srcType = encoding_1.Encoding.IntDataType.Int32;
        }
        if (!data.length) {
            return {
    ...
    function stringArray(data) {
        ...
        var offsetArray = util_1.ChunkedArray.compact(offsets);
        var offsetEncoding = (0, classifier_1.classifyIntArray)(offsetArray);
        var encodedOddsets = offsetEncoding.encode(offsetArray);
        var dataEncoding = (0, classifier_1.classifyIntArray)(output);
