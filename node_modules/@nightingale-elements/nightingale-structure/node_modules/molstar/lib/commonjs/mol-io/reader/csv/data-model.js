...
var data_model_1 = require("../cif/data-model");
...
function CsvTable(rowCount, columnNames, columns) {
    return { rowCount: rowCount, columnNames: tslib_1.__spreadArray([], columnNames, true), getColumn: function (name) { return columns[name]; } };
}
