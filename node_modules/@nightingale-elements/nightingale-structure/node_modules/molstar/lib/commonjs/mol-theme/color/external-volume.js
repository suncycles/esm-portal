...
exports.ExternalVolumeColorThemeParams = {
    volume: param_definition_1.ParamDefinition.ValueRef(function (ctx) {
        var volumes = ctx.state.data.selectQ(function (q) { return q.root.subtree().filter(function (c) { var _a; return volume_1.Volume.is((_a = c.obj) === null || _a === void 0 ? void 0 : _a.data); }); });
...
function ExternalVolumeColorTheme(ctx, props) {
    ...
    if (volume) {
        ...
        var scale_1 = color_1.ColorScale.create({ domain: domain, listOrName: coloring.list.colors });
        var cartnToGrid_1 = volume_1.Grid.getGridToCartesianTransform(volume.grid);
        linear_algebra_1.Mat4.invert(cartnToGrid_1, cartnToGrid_1);
        var gridCoords_1 = (0, linear_algebra_1.Vec3)();
        ...
        color = function (location) {
            ...
            linear_algebra_1.Vec3.copy(gridCoords_1, location.position);
            linear_algebra_1.Vec3.transformMat4(gridCoords_1, gridCoords_1, cartnToGrid_1);
            ...
            var x = (0, interpolate_1.lerp)((0, interpolate_1.lerp)(a, b, u), (0, interpolate_1.lerp)(c, d, u), v);
            a = get_1(data_1, i, j, kk);
            b = get_1(data_1, ii, j, kk);
            c = get_1(data_1, i, jj, kk);
            d = get_1(data_1, ii, jj, kk);
            var y = (0, interpolate_1.lerp)((0, interpolate_1.lerp)(a, b, u), (0, interpolate_1.lerp)(c, d, u), v);
            var value = (0, interpolate_1.lerp)(x, y, w);
            if (isRelative_1) {
...
exports.ExternalVolumeColorThemeProvider = {
    ...
    factory: ExternalVolumeColorTheme,
    getParams: function () { return exports.ExternalVolumeColorThemeParams; },
