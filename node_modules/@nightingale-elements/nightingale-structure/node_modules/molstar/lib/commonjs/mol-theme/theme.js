...
var ThemeRegistry = /** @class */ (function () {
    function ThemeRegistry(builtInThemes, emptyProvider) {
        ...
        this._map = new Map();
        this._name = new Map();
        (0, object_1.objectForEach)(builtInThemes, function (p, k) {
            if (p.name !== k)
    ...
    ThemeRegistry.prototype.create = function (name, ctx, props) {
        ...
        return provider.factory(ctx, tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(provider.getParams(ctx))), props));
    };
