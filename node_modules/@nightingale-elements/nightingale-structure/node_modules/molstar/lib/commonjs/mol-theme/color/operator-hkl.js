...
exports.OperatorHklColorThemeParams = tslib_1.__assign({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: DefaultList }));
function getOperatorHklColorThemeParams(ctx) {
    var params = param_definition_1.ParamDefinition.clone(exports.OperatorHklColorThemeParams);
    if (ctx.structure) {
...
function hklKeySplit(key) {
    var len = (0, number_1.integerDigitCount)(hklOffset, 0);
...
function OperatorHklColorTheme(ctx, props) {
    ...
    if (ctx.structure) {
        ...
        var palette_2 = (0, palette_1.getPalette)(map_1.size, props, labelOptions);
